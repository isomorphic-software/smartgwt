...
public class DataSource extends BaseClass implements com.smartgwt.client.data.events.HasHandleErrorHandlers {
    ...
    public Boolean getCacheAcrossOperationIds() throws IllegalStateException {
        ...
        return getAttributeAsBoolean("cacheAcrossOperationIds");
    }
    ...
    public Boolean getIgnoreTextMatchStyleCaseSensitive()  {
        return getAttributeAsBoolean("ignoreTextMatchStyleCaseSensitive");
    }
    ...
    /**
     * When using the "matchesPattern", "iMatchesPattern", "containsPattern" or "iContainsPattern" {@link
     * com.smartgwt.client.types.OperatorId searchoperator}, character that escapes the {@link
    ...
    public boolean getTranslatePatternOperators()  {
        return getAttributeAsBoolean("translatePatternOperators");
    }
    ...
    /**
     * @see {@link DataSource#getFileURL()}
     */
    ...
    public native OperatorId[] getTypeOperators(FieldType typeName) /*-{
        var self = this.@com.smartgwt.client.core.BaseClass::getOrCreateJsObj()();
        var ret = self.getTypeOperators(typeName == null ? null : typeName.@com.smartgwt.client.types.FieldType::getValue()());
        if(ret == null) return null;
        return @com.smartgwt.client.util.ConvertTo::arrayOfOperatorId(Lcom/google/gwt/core/client/JavaScriptObject;)(ret);
    }-*/;
     ...
     * primaryKey - see  {@link com.smartgwt.client.docs.serverds.OperationBinding#allowMultiUpdate allowMultiUpdate} <li> do
     * not use this API just because you are calling a stored procedure in SQL - if the stored procedure performs some kind of
     * CRUD operation on the records of this DataSource, use a standard CRUD operationType </ul> <P> Instead, the specific
     * purpose of this API is to bypass all checks and side effects that normally occur for CRUD operations, for example, that
     * a "fetch" requires valid Criteria or that an "update" or "remove" operation contains a valid primary key, or that an
     * "add" operation returns the newly added record.  <code>performCustomOperation</code> allows you to pass an arbitrary
     * Record to the server, act on it with custom code, and return arbitray results or even no results. <P> The "data"
     * parameter becomes {@link com.smartgwt.client.data.DSRequest#getData dsRequest.data}.  With the Smart GWT Server
     * Framework, the data is accessible server-side via DSRequest.getValues() and in {@link
     * com.smartgwt.client.docs.VelocitySupport Velocity templates} (such as &lt;customSQL&gt;) as $values. <P> Note that with
     * SQLDataSource, <code>performCustomOperation</code> must be used if you plan to have a &lt;customSQL&gt; tag in your
    ...
    /**
     * @see {@link DataSource#combineCriteria()}
     */
