 ...
 * skin.
 *  <P>
 * To enable full screenReader mode, call {@link com.smartgwt.client.util.isc#setScreenReaderMode
 ...
 * false;">http://www.w3.org/WAI/intro/aria.php</a>.
 *  <P>
 *  To completely disable ARIA markup, call
 * {@link com.smartgwt.client.util.isc#setScreenReaderMode isc.setScreenReaderMode(false)} before
 ...
 * ariaRole} appropriately.  For a list of ARIA
 ...
 * false;">http://www.w3.org/WAI/PF/aria/roles#role_definitions</a>.
 ...
 * onclick="window.open('http://www.w3.org/TR/wai-aria/states_and_properties');return
 * false;">http://www.w3.org/TR/wai-aria/states_and_properties</a>) to be written
 ...
 * onclick="window.open('http://www.w3.org/TR/wai-aria/states_and_properties#aria-haspopup');return
 * false;">"haspopup"</a>
