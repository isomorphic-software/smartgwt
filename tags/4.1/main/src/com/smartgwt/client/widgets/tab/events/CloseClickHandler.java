...
public interface CloseClickHandler extends EventHandler {
     ...
     * when the user clicks  the "close" icon for a tab. Call {@link com.smartgwt.client.widgets.tab.events.TabCloseClickEvent#cancel()} from within {@link com.smartgwt.client.widgets.tab.events.CloseClickHandler#onCloseClick} to cancel default behavior of removing the tab from the
     * TabSet
     *
