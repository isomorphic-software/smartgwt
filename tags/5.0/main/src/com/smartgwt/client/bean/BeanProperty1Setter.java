...
// there is one method type, and it implements only the setter.
public class BeanProperty1Setter<BeanClass> extends BeanProperty<BeanClass> {

    private BeanMethod<BeanClass, ?> method;

    public BeanProperty1Setter (String name, BeanMethod<BeanClass, ?> method) {
        super(name);
