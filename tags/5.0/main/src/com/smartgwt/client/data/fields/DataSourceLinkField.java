...
public class DataSourceLinkField extends DataSourceField {
    ...
    public DataSourceLinkField(String name, String title, int length) {
        super(name, FieldType.LINK, title, length);
    }

    public DataSourceLinkField(String name, String title, int length, boolean required) {
        super(name, FieldType.LINK, title, length, required);
    }
}
