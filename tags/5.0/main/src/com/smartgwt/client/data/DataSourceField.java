...
public class DataSourceField extends DataClass {
     ...
     * optionDataSource}, for the case where a separate {@link com.smartgwt.client.data.DataSourceField#getDisplayField
     * displayField} name is used within the local dataSource than the field name for the display field within the foreign
     * dataSource. <P> See {@link com.smartgwt.client.widgets.form.fields.FormItem#getForeignDisplayField foreignDisplayField}
     * for more on this, and see  {@link com.smartgwt.client.docs.serverds.DataSourceField#includeFrom includeFrom} for a
     * discussion about picking up dataSource field values from a related dataSource.
     *
     ...
     * The {@link com.smartgwt.client.widgets.form.fields.TextItem#getEnforceLength enforceLength} attribute can also 
