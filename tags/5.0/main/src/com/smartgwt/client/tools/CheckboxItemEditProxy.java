...
/**
 * {@link com.smartgwt.client.tools.EditProxy} that handles {@link com.smartgwt.client.widgets.form.fields.CheckboxItem}
 * when editMode is enabled.
 * @see com.smartgwt.client.docs.DevTools DevTools overview and related methods
 */
@BeanFactory.FrameworkClass
@BeanFactory.ScClassName("CheckboxItemEditProxy")
public class CheckboxItemEditProxy extends FormItemEditProxy {

    public static CheckboxItemEditProxy getOrCreateRef(JavaScriptObject jsObj) {
        if(jsObj == null) return null;
        BaseClass obj = BaseClass.getRef(jsObj);
        if(obj != null) {
            return (CheckboxItemEditProxy) obj;
        } else {
            return new CheckboxItemEditProxy(jsObj);
        }
    }


    public CheckboxItemEditProxy(){
        scClassName = "CheckboxItemEditProxy";
    }

    public CheckboxItemEditProxy(JavaScriptObject jsObj){
        scClassName = "CheckboxItemEditProxy";
