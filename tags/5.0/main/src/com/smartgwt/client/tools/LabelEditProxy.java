...
/**
 * {@link com.smartgwt.client.tools.EditProxy} that handles {@link com.smartgwt.client.widgets.Label} and {@link
 * com.smartgwt.client.widgets.layout.SectionHeader} objects when editMode is enabled.
 * @see com.smartgwt.client.docs.DevTools DevTools overview and related methods
 */
@BeanFactory.FrameworkClass
@BeanFactory.ScClassName("LabelEditProxy")
public class LabelEditProxy extends StatefulCanvasEditProxy {

    public static LabelEditProxy getOrCreateRef(JavaScriptObject jsObj) {
        if(jsObj == null) return null;
        BaseClass obj = BaseClass.getRef(jsObj);
        if(obj != null) {
            return (LabelEditProxy) obj;
        } else {
            return new LabelEditProxy(jsObj);
        }
    }


    public LabelEditProxy(){
        scClassName = "LabelEditProxy";
    }

    public LabelEditProxy(JavaScriptObject jsObj){
        scClassName = "LabelEditProxy";
     ...
     * component's <code>contents</code>.
     */
     ...
     * <code>contents</code>.
     * @param newValue the new component contents
     */
