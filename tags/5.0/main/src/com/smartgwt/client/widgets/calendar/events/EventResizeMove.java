...
public class EventResizeMove extends BrowserEvent<EventResizeMoveHandler>  implements Cancellable {
     ...
     * Handler type.
     */
    private static Type<EventResizeMoveHandler> TYPE;
     ...
     */
    public static <S extends HasEventResizeMoveHandlers & HasHandlers> void fire(
        S source, JavaScriptObject jsObj) {
        if (TYPE != null) {
            EventResizeMove event = new EventResizeMove(jsObj);
     ...
     */
    public static Type<EventResizeMoveHandler> getType() {
        if (TYPE == null) {
            TYPE = new Type<EventResizeMoveHandler>();
        }
        return TYPE;
    }
    ...
    protected void dispatch(EventResizeMoveHandler handler) {
        handler.onEventResizeMove(this);
    }
    ...
    @Override
    public final Type<EventResizeMoveHandler> getAssociatedType() {
        return TYPE;
    }
     ...
     *
     * @return the event that's being drag-resized
     */
