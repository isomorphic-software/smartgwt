...
public class BackgroundMouseUpEvent extends BrowserEvent<BackgroundMouseUpHandler>  implements Cancellable {
     ...
     * Handler type.
     */
    private static Type<BackgroundMouseUpHandler> TYPE;
     ...
     */
    public static <S extends HasBackgroundMouseUpHandlers & HasHandlers> void fire(
        S source, JavaScriptObject jsObj) {
        if (TYPE != null) {
            BackgroundMouseUpEvent event = new BackgroundMouseUpEvent(jsObj);
     ...
     */
    public static Type<BackgroundMouseUpHandler> getType() {
        if (TYPE == null) {
            TYPE = new Type<BackgroundMouseUpHandler>();
        }
        return TYPE;
    }
    ...
    protected void dispatch(BackgroundMouseUpHandler handler) {
        handler.onBackgroundMouseUp(this);
    }
    ...
    @Override
    public final Type<BackgroundMouseUpHandler> getAssociatedType() {
        return TYPE;
    }
     ...
     *
     * @return the datetime of the slot where the mouse button was depressed
     */
     ...
     *
     * @return the datetime of the slot where the mouse button was released
     */
