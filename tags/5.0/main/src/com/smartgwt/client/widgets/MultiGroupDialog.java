...
public class MultiGroupDialog extends Window {
     ...
     *
     * @param addLevelButtonTitle  Default value is "Add Level"
     ...
     * configuration as an array of  GroupSpecifiers. <P> This component is an {@link com.smartgwt.client.types.AutoChild} and
     * as such may be customized via  <code>multiGroupPanel.applyButtonProperties</code> and 
     ...
     * MultiGroupPanel for i18n.
     *
     * @param copyLevelButtonTitle  Default value is "Copy Level"
     * @throws IllegalStateException this property cannot be changed after the component has been created
     */
     ...
     * MultiGroupPanel for i18n.
     *
     * @param deleteLevelButtonTitle  Default value is "Delete Level"
     * @throws IllegalStateException this property cannot be changed after the component has been created
     */
     ...
     *
     * @param groupingFieldTitle  Default value is "Grouping"
     * @throws IllegalStateException this property cannot be changed after the component has been created
     */
     ...
     *
     * @param invalidListPrompt  Default value is "Columns may only be used once: '\${title}' is used multiple times."
     * @throws IllegalStateException this property cannot be changed after the component has been created
     */
     ...
     *
     * @param levelDownButtonTitle  Default value is "Move Level Down"
     * @throws IllegalStateException this property cannot be changed after the component has been created
     */
     ...
     *
     * @param levelUpButtonTitle  Default value is "Move Level Up"
     * @throws IllegalStateException this property cannot be changed after the component has been created
     */
     ...
     *
     * @param maxLevels  Default value is null
     * @throws IllegalStateException this property cannot be changed after the component has been created
     */
     ...
     * GroupSpecifiers. <P> This component is an {@link com.smartgwt.client.types.AutoChild} and as such may be customized via 
     ...
     * the MultiGroupPanel for i18n.
     *
     * @param propertyFieldTitle  Default value is "Column"
     * @throws IllegalStateException this property cannot be changed after the component has been created
     */
     ...
     *
     * @param title  Default value is "Group"
     * @throws IllegalStateException this property cannot be changed after the component has been created
     */
