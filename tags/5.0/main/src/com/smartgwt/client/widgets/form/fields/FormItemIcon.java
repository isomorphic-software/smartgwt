...
public class FormItemIcon extends DataClass implements com.smartgwt.client.widgets.form.fields.events.HasFormItemClickHandlers {
     ...
     * com.smartgwt.client.widgets.form.fields.ComboBoxItem#getPickerNavigationBar pickerNavigationBar}. <P> If not explicitly
     * specified at the icon level, this will be picked up from  iconPlacement. <P> For mobile browsing with limited available
     * screen space, icons rendered in the navigation bar may be easier for the user to interact with.
     *
