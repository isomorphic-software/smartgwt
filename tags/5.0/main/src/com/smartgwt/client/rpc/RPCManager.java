...
public class RPCManager {
     ...
     * com.smartgwt.client.rpc.RPCManager#loadScreen RPCManager.loadScreen}, <code>cacheScreens()</code> does not cause any UI
     * components to be created or drawn, it just loads the definitions of the screens.  This allows a subsequent, synchronous
     * call to {@link com.smartgwt.client.rpc.RPCManager#createScreen RPCManager.createScreen} to create the actual screen,
     * rather than contacting the <code>ScreenLoader</code> servlet and showing a loading message. <p> See {@link
     * com.smartgwt.client.rpc.RPCManager#loadScreen RPCManager.loadScreen} for the meaning of the <code>locale</code>
     * parameter. <p> Calling <code>cacheScreens</code> twice with the same screenName will re-load the definition of that
     * screen from the server such that subsequent calls to <code>createScreen()</code> will use the new definition.
     ...
     * transaction, if there is one, by  {@link com.smartgwt.client.rpc.RPCManager#getQueueTransactionId
     * getQueueTransactionId()} before the  transaction is sent.
     ...
     * {@link com.smartgwt.client.data.DSRequest#getExportCSS exportCSS} - this is intended primarily for switching the page
     * size on
     *  the fly, for exceptionally wide or tall exports.
     * 
     * 
     * @param canvas Canvas or canvas list that has exportable widgets,                    or HTML fragment derived from {@link
     ...
     * been called and at least one request has been issued. <P> NOTE: This method will return null if there's no queued
     * requests.
     *
     ...
     * your requests are synchronously submitted to the server. <br><br> This method will do nothing and the callback will not
     * be called if no requests have actually  been queued. You can detect whether the queue is empty by calling  {@link
     * com.smartgwt.client.rpc.RPCManager#getQueueTransactionId getQueueTransactionId()}. <br><br> NOTE: if you aren't the
     * caller who first enables queuing (startQueue() returns true), you should in general avoid calling sendQueue(), because
     * whoever was first to enable queuing may have more requests to add to the same queue.
     ...
     * URL.
     * <p>
     * URLs can be set on a per-request basis via {@link RPCRequest#setActionURL}, or on a
     * per-DataSource or per-operationType basis via {@link com.smartgwt.client.data.DataSource#setDataURL} and
     * {@link com.smartgwt.client.data.OperationBinding#setDataURL} respectively.  However, note that in order to be able to
     ...
     * (<a href="http://en.wikipedia.org/wiki/Cross-site_request_forgery,Cross-site">Request Forgery</a>) 
     ...
     * @param credentialsURL default value http://localhost:8080/isomorphic/login/loginSuccessMarker.html
     */
    public static native String getCredentialsURL(String credentialsURL) /*-{
     ...
     *
     * @note the default value for this marker is <b>&lt;SCRIPT&gt;//'\&quot;]]&gt;&gt;isc_</b>
     * @see com.smartgwt.client.rpc.RPCManager#setLoginRequiredMarker()
     */
    public static native void getLoginStatusCodeMarker() /*-{
     ...
     *
     * @param loginStatusCodeMarker the default value for this marker is <b>&lt;SCRIPT&gt;//'\&quot;]]&gt;&gt;isc_</b>
     * @see com.smartgwt.client.rpc.RPCManager#setLoginRequiredMarker()
     */
    public static native String setLoginStatusCodeMarker(String loginStatusCodeMarker) /*-{
        $wnd.isc.RPCManager.loginStatusCodeMarker = loginStatusCodeMarker;
    }-*/;
     ...
     * 
     * @see com.smartgwt.client.rpc.RPCManager#setLoginRequiredMarker()
     * @note The default value for the marker is <b>&lt;SCRIPT&gt;//'\&quot;]]&gt;&gt;isc_loginRequired</b>
     */
    public static native void getLoginRequiredMarker() /*-{
     ...
     * <P>
     * The +link{RPCManager.loginRequiredMarker}, +link{RPCManager.loginSuccessMarker} and 
     * +link{RPCManager.maxLoginAttemptsExceededMarker} should all start with the 
     * +link{RPCManager.loginStatusCodeMarker}.  If they do not, there will be a small impact on 
     ...
     * <P>
     * Since the raw text of the response is scanned to find the marker, the marker should ideally be
     * something that could not possibly validly appear as a data value in a normal response.  This is why
     * the default marker has characters that make it impossible to validly embed in a JavaScript String,
     * XML document or HTML content.
     * <P>
     * There is normally no need to customize these response markers, and should only be customized 
     * if there is no available option to change the response the server generates when there is a 
     * session timeout.
     * <P>
     *
     * @param loginRequiredMarker default value <b>&lt;SCRIPT&gt;//'\&quot;]]&gt;&gt;isc_loginRequired</b>
     */
    public static native String setLoginRequiredMarker(String loginRequiredMarker) /*-{
        $wnd.isc.RPCManager.loginRequiredMarker = loginRequiredMarker;
    }-*/;
     ...
     * 
     * @see com.smartgwt.client.rpc.RPCManager#setLoginRequiredMarker()
     * @note The default value for the marker is <b>&lt;SCRIPT&gt;//'\&quot;]]&gt;&gt;isc_loginSuccess</b>
     */
    public static native void getLoginSuccessMarker() /*-{
     ...
     *
     * @see com.smartgwt.client.rpc.RPCManager#setLoginRequiredMarker()
     * @param loginSuccessMarker default value <b>&lt;SCRIPT&gt;//'\&quot;]]&gt;&gt;isc_loginSuccess</b>
     */
    public static native String setLoginSuccessMarker(String loginSuccessMarker) /*-{
        $wnd.isc.RPCManager.loginSuccessMarker = loginSuccessMarker;
    }-*/;
