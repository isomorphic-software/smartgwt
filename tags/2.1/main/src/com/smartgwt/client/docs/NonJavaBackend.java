 ...
 * service operations: use&#010 {@link com.smartgwt.client.data.XMLTools#loadWSDL} to load the service definition, and then
 * use&#010 {@link com.smartgwt.client.data.WebService#callOperation} to call the operations.  Note that some server
 * frameworks&#010 allow the generation of WSDL from server method signatures.&#010 <P>&#010 Alternatively, if your backend
 * is capable of outputting &#010 <a href='http://www.json.org/' onclick="window.open('http://www.json.org/');return
 * false;">JSON</a> (JavaScript Object Notation), you can use &#010 {@link com.smartgwt.client.rpc.RPCRequest#getEvalResult
 * evalResult} to directly turn JSON results into live JavaScript objects.&#010 {@link
 * com.smartgwt.client.rpc.RPCRequest#getServerOutputAsString serverOutputAsString} lets you load arbitrary server results,
 * including&#010 JSON results that need to be processed before they can be eval()'d.&#010 <P>&#010 <h4>HTTPProxy:
 * Cross-site or cross-port data loading</h4>&#010 <P>&#010 If you develop a prototype using the Smart GWT SDK and Smart
 * GWT Java Server, and then&#010 you migrate the prototype to another server technology, you need to be aware that
 * the&#010 Smart GWT Java Server includes an HTTPProxy servlet that allows Smart GWT interfaces to&#010 contact servers
 * other than the origin server (bypassing what is called the&#010 <a
 ...
 * on&#010 other servers, typical practice is to pursue normal Smart GWT integration with your&#010 server, then write
 * server-side code that contacts other hosts on behalf of your Smart GWT&#010 interface.
 */
