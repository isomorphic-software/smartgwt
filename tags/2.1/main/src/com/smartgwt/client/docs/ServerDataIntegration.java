 ...
 * com.smartgwt.client.widgets.DataBoundComponent} will send {@link com.smartgwt.client.data.DSRequest} to the Smart GWT
 ...
 * of the {@link com.smartgwt.client.docs.DataSourceOperations 'DataSource Protocol'}. <P> Out of the box, Smart GWT is set
 ...
 * servlet.  Smart GWT supports  queuing of transactions, so each HTTP request might contain multiple DSRequests.</li>
 ...
 * com.smartgwt.client.rpc.RPCManager}, and the  ${isc.DocUtils.linkForExampleId('ormDataSource', 'Custom ORM DataSource
 * example')}.
