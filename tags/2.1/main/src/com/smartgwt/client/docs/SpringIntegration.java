 ...
 * sent by Smart GWT components.&#010 <P>&#010 There are 2 approaches for integrating Smart GWT into an existing Spring
 ...
 * the following Java&#010 anonymous class, which uses the Smart GWT JSTranslater class to dump the entire &#010 Spring
 ...
 * com.smartgwt.client.docs.IscInstall 'deploy'} Smart GWT as simple web content (JS/media/HTML files).  If you&#010 are
 * already familiar with how to generate XML from objects that typically appear in your&#010 Spring Models, this may be the
 * easiest path.&#010 </ul>&#010 <P>&#010 <b>Using Spring Controllers with Smart GWT DMI</b>&#010 <P>&#010 You can create a
 * Controller that invokes standard Smart GWT server request processing,&#010 including DMI, like so:&#010 <pre>&#010
 * public class Smart GWTRPCController extends AbstractController&#010 {&#010     public ModelAndView
 * handleRequest(HttpServletRequest request, &#010                                       HttpServletResponse response)&#010
 * throws Exception&#010     {&#010         // invoke Smart GWT server standard request processing&#010        
