 ...
 * feature is not compatible with the following features: <ul> <li> variable height auto-sizing
 * records      ({@link com.smartgwt.client.widgets.grid.ListGrid#getFixedRecordHeights
 * fixedRecordHeights:false}) <li> {@link com.smartgwt.client.docs.AutoFitData}:"horizontal", as
 * well as headers that autoFit to titles      (normally enabled via
 * <code>field.overflow:"visible"</code>) <li> the {@link
 ...
 * styling-related and formatting-related features.
