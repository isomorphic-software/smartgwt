...
/**
 * Button used to display a hierachichal Menu group for representing / selecting tree data. <P> <i><b>Important Note:</b>
...
public class TreeMenuButton extends MenuButton {
    ...
    public native static TreeMenuButton getOrCreateRef(JavaScriptObject jsObj) /*-{
        if (jsObj == null) return null;
        var instance = jsObj["__ref"];
        if (instance == null) {
            return @com.smartgwt.client.util.ObjectFactory::createCanvas(Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)("TreeMenuButton",jsObj);
        } else {
            return instance;
        }
    }-*/;
    ...
    public static native void changeAutoChildDefaults(String autoChildName, Canvas defaults) /*-{
        $wnd.isc["TreeMenuButton"].changeDefaults(autoChildName + "Defaults", defaults.@com.smartgwt.client.widgets.Canvas::getConfig()());
    }-*/;
    ...
    public static native void changeAutoChildDefaults(String autoChildName, FormItem defaults) /*-{
        $wnd.isc["TreeMenuButton"].changeDefaults(autoChildName + "Defaults", defaults.@com.smartgwt.client.widgets.form.fields.FormItem::getJsObj()());
    }-*/;
     ...
     *
     * @param emptyMenuMessage . See {@link com.smartgwt.client.docs.String String}. Default value is null
     */
     ...
     *
     * @param pathSeparatorString . See {@link com.smartgwt.client.docs.String String}. Default value is "&nbsp;&gt;&nbsp;"
     */
     ...
     *
     * @param selectedBaseStyle . See {@link com.smartgwt.client.docs.CSSStyleName CSSStyleName}. Default value is "treeMenuSelected"
     */
     ...
     *
     * @param showPath showPath Default value is false
     */
    ...
    public boolean getShowPath()  {
        return getAttributeAsBoolean("showPath");
    }
     ...
     *
     * @param unselectedTitle . See {@link com.smartgwt.client.docs.String String}. Default value is "Choose a value"
     */
    ...
    public static native void setDefaultProperties(TreeMenuButton treeMenuButtonProperties) /*-{
    	var properties = $wnd.isc.addProperties({},treeMenuButtonProperties.@com.smartgwt.client.widgets.BaseWidget::getConfig()());
