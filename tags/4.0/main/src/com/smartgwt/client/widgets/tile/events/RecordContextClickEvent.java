...
public class RecordContextClickEvent extends BrowserEvent<RecordContextClickHandler>  implements Cancellable {
     ...
     * Handler type.
     */
    private static Type<RecordContextClickHandler> TYPE;
     ...
     */
    public static Type<RecordContextClickHandler> getType() {
        if (TYPE == null) {
            TYPE = new Type<RecordContextClickHandler>();
        }
        return TYPE;
    }
    ...
    protected void dispatch(RecordContextClickHandler handler) {
        handler.onRecordContextClick(this);
    }
    ...
    @Override
    public final Type<RecordContextClickHandler> getAssociatedType() {
        return TYPE;
    }
    ...
    public native TileGrid getViewer() /*-{
        ...
        return @com.smartgwt.client.widgets.tile.TileGrid::getOrCreateRef(Lcom/google/gwt/core/client/JavaScriptObject;)(ret);
    }-*/;
	/**
