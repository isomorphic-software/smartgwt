...
public class EventHoverHTMLEvent extends BrowserEvent<EventHoverHTMLHandler>  {
     ...
     *
     * @return the event window being hovered
     */
    public native EventWindow getEventWindow() /*-{
        var self = this.@com.smartgwt.client.event.AbstractSmartEvent::jsObj;
        var ret = self.eventWindow;
        if(ret == null) return null;
        return @com.smartgwt.client.widgets.calendar.EventWindow::getOrCreateRef(Lcom/google/gwt/core/client/JavaScriptObject;)(ret);
    }-*/;
