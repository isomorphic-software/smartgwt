 ...
 * @see com.smartgwt.client.grid.GridRenderer#getCellPadding
 * @see com.smartgwt.client.grid.GridRenderer#getBaseStyle
 * @see com.smartgwt.client.grid.GridRenderer#getAlternateRowStyles
 * @see com.smartgwt.client.grid.GridRenderer#getAlternateRowFrequency
 * @see com.smartgwt.client.grid.GridRenderer#getEmptyCellValue
