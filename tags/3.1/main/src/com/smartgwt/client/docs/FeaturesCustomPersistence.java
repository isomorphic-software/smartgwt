 ...
 * target="examples">Queuing examples</a> <p> <b>Transaction Chaining:</b> allows one request in a
 * queue of operations to incorporate values from previously executed requests in the same queue. 
 * This allows a series of dependent operations - such as fetching a value from one DataSource to
 * be used in a query on another - to be defined with simple declarations right in the DataSource
 ...
 * persistence strategy. <p> <b>Java / JS Reflection:</b> Any Java object can be delivered to the
