 ...
 * value in one&#010 configuration file and have all versioned URLs change dynamically.&#010 <p>&#010 Because SmartGWT
 * performs the assembly of image URLs dynamically, versioning of&#010 SmartGWT skins must be done with a path component. 
 * You can do this by changing the base&#010 skinDir using {@link com.smartgwt.client.util.Page#setSkinDir} - e.g:&#010
 * <pre>&#010 isc.Page.setSkinDir('/version/5.6/isomorphic/skins/SmartGWT/');&#010 </pre>&#010 You can then either deploy
 ...
 * using the SmartGWT Java back-end there are several caching solutions&#010 available, depending on your server of choice.
 * Microsoft's IIS has built-in caching&#010 capability, please check the reference manual for details.  If you're using
 * Apache, you can&#010 use <a href='http://httpd.apache.org/docs/2.0/mod/mod_expires.html'
 * onclick="window.open('http://httpd.apache.org/docs/2.0/mod/mod_expires.html');return false;">mod_expires</a>.  Some
 * servlet&#010 containers also natively support the setting of caching headers.&#010 <p>&#010 The SmartGWT Java back-end
 ...
 * headers to the FileDownload&#010 servlet in your web.xml.  Typically, you'll want to serve the SmartGWT modules and
