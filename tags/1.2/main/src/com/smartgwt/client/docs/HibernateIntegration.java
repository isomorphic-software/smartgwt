 ...
 * generating Hibernate configuration from a SmartGWT DataSource file (<i>dataSourceID</i>.ds.xml).  In this case, you do
 ...
 * Hibernate integration are provided in the SDK, one using {@link com.smartgwt.client..DMI} and one using {@link
 * com.smartgwt.client.rpc.RPCManager} dispatch.  Both are accessible from the SDK Explorer as Examples->Server
 * Integration, and both include sample Hibernate configuration as well as a sample UI capable of loading and saving data.
 * <ul> <li> <a href='/examples/server_integration/index.html#customDataSourceIntegrationHibernate'
 ...
 * Integration using DMI to Hibernate"</a> shows how to use SmartGWT Direct Method Invocation ({@link
 * com.smartgwt.client..DMI}) to implement all four DataSource operations with Hibernate.  This particular example uses
 ...
 * </ul> As discussed under {@link com.smartgwt.client..DMI}, whether to use DMI or RPCManager dispatch is largely a matter
 * of preference, however if you are already using Spring, a DMI-based approach is probably a better fit. <P>
 * <b>serverType:"hibernate"</b> <P> As with DataSources using SmartGWT's built-in {@link
 * com.smartgwt.client.docs.SqlDataSource 'SQL engine'}, you need only {@link
 * com.smartgwt.client.docs.DataSourceDeclaration 'create a DataSource'} in XML format - no Java classes or other
 * configuration are required.  The {@link com.smartgwt.client.docs.AdminConsole 'Admin Console'}'s "Import DataSources"
