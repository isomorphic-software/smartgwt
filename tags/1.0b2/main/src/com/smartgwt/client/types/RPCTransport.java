 ...
 * browser settings.  For&#010 advanced use cases, ${isc.DocUtils.linkForRef('attr:RPCRequest.transport')} and
...
public enum RPCTransport implements ValueEnum {
     ...
     * configurations, this transport may not be&#010 available.  See ${isc.DocUtils.linkForRef('group:platformDependencies')}
     ...
     * to call via a URL parameter,&#010 which can be controlled with ${isc.DocUtils.linkForRef('attr:RPCRequest.callbackParam')}.
     */
     ...
     * the SmartClient Server and using &#010 ${isc.DocUtils.linkForRef('group:serverDataIntegration','Server-side data
     * integration')}, the "hiddenFrame" transport&#010 is automatically used for all RPCManager and DataSource requests
