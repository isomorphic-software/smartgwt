 ...
 * @see com.smartgwt.client..AdvancedCriteria
 * @see com.smartgwt.client..Criterion
 * @see com.smartgwt.client..Operator
 * @see com.smartgwt.client.data.DataSource#addSearchOperator
 * @see com.smartgwt.client.data.DataSource#setTypeOperators
 * @see com.smartgwt.client..Criterion#getOperator
 * @see com.smartgwt.client..Criterion#getFieldName
 * @see com.smartgwt.client..Criterion#getValue
 * @see com.smartgwt.client..Criterion#getCriteria
 * @see com.smartgwt.client..Criterion#getStart
 * @see com.smartgwt.client..Criterion#getEnd
