...
/**
 * Properties for declaring relations between DataSource and within DataSources, such as&#010 master-detail relationship (a SalesOrder contains 0 or more OrderItems) and tree&#010 relationships (records can be linked by a parentId field).
