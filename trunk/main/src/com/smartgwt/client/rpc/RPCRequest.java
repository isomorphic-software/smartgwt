 ...
 * the {@link com.smartgwt.client.rpc.RPCManager#sendRequest} method.  If you use the  {@link
 * com.smartgwt.client.rpc.RPCManager#send} method, an instance of RPCRequest will be created for you.
 */
public class RPCRequest extends DataClass {
     ...
     * contain anything that a JavaScript file loaded at init time can contain, including new&#010 views and new SmartGWT class
     * definitions.&#010 <p>&#010 <i>Example usage with {@link com.smartgwt.client.rpc.RPCManager#sendRequest}:</i>&#010
     * <pre>&#010 isc.RPCManager.sendRequest({&#010     evalResult:true,&#010     actionURL:"js/loadLabel.js",&#010    
     * evalVars:{var1:"A Value"}&#010 });&#010 </pre>&#010 This call would execute the code from <code>loadLabel.js</code>, and
     * make the variable&#010 <code>var1</code> available to that code. Therefore if the .js file contained this code:&#010
     * <pre>&#010 isc.Label.create({&#010     contents:var1&#010 })&#010 </pre>&#010 A label would be created with contents set
     * to the value of <code>var1</code> - the string&#010 <code>"A Value"</code>.&#010 &#010 <p>&#010 This feature relies on
     * the XMLHttpRequest object which can be disabled by end-users in some&#010 supported browsers.  See {@link
     ...
     * automatically generated and will differ each time&#010 the server is contacted.&#010 <P>&#010 SmartGWT makes of this
     ...
     * This is typically only useful if you are sending a request that will <b>not</b> be received by the SmartGWT Java Server,
     * however in that case, set {@link com.smartgwt.client.rpc.RPCRequest#getUseSimpleHttp useSimpleHttp}:true instead, which
     * implies <code>serverOutputAsString:true</code>. <P> <code>serverOutputAsString:true</code> allows you to, for example,
     * load the contents of static files off your webserver into a string for processing on the client with no server support. 
     * The {@link com.smartgwt.client.rpc.RPCRequest#getActionURL actionURL} must be in the same domain as the current page for
     * this to work. <p> This feature relies on the XMLHttpRequest object which can be disabled by end-users in some supported
     * browsers.  See {@link com.smartgwt.client.docs.PlatformDependencies} for more information. <p> Generally this API is
     * used for either {@link com.smartgwt.client.docs.NonJavaBackend 'non-Java backends'}  or for advanced usage such as
     * content that requires processing before it can be used in SmartGWT components (such as client-side web scraping).  Note
     * that SmartGWT provides higher-level APIs for loading common types of data, see eg {@link
     * com.smartgwt.client.widgets.HTMLFlow} for HTML content, {@link com.smartgwt.client.widgets.ViewLoader} for loading
     * SmartGWT components, {@link com.smartgwt.client.data.XMLTools#loadXML} for loading XML, {@link
     ...
     * in the queue must use the same transport. If you attempt to send a request via a different transport than those that are
     * currently on the queue, it will be sent to the server separately, ahead of the queue, and a warning will be logged to
     * the Developer Console. <p> If you specify an unknown transport, an error will be logged to the DeveloperConsole and
     ...
     * com.smartgwt.client.rpc.RPCManager#xmlHttpRequestAvailable}.
     * <p><b>Note : </b> This is an advanced setting</p>
     *
    ...
    /**
     * When set to true, assume the request is not going to the SmartGWT server, and hence send a simple HTTP request that does
     * not use SmartGWT-specific request encoding. <P> Values specified in {@link com.smartgwt.client.rpc.RPCRequest#getParams
     * params} are sent to to the server as HTTP request parameters.  If {@link
