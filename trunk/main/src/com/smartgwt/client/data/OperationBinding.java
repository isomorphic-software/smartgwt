...
public class OperationBinding extends DataClass {
    ...
    */
    ...
    /**
    * For a dataSource of {@link com.smartgwt.client.data.DataSource#getServerType serverType} "sql", this  property can be specified on an operationBinding to provide the server with a bespoke GROUP BY clause to use when constructing the SQL query to perform this operation.  The property should be a comma-separated list of column names and/or expressions, forming a valid GROUP BY clause in the syntax of the underlying database.  The server will  insert the text of this property immediately after the "GROUP BY" token. <p> Note that specifying this property enables you to use aggregate functions (such as  COUNT and SUM) in your {@link com.smartgwt.client.data.OperationBinding#getSelectClause selectClause}. Also note that care is required  when using groupClause to ensure that the selectClause contains the fields you are grouping by.  Failure to do this correctly will result in a runtime SQL error. <p> This property is only applicable to operationBindings of  {@link com.smartgwt.client.data.OperationBinding#getOperationType operationType} "fetch". <p> See the documentation for {@link com.smartgwt.client.data.OperationBinding#getCustomSQL customSQL} for usage examples
    *
    * @param groupClause groupClause Default value is null
    */
    public void setGroupClause(String groupClause) {
        setAttribute("groupClause", groupClause);
    }
    /**
     * For a dataSource of {@link com.smartgwt.client.data.DataSource#getServerType serverType} "sql", this  property can be specified on an operationBinding to provide the server with a bespoke GROUP BY clause to use when constructing the SQL query to perform this operation.  The property should be a comma-separated list of column names and/or expressions, forming a valid GROUP BY clause in the syntax of the underlying database.  The server will  insert the text of this property immediately after the "GROUP BY" token. <p> Note that specifying this property enables you to use aggregate functions (such as  COUNT and SUM) in your {@link com.smartgwt.client.data.OperationBinding#getSelectClause selectClause}. Also note that care is required  when using groupClause to ensure that the selectClause contains the fields you are grouping by.  Failure to do this correctly will result in a runtime SQL error. <p> This property is only applicable to operationBindings of  {@link com.smartgwt.client.data.OperationBinding#getOperationType operationType} "fetch". <p> See the documentation for {@link com.smartgwt.client.data.OperationBinding#getCustomSQL customSQL} for usage examples
     *
    ...
    public String getGroupClause()  {
        return getAttributeAsString("groupClause");
    }
