 ...
 * applications</a>.&#010 Google provides a great infrastructure for web applications. It takes care of many web&#010
 * application developer's headaches: hardware, operating system support, backups, scaling,&#010 security, mail etc. To run
 * under GAE your application has to comply to GAE rules.&#010 The biggest difference is GAE datastore - it is not a
 * relational database - instead they use&#010 something called <a href='http://en.wikipedia.org/wiki/BigTable'
 ...
 * support</a>.&#010 Because GAE datastore is not a relational database&#010 <a
 ...
 * application for GAE</b>&#010 <p/>&#010 Under the <code>/WEB-INF</code> directory you have to create a file named&#010 <a
 ...
 * false;"><code>appengine-web.xml</code></a>&#010 which will hold Google's specific settings.<br/>&#010 One important
 * thing to note: static and dynamic contents will be served from different servers.&#010 There are&#010 <a
 ...
 * not specified.&#010 A single GAE application is limited to 3000 files. A typical Smart GWT application consists of
 * many&#010 resources and it exceeds the limit when duplicated (even with a single theme).&#010 To run a Smart GWT
 * application we have to split resources. Here is an example configuration:<pre>&#010 &lt;?xml version="1.0"
 * encoding="UTF-8"?&gt;&#010 &lt;appengine-web-app xmlns="http://appengine.google.com/ns/1.0"&gt;&#010    
 ...
 * &lt;/resource-files&gt;&#010 &lt;/appengine-web-app&gt;&#010 </pre>&#010 To interact with DataSources an additional
 * servlet mapping has to be added to&#010 <code>web.xml</code>:<pre>&#010 &lt;servlet-mapping&gt;&#010    
 ...
 * one&#010 difference: property <b><code>{@link com.smartgwt.client.docs.serverds.DataSource#serverConstructor
 ...
 * filter.&#010 Only <code>TextMatchStyle.STARTS_WITH</code> filtering mode is supported for text fields.<br/>&#010
 ...
 * whether you use transactions or not).<br/>&#010 To participate in a transaction, entities have&#010 to belong to
 ...
 * false;">same group</a>.<br/>&#010 Note: entities of different type can not participate in a transaction even if
 ...
 * entities are&#010 instantiated automatically by the JPA provider) between them. Entities in groups can form a&#010 chain
 * of the following sort::<pre>&#010 ClassA has reference to ClassB,&#010 ClassB has reference to ClassC&#010 </pre>&#010
 * But it is impossible to have an entity referencing two other entities:<pre>&#010 ClassD has reference to ClassE,&#010
 * ClassD has reference to ClassF&#010 </pre>&#010 There are no foreign keys - the actual reference is encoded into the
 * primary key of child entity.<br/>&#010 GAE datastore does not support many-to-many relationships.<br/>&#010
 * Unidirectional one-to-many relationships work only if the parent has a declaration of&#010
 * <code>List&lt;ChildEntityClass&gt;</code>.<br/>&#010 Unidirectional relationships do not work if only the child entity
 * has reference to the parent.<br/>&#010 Bidirectional relationship example:<pre>&#010 &#64;Entity&#010 public class
 * Country&#010     implements Serializable&#010 {&#010     &#64;Id&#010     &#64;Column (nullable = false)&#010    
 * &#64;GeneratedValue (strategy = GenerationType.IDENTITY)&#010     &#64;Extension (vendorName = "datanucleus", key =
 * "gae.encoded-pk", value = "true")&#010     private String countryId;&#010&#010     &#64;OneToMany&#010     private
 * List<City> cities;&#010 //....&#010 }&#010&#010 &#64;Entity&#010 public class City&#010     implements Serializable&#010
 * {&#010     &#64;Id&#010     &#64;Column (nullable = false)&#010     &#64;GeneratedValue (strategy =
 * GenerationType.IDENTITY)&#010     &#64;Extension (vendorName = "datanucleus", key = "gae.encoded-pk", value =
 * "true")&#010     private String cityId;&#010&#010     // This is fake column - it is calculated by provider and is not
 * saved.&#010     // Actual reference to parent entity is encoded in primary key.&#010     &#64;Column (nullable =
 * false)&#010     &#64;Extension (vendorName = "datanucleus", key = "gae.parent-pk", value = "true")&#010     private
 * String countryId;&#010&#010     &#64;ManyToOne (fetch=FetchType.LAZY)&#010     private Country country;&#010 //....&#010
 * }&#010 </pre>&#010 Note: GAE does not support <code>FetchType.EAGER</code>.&#010 <p/> With&#010 <b><a
