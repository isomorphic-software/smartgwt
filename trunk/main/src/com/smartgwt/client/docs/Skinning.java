 ...
 * <h4>Basics</h4>&#010 <P>&#010 <ul>&#010 <li> SmartGWT components create their visual appearance by dynamically
 * generating HTML,&#010 within the browser, using JavaScript.&#010&#010 <li> the HTML generated by SmartGWT components
 * contains CSS style names and URLs to&#010 images&#010&#010 <li> SmartGWT components can be skinned by replacing the CSS
 * styles and images that&#010 the components use by default, or by using JavaScript properties to configure&#010
 * components to use new CSS styles and new image URLs.&#010&#010 <li> You can change the appearance of an individual
 * SmartGWT component by passing &#010 properties to {@link com.smartgwt.client..Class#create}, or you can skin all
 * components of the&#010 same class at once, by using {@link com.smartgwt.client..Class#addProperties} and &#010 {@link
 * com.smartgwt.client..Class#changeDefaults} to change the defaults for the class.&#010&#010 <li> A "skin" consists
 * of:&#010 <ul>&#010 <li> a single CSS stylesheet containing all CSS styles used by SmartGWT components&#010
 ...
 * The example skins that come with SmartGWT are in&#010 <code>isomorphicSDK/isomorphic/skins</code>.  The standard
 ...
 * SmartGWT server, by specifying the "skin" property of the loadISCTag.&#010 load_skin.js loads the stylesheet and sets
 * the CSS styleNames and media URLs that&#010 SmartGWT components will use.&#010 </ul>&#010 <P>&#010 <h4>Modifying
 * Skins</h4>&#010 <P>&#010 To modify a skin, first create a copy of one of the skins that comes with the SmartGWT&#010
 ...
 * Properties</h4>&#010 <P>&#010 <b>Starting from the name of the component</b>&#010 <P>&#010 Given a SmartGWT component
 * that you want to skin, use the search feature of the SmartGWT&#010 Reference to locate it, and open the "Instance APIs"
 ...
 * organization.  To find the base SmartGWT component for a component named&#010 "MyComponent", use the following code to
 * find out the name of the superclass:&#010 <pre>&#010     isc.<i>MyComponent</i>.getSuperClass().getClassName()&#010
 * </pre>&#010 Repeat this until you arrive at a SmartGWT built-in class.  You can execute this code in&#010 the "Eval JS"
 * area of the Results pane of the Developer Console.&#010 <P>&#010 Specific browsers offer alternate approaches to quickly
 * discover the images or style names&#010 being used for a part of a SmartGWT component's appearance: &#010 <ul>&#010 <li>
 * the Firefox browser offers a dialog via Tools->"Page Info" that gives a manifest of&#010 media used in the page.&#010
 ...
 * "Properties" shows a&#010 dialog that provides the image URL in most browsers.  Tips:&#010 <ul>&#010 <li> if a SmartGWT
 ...
 * <P>&#010 <h4>Image URLs in SmartGWT</h4>&#010 <P>&#010 Properties that refer to images by URL, such as {@link
 * com.smartgwt.client.widgets.Img#getSrc src} and {@link com.smartgwt.client.widgets.Button#getIcon icon}, are&#010
 * specially interpreted in SmartGWT to allow for simpler and more uniform image URLs,&#010 and to allow applications to be
 * restructured more easily.&#010 <P>&#010 Unlike the URL used with an HTML &lt;IMG&gt; element, the image URL passed to a
 * SmartGWT&#010 component is not assumed to be relative to the current page.  See {@link com.smartgwt.client..SCImgURL}
 * for a&#010 full explanation of the default application image directory, and the meaning of the "[SKIN]"&#010
 * prefix.&#010 <P>&#010 <h4>Specifying Image URLs</h4>&#010 <P>&#010 Default image URLs for SmartGWT components are
 ...
 * <code>load_skin.js</code> file&#010 from the "SmartGWT" sample skin includes the following code to establish the media
 ...
 * </pre>&#010 <P>&#010 <h4>Specifying Image Sizes</h4>&#010 <P>&#010 Many SmartGWT components must know some image sizes
 ...
 * possible, SmartGWT must know the&#010 sizes of the images used as "endcaps" on each tab in advance.&#010 <P>&#010 Like
 ...
 * capSize:4&#010     })&#010 </pre>&#010 <P>&#010 <h4>CSS usage in SmartGWT</h4>&#010 <P>&#010 In SmartGWT, screen layout
 * and sizing are controlled via JavaScript, and appearance via&#010 CSS and images.  &#010 <P>&#010 CSS borders, margins
 * and padding applied to SmartGWT components can be treated as purely&#010 visual properties with no effect on sizing or
 * layout.  Unlike HTML elements, a SmartGWT&#010 component will always have the exact size you specify via JavaScript,
 * regardless of browser&#010 platform, browser compatibility mode, or borders, margins, or padding, all of which
 * normally&#010 affect the final size of an HTML element. &#010 <P>&#010 For this reason, SmartGWT skinning requires only
 * novice-level familiarity with CSS, as CSS&#010 is used principally for colors and fonts.  See {@link
 ...
 * com.smartgwt.client.widgets.Button#getBaseStyle baseStyle} for details and examples.&#010 <P>&#010 SmartGWT has built-in
 * logic to manage a series of state transitions, such as:&#010 <ul>&#010 <li> "rollover": showing a different appearance
 * when the mouse is over a component&#010 <li> "button down": showing a different appearance when the mouse is pressed
 * over a&#010 component&#010 <li> "disabled": showing a different appearance when a component cannot be interacted
 ...
 * com.smartgwt.client.widgets.StretchImg} is SmartGWT component that renders out a compound image composed of 3&#010 image
 * files: two fixed-size endcaps images and a stretchable center segment.  Like stateful&#010 components, the names of each
 * image segment is appended to the image URL as a suffix.  See&#010 {@link com.smartgwt.client.widgets.StretchImg#getSrc
 * src} for details.&#010 <P>&#010 <h4>EdgedCanvas</h4>&#010 <P>&#010 Similar to a StretchImg, an {@link
 * com.smartgwt.client.widgets.EdgedCanvas} provides an image-based decorative edge&#010 around and/or behind another
 * component, with up to 9 segments (a 3x3 grid).  Decorative&#010 edges can be added to any component by setting {@link
 * com.smartgwt.client.widgets.Canvas#getShowEdges 'showEdges:true'}.&#010 EdgedCanvas is also used to construct
 * dropshadows, which can be enabled on any component via&#010 {@link com.smartgwt.client.widgets.Canvas#getShowShadow
 * 'showShadow:true'}.&#010 <P>&#010 <h4>Multiple looks for the same component type</h4>&#010 <P>&#010 In some cases you
 * need to create two variations in appearance for a component with the same&#010 behavior.  For example, you may want to
 * create a specialized Window, called "PaletteWindow",&#010 that behaves like a normal Window but has a very compact look
 * & feel.  To create a&#010 separately skinnable component for PaletteWindow, use {@link
 * com.smartgwt.client.util.isc#defineClass}.  For&#010 example:&#010 <pre>&#010    isc.defineClass("PaletteWindow",
 * "Window");&#010    isc.PaletteWindow.addProperties({&#010        showFooter:false,&#010        ...&#010    })&#010
 * </pre>
 */
