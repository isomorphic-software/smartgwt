 ...
 * this RPCManager:</li>   <ul>   <li>Validates the DSRequest</li>   <li>Sends the DSRequest through {@link
 * com.smartgwt.client.docs.DmiOverview DMI} - in other words, your code - if this is        configured in the DataSource. 
 * As described later in this section, your code can       perform some custom logic here: either completely fulfilling the
 * request, or       alternatively modifying the request and causing the default       processing of the request to
 * continue</li>   <li>Calls the DataSource's <code>execute</code> method to obtain a DSResponse.</li>   </ul> <li>Having
 * processed all requests, the RPCManager now serializes all the DSResponses  and sends them back to the browser as a
 * single HTTP response</li> </ul> <p> This basic request handling flow can be customized at a number of points: <ul>
 ...
 * DataSource to add extra processing       before and/or after the Smart GWT processing</li>   <li>Use  Transaction
 ...
 * com.smartgwt.client.docs.DmiOverview Direct Method Invocation} to call directly into your own Java        classes.  As
 * described in the DMI discussion linked to above, DMI calls can be used        in conjunction with normal
 ...
 * target="examples">Queuing examples</a>.</li> </ul> <P> For more information on the DMI subsystem, see the {@link
 * com.smartgwt.client.docs.DmiOverview DMI overview},  DMI class and the  <a
 * href="http://www.smartclient.com/smartgwtee/showcase/#dmi" target="examples">DMI example</a> in the Feature Explorer.
 ...
 * recommendations for  {@link com.smartgwt.client.docs.WriteCustomDataSource writing a custom DataSource} and provide your
 * implementation via <code>executeFetch(), executeAdd()</code>, et al.</td> <td>dsRequest.getOperationType()</td> </tr>
 * <tr> <td>2. Get inbound values (Add, Update) and/or criteria (Fetch, Update, Remove) for this request.</td>
 ...
 * </tr> </table> <P> For more information, see the {@link com.smartgwt.client.rpc.RPCManager RPCManager documentation},
 * and the  <a href="http://www.smartclient.com/smartgwtee/showcase/#orm_ds" target="examples">Custom ORM DataSource
 * example</a>.
