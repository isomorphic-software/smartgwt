 ...
 * com.smartgwt.client.data.RestDataSource provided}.&#010 <P>&#010 <h4>Consuming Existing XML and JSON formats</h4>&#010
 * <p>&#010 For WSDL web services, see the {@link com.smartgwt.client.docs.WsdlBinding WSDL binding topic} first.&#010
 * <P>&#010 To display XML or JSON data in a visual component such as a ListGrid, you bind the component&#010 to a {@link
 ...
 * com.smartgwt.client.data.OperationBinding#getRecordXPath recordXPath}, is applied to&#010 the service response to select
 * the XML elements or JSON objects that should be interpreted&#010 as DataSource records.  Then, for each field of the
 * DataSource, an optional&#010 {@link com.smartgwt.client.data.DataSourceField#getValueXPath valueXPath} can be declared
 * which selects the value for the field&#010 from within each of the XML elements or JSON objects selected by the
 ...
 * forms the&#010 DSResponses that are then interpreted by {@link com.smartgwt.client.widgets.DataBoundComponent databound
 * components}.&#010 <P>&#010 <b>Controlling how DSRequests are sent</b>&#010 <P>&#010 According to the {@link
 * com.smartgwt.client.data.OperationBinding#getDataProtocol protocol} being used, the&#010 {@link
 * com.smartgwt.client.docs.DataSourceOperations DataSource request data}, if any, either becomes HTTP&#010 params (sent by
 * GET or POST), or an XML message as put together by&#010 {@link com.smartgwt.client.data.DataSource#xmlSerialize
 ...
 * set via the {@link com.smartgwt.client.data.OperationBinding#getDataURL dataURL}&#010 property.  If using a Web Service,
 * the <code>dataURL</code> defaults to the service location&#010 URL embedded in the WSDL file.&#010 <P>&#010 For example,
 * in the default configuration for non-WSDL binding, since&#010 {@link
 ...
 * com.smartgwt.client.data.DataSourceField#getPrimaryKey primaryKey} field of "id" with value "5" on the&#010 record to be
 * updated&#010 <li> a field "age" being changed to "32"&#010 <li> "dataURL" of "save.php"&#010 </ul>&#010 You will see an
 * HTTP GET to the URL <code>save.php?id=5&age=32</code>.&#010 <P>&#010 <b>Forming a DSResponse from the response
