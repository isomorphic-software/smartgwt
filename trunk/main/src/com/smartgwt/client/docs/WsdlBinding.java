 ...
 * com.smartgwt.client.data.WebService#getFetchDS}&#010 <P>&#010 to obtain a DataSource which describes the structure of an
 * XML element or XML Schema type&#010 named <i>elementName</i>, which appears in the response message for the operation
 * named&#010 <i>operationName</i>.  A component bound to this DataSource will show fields corresponding&#010 to the
 * structure of the chosen XML element or type, that is, one field per subelement or&#010 attribute.  {@link
 * com.smartgwt.client.widgets.grid.ListGrid#fetchData} called on this DataSource (or on a&#010 component bound to it) will
 * invoke the specified web service operation, using the&#010 {@link com.smartgwt.client.data.Criteria} passed to
 * fetchData() to fill out the input message via&#010 {@link com.smartgwt.client.data.DataSource#xmlSerialize}, and using
 * the specified XML element from the response&#010 message as data.&#010 <P>&#010 Similarly, {@link
 * com.smartgwt.client.data.WebService#getInputDS} returns&#010 a DataSource suitable for binding to a form that a user
 * will fill out to provide inputs to&#010 the specified web service operation.  Typical use is to let the user fill in the
 * form, then&#010 pass the results of {@link com.smartgwt.client.widgets.form.DynamicForm#getValues} to&#010 {@link
 * com.smartgwt.client.widgets.grid.ListGrid#fetchData} as criteria.&#010 <P>&#010 If the input message to the web service
 * has extra nesting, consider using&#010 the {@link com.smartgwt.client.data.OperationBinding#getUseFlatFields
 * 'useFlatFields'} property to simplify the inputs&#010 required for <code>fetchData()</code>, and/or to simplify form
 * databinding via&#010 {@link com.smartgwt.client.widgets.DataBoundComponent#getUseFlatFields
 * 'component.useFlatFields'}.&#010 <P>&#010 Note that the WSDL tab in the Developer Console can provide a clean,
 * simplified view of any &#010 WSDL file, making it easier to pick out the appropriate <code>operationName</code> and&#010
 * <code>elementName</code> parameters to pass to <code>getFetchDS()</code> and other&#010 {@link
 * com.smartgwt.client.data.WebService} methods.&#010 <P>&#010 Take a look at the
 * ${isc.DocUtils.linkForExampleId('wsdlBinding', 'Google SOAP Search example')} and the&#010 <a
 ...
 * com.smartgwt.client.data.DataSource#transformResponse}&#010 <li> transform the inbound data, if necessary, in order to
 * add metadata such as&#010 {@link com.smartgwt.client.data.DSRequest#getStartRow startRow} for paging, or a sessionId for
 ...
 * <P>&#010 You can use the {@link com.smartgwt.client.data.DataSource#getInheritsFrom inheritsFrom} property to create
 * DataSources that extend&#010 from XML schema definitions, then add presentation metadata not found in XML schema.&#010
 * <P>&#010 Even if you choose to declare all fields manually, you can leverage XML Schema&#010 &lt;simpleType&gt;
 * definitions by setting {@link com.smartgwt.client.data.DataSourceField#getType 'field.type'} to the name&#010 of an XML
 * Schema simple type embedded in the WSDL file.&#010 <P>&#010 <b>Round Trip Binding [fetch -> edit -> save]</b>&#010
 * <P>&#010 For full read-write integration with a service that supports the basic&#010 {@link
 * com.smartgwt.client.docs.DataSourceOperations 'DataSource operations'} on persistent data, &#010 {@link
 * com.smartgwt.client.data.OperationBinding} can be declared for each DataSource operation, and&#010 the {@link
 * com.smartgwt.client.data.OperationBinding#getWsOperation 'wsOperation'} property can be used to to bind each&#010 {@link
 * com.smartgwt.client.docs.DataSourceOperations 'DataSource operation'} (fetch, update, add, remove) to a&#010
 * corresponding web service operation.&#010 <P>&#010 For example, this code accomplishes part of the binding to the &#010
 ...
 * example, if a {@link com.smartgwt.client.widgets.form.DynamicForm#saveData} is&#010 invoked and triggers a DSRequest
 * with operationType:"add", the DataSource above will invoke&#010 the "create" operation, and {@link
 * com.smartgwt.client.widgets.form.DynamicForm#getValues} will become&#010 {@link
 * com.smartgwt.client.data.DSRequest#getData data} and be serialized to form the input message of the "create" web&#010
 * service operation.&#010 <P>&#010 Typical usage is:&#010 <ol>&#010 <li> declare a DataSource that represents the fields
 * of the object as you want them&#010 represented in the UI.  This DataSource is considered the "entity DataSource".  It
 * may&#010 extend from an XML Schema complex type via {@link com.smartgwt.client.data.DataSource#getInheritsFrom
 * inheritsFrom}.&#010 <li> use {@link com.smartgwt.client.data.OperationBinding} to configure the entity DataSource
 * to&#010 call the appropriate web service operations for each DataSource operation, and extract&#010 results via&#010
 ...
 * com.smartgwt.client.data.WebService#getInputDS}.  This is&#010 done because search inputs are frequently unrelated to
 * the structure of the objects being&#010 searched for&#010 <li> bind forms use for editing ("add" and "update"
 * operations) to the entity DataSource&#010 </ul>&#010 <li> use&#010 {@link
 * com.smartgwt.client.data.DataSource#transformRequest}/{@link com.smartgwt.client.data.DataSource#transformResponse},
 * &#010 {@link com.smartgwt.client.data.OperationBinding#getUseFlatFields useFlatFields} and {@link
