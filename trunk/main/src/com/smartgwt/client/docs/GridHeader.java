...
/**
 * Properties and methods related to the ListGrid header. ListGrid headers are implemented&#010 as a {@link com.smartgwt.client.widgets.toolbar.Toolbar} of buttons shown at the top of the ListGrid &#010 (one button per column).<br>&#010 The toolbar header provides UI for interacting with the ListGrid fields directly (sorting,&#010 resizing, reordering columns, etc).
