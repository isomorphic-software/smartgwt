 ...
 * the Smart GWT Java Server.  If you are not, skip to the sections near the end of this document. <P> <b>Single file
 * upload: "binary" field type</b> <P> To use Smart GWT's client-server upload system, you use a DataSource field of {@link
 ...
 * use Smart GWT {@link com.smartgwt.client..DMI} instead. <P> Server-side validation errors may be provided, including
 ...
 * provide your own Java Servlet or JSP that creates an instance of RPCManager in order process Smart GWT requests, many
 ...
 * of Java Servlets, not specific to Smart GWT <li> unlike other DataSource "add" and "update" operations, you are not
 ...
 * com.smartgwt.client..MultiFileItem} docs for details. <P> <b>Upload without the Smart GWT Server</b> <P> If it is
