...
public class ItemHoverEvent extends AbstractSmartEvent<ItemHoverHandler>  {
   ...
   * Handler type.
   */
  private static Type<ItemHoverHandler> TYPE;
   ...
   */
  public static Type<ItemHoverHandler> getType() {
    if (TYPE == null) {
      TYPE = new Type<ItemHoverHandler>();
    }
    return TYPE;
  }
  ...
  @Override
  protected final Type<ItemHoverHandler> getAssociatedType() {
    return TYPE;
  }

    public ItemHoverEvent(JavaScriptObject jsObj) {
        super(jsObj);
    }
