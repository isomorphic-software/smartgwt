...
/**
 * The ViewLoader component can be used to load new SmartGWT-based user interfaces into a running application. <P>
 * <b>NOTE:</b> before using a ViewLoader, be sure that you have read about and understood the {@link
 * com.smartgwt.client.docs.SmartArchitecture 'SmartGWT Architecture'}.  The most responsive and scalable application
 ...
 * should be SmartGWT components defined in JavaScript, with no surrounding &lt;SCRIPT&gt; tags or other HTML framing.  The
 ...
 * The intended usage is that the returned script creates a view consisting of SmartGWT components, then calls
