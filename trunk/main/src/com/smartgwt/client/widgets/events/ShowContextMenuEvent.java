...
public class ShowContextMenuEvent extends BrowserEvent<ShowContextMenuHandler>  implements Cancellable {
  ...
  @Override
  protected final Type<ShowContextMenuHandler> getAssociatedType() {
    return TYPE;
  }
