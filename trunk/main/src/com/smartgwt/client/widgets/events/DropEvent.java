...
public class DropEvent extends BrowserEvent<DropHandler>  implements Cancellable {
  ...
  public static <S extends HasDropHandlers & HasHandlers> void fire(
    ...
    if (TYPE != null) {
      ...
      if (handlers != null) {
        DropEvent event = new DropEvent(jsObj);
  ...
  @Override
  protected final Type<DropHandler> getAssociatedType() {
    return TYPE;
  }

    public DropEvent(JavaScriptObject jsObj) {
        super(jsObj);
    }
