...
public class VisibilityChangedEvent extends BrowserEvent<VisibilityChangedHandler>  {
    ...
    public static <S extends HasVisibilityChangedHandlers & HasHandlers> void fire(
        ...
        if (TYPE != null) {
            VisibilityChangedEvent event = new VisibilityChangedEvent(jsObj);
    ...
    @Override
    public final Type<VisibilityChangedHandler> getAssociatedType() {
        return TYPE;
    }

    public VisibilityChangedEvent(JavaScriptObject jsObj) {
        super(jsObj);
    }
