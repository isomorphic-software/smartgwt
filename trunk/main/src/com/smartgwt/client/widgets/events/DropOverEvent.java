...
public class DropOverEvent extends BrowserEvent<DropOverHandler>  implements Cancellable {
    private boolean cancel = false;

  /**
   * Handler type.
   */
  private static Type<DropOverHandler> TYPE;
  ...
  @Override
  protected final Type<DropOverHandler> getAssociatedType() {
    return TYPE;
  }

    public DropOverEvent(JavaScriptObject jsObj) {
        super(jsObj);
    }
