...
public class TabClickEvent extends BrowserEvent<TabIconClickHandler>  {
   ...
   * Handler type.
   */
  private static Type<TabIconClickHandler> TYPE;
  ...
  public static <S extends HasTabIconClickHandlers & HasHandlers> void fire(
    ...
    if (TYPE != null) {
      ...
      if (handlers != null) {
        TabClickEvent event = new TabClickEvent(jsObj);
   ...
   */
  public static Type<TabIconClickHandler> getType() {
    if (TYPE == null) {
      TYPE = new Type<TabIconClickHandler>();
    }
    return TYPE;
  }
  ...
  @Override
  protected final Type<TabIconClickHandler> getAssociatedType() {
    return TYPE;
  }
     ...
     *
     * @return with click handler being fired
     */
