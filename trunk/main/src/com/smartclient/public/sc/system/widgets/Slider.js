...
_createValueLabel : function () {
	...
	var label = isc.Label.newInstance({
...
_createTrack : function (top, left, width, height) {
	...
	return isc.StretchImg.newInstance({
...
_thumbMove : function (fromClick) {
    ...
    if (this.maxValue == this.minValue) {
    	...
    	if (this.roundValues)
       		this.value = Math.round(rawValue*(this.maxValue-this.minValue) + this.minValue);
    	else
    		this.value = rawValue*(this.maxValue-this.minValue) + this.minValue;
    }
    //>DEBUG
