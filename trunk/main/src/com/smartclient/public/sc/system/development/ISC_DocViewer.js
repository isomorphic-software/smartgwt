...
var _7={name:10,title:3,description:0.5};var _8=isc.getKeys(_7);var _9=[];var _10=isc.jsdoc.getRefs();for(var k=0;k<_10.length;k++){var _12=_10[k];var m,_14=0;var _15=isc.jsdoc.getDocItem(_12);var _16=isc.jsdoc.getAttributes(_15,_8);for(var i=0;i<_3.length;i++){var _17=_3[i];for(var _18 in _7){_17.lastIndex=0;var _19=_16[_18];if(!_19)continue;var _20=_7[_18];while((m=_17.exec(_19))!=null){_14+=_20;if((m[1]&&m[3])||m[2].length==_19.length){_14+=_20}}}}
...
var _26=isc.DocSearchResults.create({autoDraw:false,nocache:true,overflow:"auto",width:"100%",height:"100%",ref:"Search Results",searchString:_1,searchRegexes:_3,hits:_2});this.docViewer.$46t(_26);if(this.lastSearchResults)this.lastSearchResults.destroy();this.lastSearchResults=_26}
...
if(!_1&&this.jumpToTopicInURL){var _2=window.location.toString().match(/[?&](topic|ref|search)=([^&]*)/);if(_2){if(_2[1]=="search"){this.$48i.doSearch(decodeURIComponent(_2[2]))}else{this.showTopic(decodeURIComponent(_2[2]))}
_1=true}}
...
if(!isc.Page.isLoaded())return;this.noHistory=true;if(_1.startsWith("/")){var _3=this.$46u.find(_1);if(_3){this.$46w.selectRecord(_3);this.$46t(_3.ref?_3.ref:_3,true);var _4=this.noHistory;var _5=this.$46w;var _6=this.$46u.indexOf(_3);isc.Timer.setTimeout(function(){var h=isc.DocViewer.instance.noHistory;isc.DocViewer.instance.noHistory=_4;_5.selection.deselectAll();_5.selectRecord(_6);_5.scrollRecordIntoView(_6);isc.DocViewer.instance.noHistory=h},0)}}else{this.$46t(_1)}
this.noHistory=false}
,isc.A.$46t=function(_1,_2){var _3,_4=false,_5=false,_6=_1,_7=null;if(isc.isA.Canvas(_1)){this.replaceCurrentView(_1);return}if(isc.isAn.Object(_1)){var _8=_1;_7=this.$46w.getMissingModules(_8);if(_8.contentsURL){if(_7){isc.say("This API requires: <a href='"+isc.licensingPage+"' target=_blank>"+_7+"</a></b></span>");return}
...
var _2=isc.emptyString;if(isc.isA.GroupViewer(_1)&&_1.doc.title){_2="<b>"+_1.title+"</b>"}else if(_1.title){if(isc.isA.SummaryViewer(_1))_2="<b>"+_1.title+"</b>";else{_2="<span style='color:#e0e0e0'>";if(isc.isA.ClassViewer(_1))_2+=_1.doc.type;else if(isc.isA.TypeViewer(_1))_2+="type";else _2+="group";_2+="</span> <b>"+_1.title+"</b>"}}
