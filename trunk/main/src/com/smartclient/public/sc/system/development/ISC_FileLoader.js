...
if(_5&&_2)_6.onload=_2;if(!_5&&_2){if(this.isA.String(_2))isc.eval(_2);else _2();return}
...
if(this.$49g){window.setTimeout("isc.FileLoader.$41b()",0)}else this.$41b()},delayedEval:function(_1){var _2=this.$406[_1];var _3=_2.fileContents;if(isc.Browser.isSafari){window.setTimeout([_3,";isc.FileLoader.$41k('",_1,"')"].join(""),0);return}else if(isc.Browser.isIE){window.execScript(_3,"javascript")}else{isc.Class.evaluate(_3,null,true)}
this.$41k(_1)},$41k:function(_1){var _2=this.$406[_1];this.$41l();if(_2.onload){if(this.isA.String(_2.onload))isc.eval(_2.onload);else _2.onload(_2)}
