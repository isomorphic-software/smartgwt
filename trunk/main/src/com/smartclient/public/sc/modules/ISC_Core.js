...
return _1}
);isc.B._maxIndex=isc.C+18;isc.A=Date.prototype;isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.A.$em=[,,,,"/",,,,,"/",,,,null];isc.A.$en="MDY";isc.A.$eo="DMY";isc.A.$ep="YMD";isc.A.$en="MDY";isc.B.push(isc.A.duplicate=function(){var _1=new Date();_1.setTime(this.getTime());return _1}
...
this.$p6(this.$n2);var _2=false;if(this.autoFetchData&&!this.$p7&&this.fetchData){if(!this.dataSource){this.logWarn("autoFetchData is set, but no dataSource is specified, can't fetch")}else{_2=!isc.RPCManager.startQueue();this.fetchData(this.initialCriteria);this.$p7=true}}
...
delete this.locatorParent;this._canvasList();isc.Canvas.$ro(this);this.$rp();isc.EH.canvasDestroyed(this);if(window[this.ID]==this)window[this.ID]=null;if(this.pointersToThis!=null){for(var i=0;i<this.pointersToThis.length;i++){var _5=this.pointersToThis[i];if(_5.object&&(_5.object[_5.property]==this)){var _6;_5.object[_5.property]=_6}}
...
return this.$s6}
,isc.A.setMargin=function(_1){this.$s7=null;this.$s8=null;if(_1==null){delete this.margin;this.getStyleHandle().margin=0}else{if(isc.isA.String(_1))_1=parseInt(_1);if(isc.isA.Number(_1)){this.margin=_1;this.getStyleHandle().margin=this.margin+isc.px}}
...
_1.bottom=0}
return(this.$s7=_1)}
);isc.evalBoundary;isc.B.push(isc.A.getTopBorderSize=function(){return this.$tj().top}
...
if(_1==null){this.padding=null;this.getHandle().style.padding=null;if(this.useClipDiv)this.getClipHandle().style.padding=null}else{if(isc.isA.String(_1))_1=parseInt(_1);if(isc.isA.Number(_1)){this.padding=_1;this.getHandle().style.padding=this.padding+isc.px;if(this.useClipDiv)this.getClipHandle().style.padding="0px"}}}
...
,isc.A.resized=function(deltaX,deltaY,reason){if(isc.$cv)arguments.$cw=this;if(this.snapTo)this.$qw(true);if(this.parentElement)this.parentElement.childResized(this,deltaX,deltaY,reason);if(this.masterElement)this.masterElement.peerResized(this,deltaX,deltaY,reason);var peers=this.peers;if(peers){for(var i=0;i<peers.length;i++){if(isc.isA.Canvas(peers[i]))peers[i].masterResized(deltaX,deltaY,reason)}}
...
);isc.evalBoundary;isc.B.push(isc.A.$t6=function(_1){if(!this.isDrawn()||this.isDirty())return;if(!this.$rm){if(this.logIsDebugEnabled())
...
,isc.A.$ve=function(){if(!this.hideUsingDisplayNone||!this.isDrawn())return;var _1=this.getStyleHandle();if(!this.isVisible()&&!this.$62u){this.$vh=_1.display;this.$62u=true;_1.display="none"}else if(this.isVisible()&&this.$62u){_1.display=(this.$vh?this.$vh:isc.emptyString);delete this.$62u}}
...
);isc.evalBoundary;isc.B.push(isc.A.$v2=function(){var _1=isc.isA.Layout(this)?this.members:this.children;if(!_1||_1.length==0)return;var _2=this.$vy();for(var i=_1.length-1;i>=0;i--){if(_1[i]==null||(_1[i].tabIndex!=null&&!_1[i].$sp))continue;if(_2==null)_1[i].$sq(this);else _1[i].$vx(_2);_2=_1[i]}}
...
if(_1==null)return;if(_1.endsWith(";"))_1=_1.slice(0,_1.length-1);this.border=_1;var _2=this.getStyleHandle();if(_2&&_2.border!=_1){_2.border=_1}
...
);isc.B._maxIndex=isc.C+503;isc.A=isc.Canvas;isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.A.$hm="[SKIN]";isc.A.printOmitControls=["Button","StretchImgButton","ImgButton","MenuButton","Toolbar","ToolStrip","ButtonItem","ToolbarItem"];isc.A.printIncludeControls=["Label"];isc.A.$ws=0;isc.A.$wt="ID='";isc.A.$ob="'";isc.A.$wu="absmiddle";isc.A.$wv=[,,," eventpart='valueicon' style='vertical-align:middle;margin-left:",,"px;margin-right:",,"px;'"];isc.A.$ww={};isc.A.$wx={png:true,PNG:true,Png:true};isc.A.$wy=["<a",," href='",,"' target='",,"'",,,,">",,"</a>"];isc.A.$wz="[SKINIMG]/blank.gif";isc.A.$w0="0";isc.A.$w1="clearRedrawQueue";isc.A.$tw=[];isc.B.push(isc.A.stripScriptTags=function(_1){return _1.replace(/<script([^>]*)?>(.|\n|\r)*?<\/script>/ig,isc.emptyString)}
...
isc.setAutoDraw=function(_1){if(_1==null)_1=true;isc.Canvas.addProperties({autoDraw:_1})};isc.defineClass("PrintCanvas","Canvas");isc.A=isc.PrintCanvas.getPrototype();isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.A.redrawOnResize=false;isc.A.overflow="hidden";isc.B.push(isc.A.initWidget=function(){this.Super("initWidget",arguments)}
...
,isc.A.getPrintFrameURL=function(_1){return isc.Page.getURL("[HELPERS]printFrame.jsp?id="+this.getID()+"&title="+(_1||""))}
...
isc.A=isc.Canvas.getPrototype();isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.A.showComplexFields=true;isc.A.ignoreEmptyCriteria=true;isc.A.dragRecategorize=true;isc.A.duplicateDragMessage="Duplicates not allowed";isc.A.addDropValues=true;isc.A.fieldIdProperty="name";isc.A.styleOpposite="cellHiliteOpposite";isc.A.hiliteProperty="_hilite";isc.A.hiliteMarker="$63i";isc.A.$578=0;isc.A.$579=[];isc.B.push(isc.A.bindToDataSource=function(_1,_2){if(this.dataSource==null&&this.data!=null)this.dataSource=this.data.dataSource;var _3=this.getDataSource();if(_3!=null&&isc.isA.String(_3)){this.logWarn("unable to look up DataSource: "+_3+", databinding will not be used");return _1}
...
,isc.A.createDataModel=function(_1,_2,_3){this.logInfo("Creating new isc.ResultSet for operation '"+_2.ID+"' with filterValues: "+isc.Comm.serialize(_1));var _4=this.getDataSource(),_5=this.dataProperties||{};if(this.dataFetchDelay)_5.fetchDelay=this.dataFetchDelay;isc.addProperties(_5,{operation:_2,filter:_1,context:_3,componentId:this.ID});return _4.getResultSet(_5)}
...
,isc.A.transferRecords=function(_1,_2,_3,_4){if(_4==this){if(_3!=null&&!this.isGrouped)this.data.slideList(_1,_3)}else{var _5=this.getDataSource();var _6=_4.getDataSource();if(_5&&_5==_6&&_4.dragDataAction==isc.ListGrid.MOVE){for(var i=0;i<_1.length;i++){var _8=_1[i];isc.addProperties(_8,this.getDropValues(_8,_6,_2,_3,_4));this.$61f(_8,_6)}}else{if(!isc.isAn.Array(_1))_1=[_1];if(this.selectionType==isc.Selection.MULTIPLE||this.selectionType==isc.Selection.SIMPLE)
