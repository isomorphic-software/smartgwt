    ...
    private ExplorerTreeNode[] getData() {
        if (data == null) {
            data = new ExplorerTreeNode[]{
                    ...
                    new ExplorerTreeNode("Data Types", "grid-sortfilter-datatypes", "grid-sortfilter-category", null, new SortDataTypesSample.Factory(), true, idSuffix),
                    ...
                    new ExplorerTreeNode("Details", "form-details-category", "form-category", "silk/vcard_edit.png", null, true, idSuffix),
