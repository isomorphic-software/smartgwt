...
public interface ListPropertiesChangedHandler extends EventHandler {
    /**
     ...
     */
    void onListPropertiesChanged(com.smartgwt.client.widgets.rte.events.ListPropertiesChangedEvent event);
}
