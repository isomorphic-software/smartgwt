 ...
 * <a href='/docs/Smart GWT_Quick_Start_Guide.pdf' onclick="window.open('/docs/Smart GWT_Quick_Start_Guide.pdf');return
 * false;">QuickStart Guide</a>, Chapter 4, <i>Coding</i>.
 ...
 *  server.  The {@link com.smartgwt.client.docs.ClientDataIntegration Client-side Data Integration} chapter covers
 ...
 *  {@link com.smartgwt.client.data.XMLTools#loadWSDL XMLTools.loadWSDL} to load the service definition, and then use
 * {@link com.smartgwt.client.data.WebService#callOperation WebService.callOperation} to call the operations.  Note that
 * some server frameworks
 *  allow the generation of WSDL from server method signatures.
 *  <P>
 *  Alternatively, if your backend is capable of outputting 
 * <a href='http://www.json.org/' onclick="window.open('http://www.json.org/');return false;">JSON</a> (JavaScript Object
 ...
 * objects.
 * {@link com.smartgwt.client.rpc.RPCRequest#getServerOutputAsString serverOutputAsString} lets you load arbitrary server
 * results, including
 ...
 * onclick="window.open('http://www.google.com/search?q=same+origin+policy');return false;">"same origin policy"</a>).
 *  <P>
 ...
 * files, which contain the service URL - you may need to use {@link com.smartgwt.client.data.WebService#setLocation
