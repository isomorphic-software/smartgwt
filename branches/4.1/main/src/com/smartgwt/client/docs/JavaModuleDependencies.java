 ...
 * &nbsp;&nbsp;&nbsp;&nbsp;hsqldb<br>  </li> <li><b>isomorphic_autotest</b>: Support for  {@link
 * com.smartgwt.client.docs.AutomatedTesting automated testing and Continuous Integration}<br>
 * &nbsp;&nbsp;<u>Requires</u>:<br> &nbsp;&nbsp;&nbsp;&nbsp;isomorphic_core_rpc<br> 
 * &nbsp;&nbsp;&nbsp;&nbsp;selenium-server<br> &nbsp;&nbsp;<em>The
 * <code>selenium-server.jar</code> file provided with Smart GWT is a  trimmed version that does
 * not include all of the libraries used by Selenium itself. Therefore the following libraries are
 * also needed:</em><br> &nbsp;&nbsp;&nbsp;&nbsp;backport-util-concurrent<br> 
