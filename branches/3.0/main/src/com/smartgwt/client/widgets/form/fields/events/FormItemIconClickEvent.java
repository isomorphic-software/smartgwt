...
public class FormItemIconClickEvent extends AbstractSmartEvent<FormItemClickHandler>  {
     ...
     * Handler type.
     */
    private static Type<FormItemClickHandler> TYPE;
     ...
     */
    public static <S extends HasFormItemClickHandlers & HasHandlers> void fire(
        S source, JavaScriptObject jsObj) {
        if (TYPE != null) {
            FormItemIconClickEvent event = new FormItemIconClickEvent(jsObj);
     ...
     */
    public static Type<FormItemClickHandler> getType() {
        if (TYPE == null) {
            TYPE = new Type<FormItemClickHandler>();
        }
        return TYPE;
    }
    ...
    @Override
    public final Type<FormItemClickHandler> getAssociatedType() {
        return TYPE;
    }
