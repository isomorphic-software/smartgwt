...
public class SelectionUpdatedEvent extends BrowserEvent<SelectionUpdatedHandler>  {
     ...
     */
    public static <S extends HasSelectionUpdatedHandlers & HasHandlers> void fire(
        S source, JavaScriptObject jsObj) {
        if (TYPE != null) {
            SelectionUpdatedEvent event = new SelectionUpdatedEvent(jsObj);
    ...
    @Override
    public final Type<SelectionUpdatedHandler> getAssociatedType() {
        return TYPE;
    }

    public SelectionUpdatedEvent(JavaScriptObject jsObj) {
        super(jsObj);
    }
