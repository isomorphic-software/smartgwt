 ...
 * com.smartgwt.client.util.Page#registerKey Page.registerKey} or {@link
 * com.smartgwt.client.util.Page#setEvent Page.setEvent} or at the widget level via {@link
 ...
 * com.smartgwt.client.widgets.Canvas#keyUp Canvas.keyUp}. <P> Details about the key events can be
 * retrieved via static methods on the EventHandler class including {@link
 * com.smartgwt.client.util.EventHandler#getKey EventHandler.getKey}, {@link
 * com.smartgwt.client.util.EventHandler#getKeyEventCharacter EventHandler.getKeyEventCharacter}
 * and {@link com.smartgwt.client.util.EventHandler#getKeyEventCharacterValue
 * EventHandler.getKeyEventCharacterValue}. <P> As with other Smart GWT event handling code,
 * returning <code>false</code> will suppress the default native browser behavior.<br>
 * <b>Note:</b> browsers do not allow cancellation of some keys' default behaviors. These cases
 * vary by browser, and wherever native cancellation is supported, returning false from your event
 * handler should be sufficient to suppress the behavior. <br> Some specific cases where default
 * behavior cancellation is not always possible include: <ul><li>Some function keys (<code>f1, f3,
