 ...
 * a per-row basis, use +sgwtLink{listGrid.setEditorCustomizer()}. <P> <b>NOTE:</b> with both
 * APIs, in effect several FormItems are generated from the customized FormItem you provide - see
 * the docs for {@link com.smartgwt.client.data.DataSourceField#getEditorType editorType} for
 * special coding patterns that apply in this case.  <P> <b>Binary Fields</b> <P> The ListGrid
