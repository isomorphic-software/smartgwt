...
public class Calendar extends Canvas implements DataBoundComponent, com.smartgwt.client.widgets.calendar.events.HasBackgroundClickHandlers, com.smartgwt.client.widgets.calendar.events.HasBackgroundMouseDownHandlers, com.smartgwt.client.widgets.calendar.events.HasBackgroundMouseUpHandlers, com.smartgwt.client.widgets.calendar.events.HasCurrentViewChangedHandlers, com.smartgwt.client.widgets.calendar.events.HasDateChangedHandlers, com.smartgwt.client.widgets.calendar.events.HasDayBodyClickHandlers, com.smartgwt.client.widgets.calendar.events.HasDayHeaderClickHandlers, com.smartgwt.client.widgets.calendar.events.HasEventAddedHandlers, com.smartgwt.client.widgets.calendar.events.HasEventChangedHandlers, com.smartgwt.client.widgets.calendar.events.HasEventClickHandlers, com.smartgwt.client.widgets.calendar.events.HasEventMovedHandlers, com.smartgwt.client.widgets.calendar.events.HasEventRemoveClickHandlers, com.smartgwt.client.widgets.calendar.events.HasEventRemovedHandlers, com.smartgwt.client.widgets.calendar.events.HasEventRepositionMoveHandlers, com.smartgwt.client.widgets.calendar.events.HasEventRepositionStopHandlers, com.smartgwt.client.widgets.calendar.events.HasEventResizedHandlers, com.smartgwt.client.widgets.calendar.events.HasEventResizeMoveHandlers, com.smartgwt.client.widgets.calendar.events.HasEventResizeStopHandlers, com.smartgwt.client.widgets.calendar.events.HasEventHoverHTMLHandlers, com.smartgwt.client.widgets.calendar.events.HasTimelineEventMovedHandlers, com.smartgwt.client.widgets.calendar.events.HasTimelineEventResizedHandlers {
     ...
     *
     * @param backButtonTitle  Default value is "Back"
     * @throws IllegalStateException this property cannot be changed after the component has been created
     */
     ...
     *
     * @param bringEventsToFront  Default value is null
     * @throws IllegalStateException this property cannot be changed after the component has been created
     */
     ...
     *
     * @param monthButtonTitle  Default value is "< \${monthName}"
     * @throws IllegalStateException this property cannot be changed after the component has been created
     */
     ...
     * Calendar.getCellHoverHTML}, which can be overridden to return custom results; by  default, it returns the cell's date as
     * a string.
     *
     * @param showCellHovers  Default value is true
     * @throws IllegalStateException this property cannot be changed after the component has been created
     */
    ...
    public Boolean getShowCellHovers()  {
        return getAttributeAsBoolean("showCellHovers");
    }
     ...
     * call to  {@link com.smartgwt.client.widgets.calendar.Calendar#getDragHoverHTML Calendar.getDragHoverHTML}, which can be
     * overridden to return custom results; by  default, it returns the date range of the drag canvas as a string.
     *
     * @param showDragHovers  Default value is true
     * @throws IllegalStateException this property cannot be changed after the component has been created
     */
    public void setShowDragHovers(Boolean showDragHovers)  throws IllegalStateException {
        setAttribute("showDragHovers", showDragHovers, false);
    }
    ...
    public Boolean getShowDragHovers()  {
        return getAttributeAsBoolean("showDragHovers");
    }
     ...
     * determined by a call to  {@link com.smartgwt.client.widgets.calendar.Calendar#getHeaderHoverHTML
     * Calendar.getHeaderHoverHTML}, which can be overridden to return custom results;
     *
     * @param showHeaderHovers  Default value is true
     * @throws IllegalStateException this property cannot be changed after the component has been created
     */
    ...
    public Boolean getShowHeaderHovers()  {
        return getAttributeAsBoolean("showHeaderHovers");
    }
     ...
     * with the "Over" style.
     *
     * @param showLaneRollOver  Default value is null
     */
     ...
     *
     * @param showMonthButton  Default value is null
     */
    ...
    /**
     * When set to true, causes the Calendar to show customizable hovers when the mouse moves over various areas of a
     * CalendarView.  See {@link com.smartgwt.client.widgets.calendar.Calendar#getShowHeaderHovers showHeaderHovers}, {@link
     * com.smartgwt.client.widgets.calendar.Calendar#getShowCellHovers showCellHovers} and  {@link
     ...
     *
     * @param showViewHovers whether to allow CalendarViews to show hovers. Default value is false
     * @throws IllegalStateException this property cannot be changed after the component has been created
     */
    public void setShowViewHovers(Boolean showViewHovers)  throws IllegalStateException {
        setAttribute("showViewHovers", showViewHovers, false);
    }
    ...
    public Boolean getShowViewHovers()  {
        return getAttributeAsBoolean("showViewHovers");
    }
    ...
    private native void setupBackgroundMouseUpEvent() /*-{
        ...
        if(this.@com.smartgwt.client.widgets.BaseWidget::isCreated()()) {
            ...
            obj.addProperties({backgroundMouseUp: 
                function () {
                    var param = {"startDate" : arguments[0], "endDate" : arguments[1]};
                    return backgroundMouseUp(param) == true;
                }
             });
        } else {
            obj = this.@com.smartgwt.client.widgets.BaseWidget::getConfig()();
    ...
    public native String getDragHoverHTML(CalendarView view, CalendarEvent event, String defaultValue) /*-{
        var self = this.@com.smartgwt.client.widgets.BaseWidget::getOrCreateJsObj()();
        var ret = self.getDragHoverHTML(view.@com.smartgwt.client.widgets.BaseWidget::getOrCreateJsObj()(), event.@com.smartgwt.client.core.DataClass::getJsObj()(), defaultValue);
        return ret;
    }-*/;
    ...
    private native void setupEventHoverHTMLEvent() /*-{
        ...
        var getEventHoverHTML = $entry(function(){
            var param = {"event" : arguments[0], "eventCanvas" : arguments[1], "view" : arguments[2], "defaultValue" : arguments[3]};
    ...
    public native String getIndicatorHoverHTML(CalendarEvent indicator, IndicatorCanvas indicatorCanvas, CalendarView view, String defaultValue) /*-{
        var self = this.@com.smartgwt.client.widgets.BaseWidget::getOrCreateJsObj()();
        var ret = self.getIndicatorHoverHTML(indicator.@com.smartgwt.client.core.DataClass::getJsObj()(), indicatorCanvas.@com.smartgwt.client.widgets.BaseWidget::getOrCreateJsObj()(), view.@com.smartgwt.client.widgets.BaseWidget::getOrCreateJsObj()(), defaultValue);
        return ret;
    }-*/;
    ...
    public native String getZoneHoverHTML(CalendarEvent zone, ZoneCanvas zoneCanvas, CalendarView view, String defaultValue) /*-{
        var self = this.@com.smartgwt.client.widgets.BaseWidget::getOrCreateJsObj()();
        var ret = self.getZoneHoverHTML(zone.@com.smartgwt.client.core.DataClass::getJsObj()(), zoneCanvas.@com.smartgwt.client.widgets.BaseWidget::getOrCreateJsObj()(), view.@com.smartgwt.client.widgets.BaseWidget::getOrCreateJsObj()(), defaultValue);
        return ret;
    }-*/;
     ...
     * @param event The event object to refresh in the current view
     * @param styleName The new CSS style to apply to the canvases showing this event. See {@link com.smartgwt.client.docs.CSSStyleName CSSStyleName}
     */
    ...
    public native void setEventHoverHTMLCustomizer(EventHoverHTMLCustomizer eventHoverHTMLCustomizer) /*-{
        ...
        self.getEventHoverHTML = $debox($entry(function(jsEvent, jsEventWindow) {
            ...
            var eventWindow = @com.smartgwt.client.widgets.calendar.EventWindow::getByJSObject(Lcom/google/gwt/core/client/JavaScriptObject;)(jsEventWindow);
    ...
    public native void setEventCanvasHoverHTMLCustomizer(EventCanvasHoverHTMLCustomizer customizer) /*-{
        ...
        self.getEventHoverHTML = $debox($entry(function(jsEvent, jsEventCanvas) {
            ...
            var eventCanvasJ = @com.smartgwt.client.widgets.calendar.EventCanvas::getByJSObject(Lcom/google/gwt/core/client/JavaScriptObject;)(jsEventCanvas);
