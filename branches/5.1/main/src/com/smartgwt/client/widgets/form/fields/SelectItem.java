...
public class SelectItem extends FormItem implements PickList, com.smartgwt.client.widgets.form.fields.events.HasDataArrivedHandlers {
    ...
    public static native void changeAutoChildDefaults(String autoChildName, DrawItem defaults) /*-{
        $wnd.isc.SelectItem.changeDefaults(autoChildName + "Defaults", defaults.@com.smartgwt.client.widgets.drawing.DrawItem::getJsObj()());
    }-*/;
     ...
     * com.smartgwt.client.widgets.form.fields.SelectItem#getOptionDataSource optionDataSource}, developers may explicitly
     * specify {@link com.smartgwt.client.widgets.form.fields.SelectItem#getForeignDisplayField foreignDisplayField}. If that
     ...
     * com.smartgwt.client.widgets.form.fields.SelectItem#getDisplayFieldName SelectItem.getDisplayFieldName} for details). 
     * Note that if <code>optionDataSource</code> is set and no valid display field is specified (via {@link
     * com.smartgwt.client.widgets.form.fields.SelectItem#getForeignDisplayField foreignDisplayField}, or this property), 
     ...
     * optionDataSource} and an explicit   {@link com.smartgwt.client.widgets.form.fields.SelectItem#getForeignDisplayField
    ...
    /**
     * Empty message to display in the selectItem if  hideEmptyPickList is <code>false</code>.
     * <p><b>Note : </b> This is an advanced setting</p>
     *
    ...
    /**
     * For PickList items with {@link com.smartgwt.client.widgets.form.fields.SelectItem#getPickListPlacement
     * pickListPlacement} set such that the pickList does not render near-origin, should specified {@link
     * com.smartgwt.client.widgets.form.fields.SelectItem#getIcons icons} be rendered inline within the formItem itself, or
     * within the {@link com.smartgwt.client.widgets.form.fields.SelectItem#getPickerNavigationBar pickerNavigationBar}. <P>
     ...
     *
     * @param pickerExitButtonTitle  See {@link com.smartgwt.client.docs.HTMLString HTMLString} . Default value is "Done"
     */
    ...
    /**
     * If true, {@link com.smartgwt.client.widgets.form.fields.SelectItem#getSpecialValues specialValues} special values such
     ...
     * com.smartgwt.client.widgets.form.fields.SelectItem#getSeparateSpecialValues separateSpecialValues} controls this. <p> If
     * <code>specialValues</code> are configured, {@link com.smartgwt.client.widgets.form.fields.SelectItem#getAllowEmptyValue
     * allowEmptyValue} is ignored - an empty value, if desired, must be included in the <code>specialValues</code>.  To
     * provide a <code>specialValue</code> which clears the value of the field, use the special constant  emptyStoredValue. <p>
     ...
     * dataset <i>will</i> be updated by automatic {@link com.smartgwt.client.widgets.form.fields.SelectItem#getCacheSync cache
     * synchronization} (if  the {@link com.smartgwt.client.widgets.form.fields.SelectItem#getDisplayField displayField} is
     * updated).  However when using a distinct {@link com.smartgwt.client.widgets.form.fields.SelectItem#getValueField
     * valueField} and {@link com.smartgwt.client.widgets.form.fields.SelectItem#getDisplayField displayField}, you are
     * required to provide {@link com.smartgwt.client.widgets.form.fields.SelectItem#getSpecialValues specialValues} as a map
     * (there is no support for {@link com.smartgwt.client.widgets.form.fields.SelectItem#getFetchMissingValues
     * fetchMissingValues} automatically fetching appropriate display values).
     *
     * @param specialValues  Default value is null
     */
