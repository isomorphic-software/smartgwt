...
public class StaticTextItem extends FormItem {
    ...
    public static native void changeAutoChildDefaults(String autoChildName, DrawItem defaults) /*-{
        $wnd.isc.StaticTextItem.changeDefaults(autoChildName + "Defaults", defaults.@com.smartgwt.client.widgets.drawing.DrawItem::getJsObj()());
    }-*/;
     ...
     * item's text box element? <P> Overridden to be <code>false</code> for StaticTextItems by default. <P> See {@link
     * com.smartgwt.client.widgets.form.fields.FormItem#shouldApplyHeightToTextBox shouldApplyHeightToTextBox()} for more
     * information.
     * <p><b>Note : </b> This is an advanced setting</p>
     *
     * @param applyHeightToTextBox  Default value is false
     */
     ...
     *
     * @param clipValue  Default value is false
     ...
     *
     * @param wrap  Default value is true
     * @see com.smartgwt.client.docs.Appearance Appearance overview and related methods
     */
