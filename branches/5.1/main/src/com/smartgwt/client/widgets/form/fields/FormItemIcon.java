...
public class FormItemIcon extends DataClass implements com.smartgwt.client.widgets.form.fields.events.HasFormItemClickHandlers {
     ...
     * <p><b>Note : </b> This is an advanced setting</p>
     *
     * @param disableOnReadOnly  Default value is null
     */
     ...
     *
     * @param hspace  Default value is null
    ...
    /**
     * For PickList items with {@link com.smartgwt.client.widgets.form.fields.FormItemIcon#getPickListPlacement
     * pickListPlacement} set such that the pickList does not render near-origin, should this icon be rendered inline within
     * the formItem itself, or within the {@link com.smartgwt.client.widgets.form.fields.ComboBoxItem#getPickerNavigationBar
     * pickerNavigationBar}. <P> If not explicitly specified at the icon level, this will be picked up from  iconPlacement. <P>
     * For mobile browsing with limited available screen space, icons rendered in the navigation bar may be easier for the user
     * to interact with.
     *
     * @param iconPlacement  Default value is null
     */
     ...
     * <p><b>Note : </b> This is an advanced setting</p>
     *
     * @param neverDisable  Default value is null
     */
     ...
     * <p><b>Note : </b> This is an advanced setting</p>
     *
     * @param showFocused  Default value is null
     ...
     * <p><b>Note : </b> This is an advanced setting</p>
     *
     * @param showFocusedWithItem  Default value is null
     * @see com.smartgwt.client.widgets.form.fields.FormItem#setShowFocusedIcons
     ...
     * <p><b>Note : </b> This is an advanced setting</p>
     *
     * @param showOver  Default value is null
     ...
     * <p><b>Note : </b> This is an advanced setting</p>
     *
     * @param showRTL  Default value is null
     */
     ...
     * if appropriate to show the icon's over or disabled state. <p> If {@link
