...
public class SimpleType extends BaseClass {
     ...
     *
     * @param fieldProperties  Default value is null
     * @throws IllegalStateException this property cannot be changed after the underlying component has been created
     */
    ...
    **/
    ...
    public static abstract class SimpleTypeValueExtractor {
         ...
         * version of getAtomicValue().
         * @param value Raw data value to convert. Typically this would be a field value for some record.
         * @param reason A string passed by the framework to indicate why it is asking for the atomic value.
         ...
         *               impose case-insensitive sorting         
         * @return Atomic value. This should match the underlying atomic type specified by the {@link #inheritsFrom} attribute.
         */
    ...
    public native Object setSimpleTypeValueExtractor(SimpleTypeValueExtractor extractor) /*-{
        ...
        self.getAtomicValue = $debox($entry(function(value, reason) {
            var valueJ = $wnd.isc_getAtomicValue_no_incoming_conversion ? value :
                                    $wnd.SmartGWT.convertToJavaObject(value);
            var val = extractor.@com.smartgwt.client.data.SimpleType.SimpleTypeValueExtractor::getAtomicValue(Ljava/lang/Object;Ljava/lang/String;)(valueJ, reason);
            return $wnd.SmartGWT.convertToPrimitiveType(val);
        }));
    }-*/;
    ...
    public static abstract class SimpleTypeValueUpdater {
         ...
         * specified by the {@link #inheritsFrom} attribute.
         * @param value Raw data value to convert. Typically this would be a field value for some record.
         * @param reason A string passed by the framework to indicate why it is updating the atomic value.
    ...
    public native Object setSimpleTypeValueUpdater(SimpleTypeValueUpdater updater) /*-{
        ...
        self.updateAtomicValue = $debox($entry(function(atomicValue, currentValue, reason) {
            ...
            var currentValueJ = $wnd.isc_getAtomicValue_no_incoming_conversion ? currentValue :
                                    $wnd.SmartGWT.convertToJavaObject(currentValue);
            var val = updater.@com.smartgwt.client.data.SimpleType.SimpleTypeValueUpdater::updateAtomicValue(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/String;)(atomicValueJ,currentValueJ,reason);
