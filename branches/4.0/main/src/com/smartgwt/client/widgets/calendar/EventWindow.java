 ...
 * {@link com.smartgwt.client.widgets.calendar.Calendar#getEventWindow eventWindow}.
 */
public class EventWindow extends Window {

    public native static EventWindow getOrCreateRef(JavaScriptObject jsObj) /*-{
        if (jsObj == null) return null;
        var instance = jsObj["__ref"];
        if (instance == null) {
            return @com.smartgwt.client.util.ObjectFactory::createCanvas(Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)("EventWindow",jsObj);
        } else {
            return instance;
        }
    }-*/;
    ...
    public static native void changeAutoChildDefaults(String autoChildName, Canvas defaults) /*-{
        $wnd.isc["EventWindow"].changeDefaults(autoChildName + "Defaults", defaults.@com.smartgwt.client.widgets.Canvas::getConfig()());
    }-*/;
    ...
    public static native void changeAutoChildDefaults(String autoChildName, FormItem defaults) /*-{
        $wnd.isc["EventWindow"].changeDefaults(autoChildName + "Defaults", defaults.@com.smartgwt.client.widgets.form.fields.FormItem::getJsObj()());
    }-*/;
    ...
    public static native void setDefaultProperties(EventWindow eventWindowProperties) /*-{
    	var properties = $wnd.isc.addProperties({},eventWindowProperties.@com.smartgwt.client.widgets.BaseWidget::getConfig()());
