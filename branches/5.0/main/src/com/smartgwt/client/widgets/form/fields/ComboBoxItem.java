...
public class ComboBoxItem extends TextItem implements PickList, com.smartgwt.client.widgets.form.fields.events.HasDataArrivedHandlers {
     ...
     * comboBoxItem filtering, the +sgwtLink{comboBoxItem.setPickListFilterCriteriaFunction()} may be specified.
     *
    ...
    public Boolean getFilterWithValue()  {
        return getAttributeAsBoolean("filterWithValue", true);
    }
     ...
     * at the icon level via {@link com.smartgwt.client.widgets.form.fields.FormItemIcon#getIconPlacement iconPlacement}. <P>
     * For mobile browsing with limited available screen space, icons rendered in the navigation bar may be easier for the user
     * to interact with.
     *
