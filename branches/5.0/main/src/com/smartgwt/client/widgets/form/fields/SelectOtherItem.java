...
public class SelectOtherItem extends SelectItem {
    ...
    public static SelectOtherItem getOrCreateRef(JavaScriptObject jsObj) {
		...
		if(obj != null && JSOHelper.getAttribute(jsObj,"__ref")==null) {
            return com.smartgwt.client.util.ObjectFactory.createFormItem("SelectOtherItem",jsObj);
    ...
    public static native void changeAutoChildDefaults(String autoChildName, DrawItem defaults) /*-{
        $wnd.isc.SelectOtherItem.changeDefaults(autoChildName + "Defaults", defaults.@com.smartgwt.client.widgets.drawing.DrawItem::getJsObj()());
    }-*/;
     ...
     *
     * @param dialogWidth  Default value is 250
     */
     ...
     *
     * @param otherTitle  Default value is "Other..."
     ...
     *
     * @param otherValue  Default value is "***other***"
     * @see com.smartgwt.client.docs.Appearance Appearance overview and related methods
     */
     ...
     *
     * @param selectOtherPrompt  Default value is "Other value for <br>${item.getTitle()}?"
     */
     ...
     *
     * @param separatorTitle  Default value is "--------------------"
     * @see com.smartgwt.client.docs.Appearance Appearance overview and related methods
     */
     ...
     * <p><b>Note : </b> This is an advanced setting</p>
     *
     * @param separatorValue  Default value is "----"
     * @see com.smartgwt.client.docs.Appearance Appearance overview and related methods
     */
