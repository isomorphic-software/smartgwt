...
public class DynamicForm extends Canvas implements DataBoundComponent, com.smartgwt.client.widgets.form.events.HasFormSubmitFailedHandlers, com.smartgwt.client.widgets.form.events.HasAsyncValidationReplyHandlers, com.smartgwt.client.widgets.form.events.HasHiddenValidationErrorsHandlers, com.smartgwt.client.widgets.form.events.HasItemChangeHandlers, com.smartgwt.client.widgets.form.events.HasItemChangedHandlers, com.smartgwt.client.widgets.form.events.HasItemKeyPressHandlers, com.smartgwt.client.widgets.form.events.HasSubmitValuesHandlers, com.smartgwt.client.widgets.form.events.HasValuesChangedHandlers {
     ...
     * com.smartgwt.client.widgets.form.fields.FormItem#getAllowExpressions allowExpressions} for details.
     *
     ...
     * specified per item via {@link com.smartgwt.client.widgets.form.fields.FormItem#getAutoComplete autoComplete}. <P> Note
     * that even with this value set to <code>"none"</code>, native browser  auto-completion may occur for log in forms (forms
     * containing username and  {@link com.smartgwt.client.widgets.form.fields.PasswordItem password} fields). This behavior
     * varies by browser, and is a result of an  <a href='https://www.google.com/search?q=password+ignores+autocomplete+off'
     ...
     * forms.
     *
     * @param autoComplete  Default value is "none"
     ...
     *
     * @param autoFocus  Default value is false
     ...
     *
     * @param autoFocusOnError  Default value is true
     * @see com.smartgwt.client.docs.Focus Focus overview and related methods
     */
     ...
     *
     * @param browserSpellCheck  Default value is true
     ...
     * DynamicForm.cancel}
     *
     * @param cancelParamName  Default value is "org.apache.struts.taglib.html.CANCEL"
     */
     ...
     * DynamicForm.cancel}
     *
     * @param cancelParamValue  Default value is "cancel"
     */
     ...
     * <p><b>Note : </b> This is an advanced setting</p>
     *
     * @param canSubmit  Default value is false
     * @see com.smartgwt.client.docs.Submitting Submitting overview and related methods
     */
     ...
     * be focusable if {@link com.smartgwt.client.util.isc#setScreenReaderMode isc.setScreenReaderMode} has been called. See
     * {@link com.smartgwt.client.docs.Accessibility}.
     * <p><b>Note : </b> This is an advanced setting</p>
     *
     * @param canTabToSectionHeaders  Default value is null
     * @throws IllegalStateException this property cannot be changed after the component has been created
     */
     ...
     *
     * @param cellBorder  Default value is 0
     ...
     *
     * @param clipItemTitles  Default value is false
     */
     ...
     * see {@link com.smartgwt.client.widgets.form.DynamicForm#getValuesAsCriteria DynamicForm.getValuesAsCriteria} for
     * settings that cause a form to produce AdvancedCriteria.
     *
     * @param defaultSearchOperator  Default value is null
     * @throws IllegalStateException this property cannot be changed after the component has been created
     */
     ...
     *
     * @param disableValidation  Default value is null
     ...
     *
     * @param editProxyConstructor  See {@link com.smartgwt.client.docs.SCClassName SCClassName} . Default value is "FormEditProxy"
     * @throws IllegalStateException this property cannot be changed after the component has been created
     */
     ...
     * <p><b>Note : </b> This is an advanced setting</p>
     *
     * @param encoding  Default value is DynamicForm.NORMAL
     * @see com.smartgwt.client.docs.Submitting Submitting overview and related methods
     */
     ...
     * to this item.
     *
     * @param errorItemCellStyle  Default value is "formCellError"
     * @throws IllegalStateException this property cannot be changed after the component has been created
     * @see com.smartgwt.client.docs.Validation Validation overview and related methods
     */
     ...
     *
     * @param fixedColWidths  Default value is false
     * @see com.smartgwt.client.docs.FormLayout FormLayout overview and related methods
     */
     ...
     * <p><b>Note : </b> This is an advanced setting</p>
     *
     * @param formSubmitFailedWarning  Default value is "Form was unable to be submitted. The most likely cause for this is an invalid value in an upload field."
     */
     ...
     *
     * @param hiliteRequiredFields  Default value is true
     ...
     *
     * @param implicitSaveDelay  Default value is 2000
     */
     ...
     *
     * @param itemHoverAlign  Default value is null
     ...
     *
     * @param itemHoverDelay  Default value is 500
     ...
     *
     * @param itemHoverHeight  Default value is null
     ...
     *
     * @param itemHoverOpacity  Default value is null
     ...
     *
     * @param itemHoverVAlign  Default value is null
     ...
     *
     * @param itemHoverWidth  Default value is null
     ...
     * <p><b>Note : </b> This is an advanced setting</p>
     *
     * @param itemLayout  Default value is "table"
     * @see com.smartgwt.client.docs.FormLayout FormLayout overview and related methods
     */
     ...
     *
     * @param longTextEditorType  Default value is "textArea"
     * @see com.smartgwt.client.docs.Appearance Appearance overview and related methods
     */
     ...
     *
     * @param minColWidth  Default value is 20
     * @see com.smartgwt.client.docs.FormLayout FormLayout overview and related methods
     */
     ...
     *
     * @param numCols  Default value is 2
     * @see com.smartgwt.client.docs.FormLayout FormLayout overview and related methods
     */
    ...
    /**
     * Should the value of items that are {@link com.smartgwt.client.widgets.form.fields.FormItem#getCanEdit canEdit:false},
     * and  {@link com.smartgwt.client.widgets.form.fields.FormItem#getReadOnlyDisplay readOnlyDisplay:"static"} be clipped if
     * they overflow the  specified size of the item? <P> Can be overridden via {@link
     * com.smartgwt.client.widgets.form.fields.FormItem#getReadOnlyClipValue readOnlyClipValue} on individual FormItems.
     *
     * @param readOnlyClipValue  Default value is false
     */
    public void setReadOnlyClipValue(Boolean readOnlyClipValue) {
        setAttribute("readOnlyClipValue", readOnlyClipValue, true);
    }
    ...
    public Boolean getReadOnlyClipValue()  {
        Boolean result = getAttributeAsBoolean("readOnlyClipValue");
        return result == null ? false : result;
    }
    

    /**
     * If {@link com.smartgwt.client.widgets.form.DynamicForm#getCanEdit canEdit} is set to <code>false</code>, how should this
     * items in this form be displayed to the user? <P> Can be overridden via {@link
     * com.smartgwt.client.widgets.form.fields.FormItem#getReadOnlyDisplay readOnlyDisplay} on individual FormItems.
     *
     * <br><br>If this method is called after the component has been drawn/initialized:
     ...
     * <code>"static"</code>. <P> Can be overridden via {@link
     * com.smartgwt.client.widgets.form.fields.FormItem#getReadOnlyTextBoxStyle readOnlyTextBoxStyle} on individual FormItems.
     *
     ...
     * <p><b>Note : </b> This is an advanced setting</p>
     *
     * @param rejectInvalidValueOnChange  Default value is null
     */
    ...
    /**
     * The string pre-pended to the title of every required item in this form if highlightRequiredFields is true.
     *
     ...
     * method.
     *
     * @param saveOnEnter  Default value is false
     * @see com.smartgwt.client.docs.Submitting Submitting overview and related methods
     */
     ...
     *
     * @param sectionVisibilityMode  Default value is "multiple"
     ...
     *
     * @param selectOnClick  Default value is false
     * @see com.smartgwt.client.docs.Focus Focus overview and related methods
     */
     ...
     * selectOnFocus}.
     *
     * @param selectOnFocus  Default value is false
     * @see com.smartgwt.client.docs.Focus Focus overview and related methods
     */
     ...
     *
     * @param showComplexFieldsRecursively  Default value is null
     * @throws IllegalStateException this property cannot be changed after the component has been created
     */
     ...
     * com.smartgwt.client.docs.FormItemBaseStyle} for a  discussion for how error styling is calculated.
     *
     ...
     * com.smartgwt.client.docs.FormItemBaseStyle} for a  discussion for how error styling is calculated.
     *
     * @param showErrorStyle  Default value is true
     * @see com.smartgwt.client.docs.Validation Validation overview and related methods
     */
     ...
     * com.smartgwt.client.docs.FormItemBaseStyle} for a  discussion for how error styling is calculated.
     *
     * @param showErrorText  Default value is false
     * @see com.smartgwt.client.docs.Validation Validation overview and related methods
     */
     ...
     *
     * @param showInlineErrors  Default value is true
     * @see com.smartgwt.client.docs.Validation Validation overview and related methods
     */
     ...
     * title for the item.
     *
     * @param showTitlesWithErrorMessages  Default value is false
     * @see com.smartgwt.client.docs.Validation Validation overview and related methods
     */
     ...
     * default by specifying {@link com.smartgwt.client.rpc.RPCRequest#getWillHandleError dsRequest.willHandleError} on the
     * DSRequest. In this case the callback passed in  will be fired even if the server returns an error status code. <P> If
     ...
     * <p><b>Note : </b> This is an advanced setting</p>
     *
     * @param suppressValidationErrorCallback  Default value is false
     */
     ...
     *
     * @param synchronousValidation  Default value is false
     * @throws IllegalStateException this property cannot be changed after the component has been created
     */
     ...
     *
     * @param userTask  Default value is null
     * @throws IllegalStateException this property cannot be changed after the component has been created
     */
     ...
     *
     * @param validationURL  Default value is null
     * @see com.smartgwt.client.widgets.form.DynamicForm#saveData
     * @see com.smartgwt.client.widgets.form.DynamicForm#submit
     * @see com.smartgwt.client.docs.Validation Validation overview and related methods
     */
     ...
     * com.smartgwt.client.widgets.form.DynamicForm#getValues DynamicForm.getValues}. <P> Providing values on initialization is
     * equivalent to calling {@link com.smartgwt.client.widgets.form.DynamicForm#setValues DynamicForm.setValues}. <P> As the
     * user manipulates form items to change values, change events fire {@link
     ...
     * com.smartgwt.client.docs.Items form item} in the form, and each property value is the value held by that form item.
     */
     ...
     *
     * @param wrapItemTitles  Default value is null
     * @see com.smartgwt.client.docs.FormTitles FormTitles overview and related methods
     */
     ...
     * com.smartgwt.client.widgets.form.DynamicForm#setValues DynamicForm.setValues}. <P> This method will also call {@link
     ...
     * ValuesManager.hiddenValidationErrors}. <P> In the case of a validation error, the callback will <b>not</b> be called by
     * default since the form has already handled the failed save by displaying the validation errors to the user.  If you need
     * to do something additional in this case, you can set {@link com.smartgwt.client.rpc.RPCRequest#getWillHandleError
     * willHandleError} via the <code>requestProperties</code> parameter to force your callback to be invoked.  However, first
     * consider: <ul> <li> if you are trying to customize display of validation errors, there are several {@link
     ...
     * com.smartgwt.client.widgets.form.DynamicForm#addHiddenValidationErrorsHandler DynamicForm.hiddenValidationErrors} <P> If
     * this form has any fields which require server-side validation  (see {@link
     ...
     * com.smartgwt.client.widgets.form.DynamicForm#addAsyncValidationReplyHandler DynamicForm.asyncValidationReply} to detect
     * and respond to asynchronous validation.
     ...
     * @see com.smartgwt.client.docs.Validation Validation overview and related methods
     */
    public native void validateData(DSCallback callback, DSRequest requestProperties) /*-{
        var self = this.@com.smartgwt.client.widgets.BaseWidget::getOrCreateJsObj()();
        self.validateData(
			$entry( function(dsResponse, data, dsRequest) { 
				if(callback!=null) callback.@com.smartgwt.client.data.DSCallback::execute(Lcom/smartgwt/client/data/DSResponse;Ljava/lang/Object;Lcom/smartgwt/client/data/DSRequest;)(
    ...
    */
    ...
    public LogicalStructureObject setLogicalStructure(DynamicFormLogicalStructure s) {
        ...
        try {
            s.readOnlyClipValue = getAttributeAsString("readOnlyClipValue");
        } catch (Throwable t) {
            s.logicalStructureErrors += "DynamicForm.readOnlyClipValue:" + t.getMessage() + "\n";
        }
        try {
