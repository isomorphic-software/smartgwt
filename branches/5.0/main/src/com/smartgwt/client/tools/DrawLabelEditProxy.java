...
/**
 * {@link com.smartgwt.client.tools.EditProxy} that handles {@link com.smartgwt.client.widgets.drawing.DrawLabel
 * DrawLabels} when editMode is enabled.
 * @see com.smartgwt.client.docs.DevTools DevTools overview and related methods
 */
@BeanFactory.FrameworkClass
@BeanFactory.ScClassName("DrawLabelEditProxy")
public class DrawLabelEditProxy extends DrawItemEditProxy {
    ...
    public static DrawLabelEditProxy getOrCreateRef(JavaScriptObject jsObj) {
        ...
        if(obj != null) {
            return (DrawLabelEditProxy) obj;
        } else {
            return new DrawLabelEditProxy(jsObj);
        }
    }


    public DrawLabelEditProxy(){
        scClassName = "DrawLabelEditProxy";
    }
