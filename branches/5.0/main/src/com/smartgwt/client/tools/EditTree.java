 ...
 * directly set or looked at. <P> EditTree supports the {@link com.smartgwt.client.tools.EditContext} public API although
 * it is not an EditContext. The properties and method calls are passed through to the EditContext instance.
...
public class EditTree extends TreeGrid {
    ...
    public static native void changeAutoChildDefaults(String autoChildName, Canvas defaults) /*-{
        $wnd.isc.EditTree.changeDefaults(autoChildName + "Defaults", defaults.@com.smartgwt.client.widgets.Canvas::getConfig()());
    }-*/;
    ...
    public static native void changeAutoChildDefaults(String autoChildName, FormItem defaults) /*-{
        $wnd.isc.EditTree.changeDefaults(autoChildName + "Defaults", defaults.@com.smartgwt.client.widgets.form.fields.FormItem::getJsObj()());
    }-*/;
     ...
     * created.
     *
     * @param editContext  Default value is null
     * @throws IllegalStateException this property cannot be changed after the component has been created
     */
     ...
     * created.
     *
     * @return Returns the {@link com.smartgwt.client.tools.EditContext} instance managed by the EditTree.
     */
     ...
     * node. <P> Can be retrieved at any time. Use {@link com.smartgwt.client.tools.EditTree#getRootEditNode
     * EditTree.getRootEditNode} to retrieve the {@link com.smartgwt.client.tools.EditNode} created from the rootComponent.
     *
     ...
     * com.smartgwt.client.tools.EditTree#serializeAllEditNodesAsJSON EditTree.serializeAllEditNodesAsJSON} or {@link
     * com.smartgwt.client.tools.EditTree#serializeEditNodesAsJSON EditTree.serializeEditNodesAsJSON}. <P> By default,
     * components that have {@link com.smartgwt.client.widgets.Canvas#getID global IDs} will not actually be allowed to take
     * those global IDs - instead, only widgets that have one of the global IDs passed as the <code>globals</code> parameter
     * will actually receive their global IDs.  To override this behavior, pass the special value {@link
     * com.smartgwt.client.rpc.RPCManager#ALL_GLOBALS ALL_GLOBALS} for the <code>globals</code> parameter.
     ...
     * com.smartgwt.client.tools.PaletteNode PaletteNodes} (possibly created by calling {@link
     * com.smartgwt.client.tools.EditTree#serializeAllEditNodes EditTree.serializeAllEditNodes} or {@link
     * com.smartgwt.client.tools.EditTree#serializeEditNodes EditTree.serializeEditNodes}. <P> By default, components that have
    ...
    public static native void setDefaultProperties(EditTree editTreeProperties) /*-{
    	var properties = $wnd.isc.addProperties({},editTreeProperties.@com.smartgwt.client.widgets.BaseWidget::getConfig()());
