...
public class TabSetEditProxy extends CanvasEditProxy {
     ...
     * com.smartgwt.client.tools.EditProxy#getInlineEditForm inlineEditForm} to obtain the starting edit value. <p> Returns a
     * comma-separated list of tab titles. A " [x]" suffix is added for any tab with <code>canClose</code> enabled.
     */
     ...
     * com.smartgwt.client.tools.EditProxy#getInlineEditForm inlineEditForm} to commit the change. <p> Takes a comma-separated
     * list of tab titles. Add " [x]" to a title to enable <code>canClose</code> for the tab.
