 ...
 * although some chart types are only capable of showing a single facet of data. <P> Concrete
 * charting implementations may use any value for <code>chartType</code> but should support the
 * provided <code>chartType</code> values for charts that correspond to the visual presentation
