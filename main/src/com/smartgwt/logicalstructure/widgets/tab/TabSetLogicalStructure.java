...
public class TabSetLogicalStructure extends CanvasLogicalStructure {
    public String addTabButtonIcon;
    public String animateTabScrolling;
    public String ariaCloseableSuffix;
    public String canAddTabs;
    ...
    public Tab selectedTabAsTab;
    public String selectedTabAsString;
    ...
    public String simpleTabIconOnlyBaseStyle;
    ...
    public String touchPickerButtonSize;
