...
public class SplitPaneLogicalStructure extends LayoutLogicalStructure {
    public String addHistoryEntries;
    public String animateNavigationBarStateChanges;
    public String autoNavigate;
    public String currentPane;
    public Canvas detailNavigationControl;
    public Canvas detailPane;
    public String detailPaneTitleTemplate;
