...
public class CanvasLogicalStructure extends BaseWidgetLogicalStructure {
    ...
    public String childrenResizeSnapAlign;
    public String childrenSnapAlign;
    public String childrenSnapCenterAlign;
    public String childrenSnapEdgeAlign;
    ...
    public String disableTouchScrollingForDrag;
    public String doubleClickDelay;
    public String dragAppearance;
    public String dragIntersectStyle;
    public String dragMaskType;
    public String dragMaxHeight;
    public String dragMaxWidth;
    public String dragMinHeight;
    public String dragMinWidth;
    ...
    public String isPrinting;
    public String isRuleScope;
    public String isSnapAlignCandidate;
    public String leavePageSpace;
    ...
    public String sizeMayChangeOnRedraw;
    public String skinImgDir;
    public Canvas[] snapAlignCandidates;
    public String snapAlignCenterLineStyle;
    ...
    public String snapResizeToAlign;
    public String snapResizeToGrid;
    public String snapTo;
    public String snapToAlign;
    public String snapToCenterAlign;
    public String snapToEdgeAlign;
    ...
    public String useCSSShadow;
    public String useImageForSVG;
    public String useNativeDrag;
    public String useOpacityFilter;
    public String useTouchScrolling;
    public ValuesManager valuesManagerAsValuesManager;
    public String valuesManagerAsString;
    public String visibility;
    public AdvancedCriteria visibleWhen;
}
