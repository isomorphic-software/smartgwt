...
public class CubeGridLogicalStructure extends ListGridLogicalStructure {
    ...
    public String autoFitColumnTitle;
    ...
    public String chartDialogTitle;
    public String chartItemTitle;
    public String chartStackedTitle;
    public String chartType;
    public String chartTypeTitle;
    public String colHeaderBaseStyle;
    public String colHeaderLabelBaseStyle;
    public String[] columnFacets;
    public String controlCloseTitle;
    public String controlMaximizeTitle;
    public String controlMinimizeTitle;
    public String controlReorderHandleTitle;
    public String controlSortDownTitle;
    public String controlSortUpTitle;
    public CellRecord[] data;
    public DataSource dataSource;
    public String defaultFacetWidth;
    public String editByCell;
    public String enableCharting;
    public String exportColumnFacetBGColor;
    public String exportColumnFacetTextColor;
    public String exportFacetBGColor;
    public String exportFacetSeparatorString;
    public String exportFacetTextColor;
    public String exportRowFacetBGColor;
    public String exportRowFacetTextColor;
    public String facetLabelHoverAlign;
    public String facetLabelHoverHeightAsString;
    public String facetLabelHoverStyle;
    public String facetLabelHoverVAlign;
    public String facetLabelHoverWidthAsString;
    public String facetTitleAlign;
    public String facetValueAlign;
    public MenuItem[] facetValueContextItems;
    public String facetValueHoverAlign;
    public String facetValueHoverHeightAsString;
    public String facetValueHoverStyle;
    public String facetValueHoverVAlign;
    public String facetValueHoverWidthAsString;
    public String fieldVisibilitySubmenuTitle;
    public FacetValueMap fixedFacetValues;
    public String hideAllHighlightsTitle;
    public String hideEmptyAxis;
    public String hideEmptyFacetValues;
    public String highlightCellTitle;
    public String highlightSelectionTitle;
    public String highlightTitle;
    public Hilite[] hilites;
    public String indentVTreeFacets;
    public String innerHeaderBaseStyle;
    public String maximizeColumnTitle;
    public String metricFacetId;
    public String minimizeColumnTitle;
    public String noHighlightsTitle;
    public String padTitles;
    public String renameFacetValueMessage;
    public String renameFacetValueTitle;
    ...
    public String rowHeaderLabelBaseStyle;
    public String saveByCell;
    public String showAllHighlightsTitle;
    public String showFacetContextMenus;
    public String showFacetValueContextMenus;
    public String showHighlightsTitle;
    public String showHoverTipsTitle;
    public String simpleDeselect;
    public String skinImgDir;
    public String sortDirection;
    public FacetValueMap sortedFacetValues;
    public String styleName;
    public String valueExportFormat;
