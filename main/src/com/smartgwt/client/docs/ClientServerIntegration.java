 ...
 * com.smartgwt.client.docs.WriteCustomDataSource custom DataSource}</li>     <li>Whether or not your storage is SQL, add
 * business logic either declaratively in the          DataSource definition, via DMI, or any combination of the two:  
 * <ul><li>The &lt;criteria&gt; and &lt;values&gt; properties of an {@link com.smartgwt.client.data.OperationBinding}      
 ...
 * in         {@link com.smartgwt.client.docs.ServerDataIntegration the server integration overview}. </ul> </ul> <ul>
 * <li>If you do not have a Java server</li>   <ul><li>If you are not obliged to use a pre-existing network protocol, use
 * the            {@link com.smartgwt.client.data.RestDataSource}</li>       <li>Otherwise, use {@link
