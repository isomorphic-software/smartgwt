 ...
 * Velocity templates you write to implement {@link com.smartgwt.client.docs.CustomQuerying custom
 * queries}, 
 *   transaction chaining,  
 * {@link com.smartgwt.client.docs.serverds.OperationBinding#requires dynamic security checking}
 * and 
 ...
 * precision.  If you are not using {@link com.smartgwt.client.rpc.RPCManager#startQueue queuing},
 * this value will be
 *  identical to <b>$currentDate</b></li>
 *  <li><b>$servletRequest</b>. The associated <code>HttpServletRequest</code></li> 
 * <li><b>$dsRequest</b>. The associated {@link com.smartgwt.client.data.DSRequest} (though of
 * course this is a
 ...
 * <li><b>$dataSources</b>. This variable gives you access to Smart GWT {@link
 * com.smartgwt.client.data.DataSource}s.  
 ...
 * - you need to use either <code>$httpParameters</code> or
 ...
 *  </pre>
 * When you use these Velocity variables in a {@link
 * com.smartgwt.client.docs.serverds.OperationBinding#customSQL customSQL} 
 * clause or SQL snippet such as a {@link
 * com.smartgwt.client.docs.serverds.OperationBinding#whereClause whereClause}, all of 
 ...
 * {@link com.smartgwt.client.docs.CustomQuerying} for details of these variables). 
 * So:<br><br><code>
 ...
 * These {@link com.smartgwt.client.docs.serverds.OperationBinding#values values} clauses set
