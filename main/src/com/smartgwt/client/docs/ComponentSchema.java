 ...
 * <li>instanceConstructor="MyListGrid" indicates the Smart GWT class that&#010  create() should be called on to construct
 * an instance.&#010 <li>showLocalFieldsOnly is a boolean that, when set to true, tells the {@link
 * com.smartgwt.client.docs.VisualBuilder}&#010 to show only the fields declared in this schema in the component editor. 
 * Otherwise fields&#010 inherited via {@link com.smartgwt.client.data.DataSource#getInheritsFrom inheritsFrom} (all the
 * way up the chain) are also included.&#010 <li>showSuperClassEvents is a boolean that, like showLocalFieldsOnly,
 * optionally restricts&#010 the list of events shown in the Events tab of the {@link
 * com.smartgwt.client.docs.VisualBuilder} to those defined in&#010 this schema only.&#010 <li>showSuperClassActions is a
 * boolean that optionally restricts the list of actions shown&#010 in the menu when you map a component Event to a
 * component Action within {@link com.smartgwt.client.docs.VisualBuilder}&#010 to those defined in this schema only.&#010
 ...
 * order to modify properties such as {@link com.smartgwt.client.data.DataSourceField#getEditorType field.editorType}.&#010
 * <P>&#010 The following DataSourceField properties have special significance when a component schema&#010 is used to
 * process {@link com.smartgwt.client.docs.ComponentXML component XML}:&#010 <ul>&#010 <li> {@link
 * com.smartgwt.client.data.DataSourceField#getType field.type} declares the type of the field, and hence the&#010 type of
 * the JavaScript value your custom class will be initialized with.  In order to&#010 declare subcomponents, can be set to
 * the name of another component (built-in or custom).  &#010 <li> {@link
 ...
 * StringMethod} via  Class.registerStringMethods.&#010 <p>&#010 In order for a method to be considered an action, it needs
 * to have a method definition in&#010 the methods array and have the <code>action</code> property set to
 * <code>true</code>.  For&#010 example, the following is a definition of the 'hide' action available on any Canvas,
 * as&#010 copied from Canvas.ds.xml:&#010 <pre>&#010     &lt;methods&gt;&#010         &lt;method name="hide" title="Hide"
 * action="true"/&gt;&#010     &lt;/methods&gt;&#010 </pre>&#010 For custom component actions, an array of expected
 * parameters may be specified using the&#010 <code>params</code> attribute. Each entry in this array should have a
 * specified type.&#010 By doing this, you allow the visual builder to pass parameters through to actions when setting
 ...
 * com.smartgwt.client.widgets.grid.ListGrid#addRecordClickHandler recordClick} event with this custom method, the&#010
 * Visual Builder logic would automatically associate the parameters available in the fired event&#010 (in this case
