 ...
 * <li>showLocalFieldsOnly is a boolean that, when set to true, tells the {@link
 * com.smartgwt.client.docs.VisualBuilder}
 *  to show only the fields declared in this schema in the component editor.  Otherwise fields
 * inherited via {@link com.smartgwt.client.data.DataSource#getInheritsFrom inheritsFrom} (all the
 * way up the chain) are also included.
 *  <li>showSuperClassEvents is a boolean that, like showLocalFieldsOnly, optionally restricts
 * the list of events shown in the Events tab of the {@link
 * com.smartgwt.client.docs.VisualBuilder} to those defined in
 *  this schema only.
 *  <li>showSuperClassActions is a boolean that optionally restricts the list of actions shown
 * in the menu when you map a component Event to a component Action within {@link
 * com.smartgwt.client.docs.VisualBuilder}
 ...
 * the class as a {@link com.smartgwt.client.docs.StringMethods StringMethod} via 
 ...
 * parameter of type {@link com.smartgwt.client.widgets.grid.ListGridRecord} you could define it
 * as follows:
 *  <pre>
 ...
 *      &lt;/method&gt;
 *  </pre>
 * If a user working within the visualBuilder then added ListGrid to the page and used the "+"
 * icon
 * to associate the {@link com.smartgwt.client.widgets.grid.ListGrid#addRecordClickHandler
 * recordClick} event with this custom method, the
