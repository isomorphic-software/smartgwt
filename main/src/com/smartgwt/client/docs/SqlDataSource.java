 ...
 * The Smart GWT Server supports comprehensive, codeless SQL connectivity for DataSources
 ...
 * of any complexity.  {@link com.smartgwt.client.docs.SqlVsJPA This article} compares the
 * built-in SQL DataSource
 *  to other persistence approaches based on Javabeans.
 *  <P>
 * To use the built-in SQL engine, declare a {@link com.smartgwt.client.data.DataSource} in XML
 * format with
 * {@link com.smartgwt.client.docs.serverds.DataSource#serverType DataSource.serverType} set to
 * "sql", and place it in the shared dataSources directory
 *  ([webroot]/shared/ds by default) in a file called "[dataSourceId].ds.xml".
 *  <p>
 * You can then use the {@link com.smartgwt.client.docs.AdminConsole Admin Console} to configure
 * database access,
 ...
 * can set {@link com.smartgwt.client.docs.serverds.DataSource#dbName DataSource.dbName} to the
 ...
 *  <p>
 *  <table class='normal'>
 * <tr><td width=40></td><td width=400><i>HSQLDB 1.7.x, 1.8.x, 2.0.x, 2.2.x, 2.3.x, 2.4.x,
 * 2.5.x</i></td><td></td></tr>
 *  <tr><td></td><td><i>IBM DB2 8.x, 9.x, 10.x, 11.x</i></td><td></td></tr>
 * <tr><td></td><td><i>IBM DB2 for i (formerly known as DB2 for i5/OS) V5R4M0
 * onwards</i></td><td></td></tr>
 *  <tr><td></td><td><i>Firebird 2.5.x, 3.x</i></td><td></td></tr>
 *  <tr><td></td><td><i>Informix 12.10.x, 14.10.x</i></td><td></td></tr>
 * <tr><td></td><td><i>MS SQL Server 2000, 2005, 2008, 2008 R2, 2012, 2014, 2016, 2017,
 * 2019</i></td><td></td></tr>
 ...
 *  <a href="http://forums.smartclient.com">Smart GWT forums</a> for assistance.
 *  <P>
 * You can connect to an existing database table by providing a {@link
 * com.smartgwt.client.docs.serverds.DataSource#tableName DataSource.tableName}
 *  attribute value.  Field-level details can be provided explicitly, if you choose, or these
 * can be automatically inferred from your schema via {@link
 ...
 * following field definition overrides an automatically {@link
 * com.smartgwt.client.data.DataSource#getAutoDeriveTitles derived title}
 ...
 * {@link com.smartgwt.client.rpc.RPCManager#actionURL actionURL}, and hence handled
 * automatically, without you having
 * to write any Java code, by the {@link com.smartgwt.client.docs.ServletDetails IDACall servlet
 ...
 * this description of {@link com.smartgwt.client.docs.ServerDataIntegration server data
 * integration}.
