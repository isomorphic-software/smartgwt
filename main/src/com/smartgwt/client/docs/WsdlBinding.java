 ...
 * becomes a JavaScript Date object)&#010 <li> {@link com.smartgwt.client.data.XMLTools#loadXMLSchema import of XML Schema}
 * (contained in WSDL, or external),&#010 including translating XML Schema "restrictions" to ISC {@link
 * com.smartgwt.client.widgets.form.validator.Validator Validators}&#010 </ul>&#010 <P>&#010 WSDL services can be contacted
 ...
 * com.smartgwt.client.data.WebService#getFetchDS WebService.getFetchDS(<i>operationName,elementName</i>)}&#010 <P>&#010 to
 * obtain a DataSource which describes the structure of an XML element or XML Schema type&#010 named <i>elementName</i>,
 * which appears in the response message for the operation named&#010 <i>operationName</i>.  A component bound to this
 * DataSource will show fields corresponding&#010 to the structure of the chosen XML element or type, that is, one field
 * per subelement or&#010 attribute.  {@link com.smartgwt.client.widgets.grid.ListGrid#fetchData fetchData()} called on
 * this DataSource (or on a&#010 component bound to it) will invoke the specified web service operation, using the&#010
 * {@link com.smartgwt.client.data.Criteria} passed to fetchData() to fill out the input message via&#010 {@link
 ...
 * WebService.getInputDS(<i>operationName</i>)} returns&#010 a DataSource suitable for binding to a form that a user will
 * fill out to provide inputs to&#010 the specified web service operation.  Typical use is to let the user fill in the
 * form, then&#010 pass the results of {@link com.smartgwt.client.widgets.form.DynamicForm#getValues form.getValues()}
 * to&#010 {@link com.smartgwt.client.widgets.grid.ListGrid#fetchData fetchData()} as criteria.&#010 <P>&#010 If the input
 * message to the web service has extra nesting, consider using&#010 the {@link
 * com.smartgwt.client.data.OperationBinding#getUseFlatFields useFlatFields} property to simplify the inputs&#010 required
 * for <code>fetchData()</code>, and/or to simplify form databinding via&#010 {@link
 ...
 * available to you via {@link com.smartgwt.client.data.WebService#getSchema WebService.getSchema} and {@link
 ...
 * operations} on persistent data, &#010 {@link com.smartgwt.client.data.OperationBinding OperationBindings} can be
 * declared for each DataSource operation, and&#010 the {@link com.smartgwt.client.data.OperationBinding#getWsOperation
 * wsOperation} property can be used to to bind each&#010 {@link com.smartgwt.client.docs.DataSourceOperations DataSource
 * operation} (fetch, update, add, remove) to a&#010 corresponding web service operation.&#010 <P>&#010 For example, this
 * code accomplishes part of the binding to the &#010 <a href='http://www.google.com/search?q=sforce+partner+wsdl'
 ...
 * invoke&#010 the "create" operation, and {@link com.smartgwt.client.widgets.form.DynamicForm#getValues form.values} will
 * become&#010 {@link com.smartgwt.client.data.DSRequest#getData data} and be serialized to form the input message of the
 * "create" web&#010 service operation.&#010 <P>&#010 Typical usage is:&#010 <ol>&#010 <li> declare a DataSource that
 * represents the fields of the object as you want them&#010 represented in the UI.  This DataSource is considered the
 * "entity DataSource".  It may&#010 extend from an XML Schema complex type via {@link
 * com.smartgwt.client.data.DataSource#getInheritsFrom inheritsFrom}.&#010 <li> use {@link
 * com.smartgwt.client.data.OperationBinding operationBindings} to configure the entity DataSource to&#010 call the
 * appropriate web service operations for each DataSource operation, and extract&#010 results via&#010 {@link
 * com.smartgwt.client.data.OperationBinding#getRecordXPath recordXPath}/{@link
 * com.smartgwt.client.data.OperationBinding#getRecordName recordName}&#010 <li> bind components as follows:&#010 <ul>&#010
 * <li> bind {@link com.smartgwt.client.widgets.grid.ListGrid grids} to the entity DataSource&#010 <li> bind {@link
 * com.smartgwt.client.widgets.form.SearchForm SearchForms} to the input message of the fetch operation&#010 (obtained via
 * {@link com.smartgwt.client.data.WebService#getInputDS webService.getInputDS("operationName")}.  This is&#010 done
 * because search inputs are frequently unrelated to the structure of the objects being&#010 searched for&#010 <li> bind
 * forms use for editing ("add" and "update" operations) to the entity DataSource&#010 </ul>&#010 <li> use&#010 {@link
 * com.smartgwt.client.data.DataSource#transformRequest transformRequest}/{@link
 * com.smartgwt.client.data.DataSource#transformResponse transformResponse}, &#010 {@link
 ...
 * loadWSDLTag &lt;isc:loadWSDL&gt; JSP tag}&#010 is recommended, as it automatically caches a translated form of the WSDL
 * file.  If you are&#010 not using the Smart GWT server, the WSDL tab in the Developer Console allows you&#010 to save a
 * .js file representing a WebService object, which can then be loaded and cached&#010 like a normal JavaScript file.&#010
 * <P>&#010 <B>Creating New WSDL Services</B>&#010 <P>&#010 If you have no existing WSDL web service but would like to use
 * web services for integration,&#010 you can implement the "Smart GWTOperations" web service described by the&#010
 * ${isc.DocUtils.externalLink(isc.Page.getIsomorphicDir()+"system/schema/Smart GWTOperations.wsdl","WSDL file")} &#010
 ...
 * DataSources}).  To change the URL where ISC&#010 expects to find the Smart GWTOperations web service, use {@link
 * com.smartgwt.client.data.WebService#setLocation WebService.setLocation}&#010 like so:<pre>&#010      var service =
