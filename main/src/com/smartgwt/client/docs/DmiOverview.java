 ...
 * {@link com.smartgwt.client.data.DataSource#getServerObject serverObject} or on a particular
 * operationBinding via
 * {@link com.smartgwt.client.docs.serverds.OperationBinding#serverObject serverObject}.  The
 * ServerObject specifies the target of the method
 * invocation and {@link com.smartgwt.client.docs.serverds.OperationBinding#serverMethod
 * serverMethod} specifies the method that will be
 *  called.
 *  <P>
 ...
 * com.smartgwt.client.docs.serverds.OperationBinding#serverMethod serverMethod}.  The method must
 * be public,
 ...
 * {@link com.smartgwt.client.docs.serverds.ServerObject#dropExtraFields dropExtraFields}, on a
 * per-DataSource level by setting
 * {@link com.smartgwt.client.data.DataSource#getDropExtraFields dropExtraFields}, or globally by
 ...
 * com.smartgwt.client.data.DataSource#getDropExtraFields dropExtraFields} which
 ...
 * {@link com.smartgwt.client.docs.serverds.ServerObject#visibleMethods visibleMethods} block that
 * specifies which methods are callable on this
 *  ServerObject.  This section is not consulted for DataSource DMIs because the
 * {@link com.smartgwt.client.docs.serverds.OperationBinding#serverMethod serverMethod} is used to
 * specify the callable method in that case.
 *  <p>
 ...
 * onclick="window.open('/examples/server_integration/#customDataSourceIntegrationDMI');return
 * false;">the supplyItemDMI example</a>
 ...
 * See {@link com.smartgwt.client.rpc.RPCRequest#getData data} for an overview of how server side
