 ...
 * (<i>requires <a href='http://smartclient.com/product' target='_blank'>Reify OEM
 * license</a></i>)
 *  </ul>
 ...
 *  dialog similar to Reify's File -&gt; Import dialog will immediately appear.  
 *  
 ...
 *  imports the same tools module required to run Reify).
 *  
 *  <li> in Reify: select the Screen menu option "Import from Balsamiq".
 *  You can provide the Balsamiq mockup file in
 *  various ways; providing a file will automatically load the screen created from the imported
 *  Balsamiq mockup into Reify for further editing.
 *  </ul>
 ...
 *  <P>
 *  Both tools can also save to a file under webroot.  In Reify, use Screen-&gt;Save screen as.
 *  In the standalone tool, use the "Output File" text field in the initial dialog.  This is
 *  most useful if you are using an "exploded" deployment .  If you are using the Eclipse IDE 
 ...
 *  <P>
 *  Balsamiq supports
 * <a href='https://balsamiq.com/wireframes/desktop/docs/linking/' target='_blank'>linking
 ...
 * <a href='https://balsamiq.com/wireframes/desktop/docs/symbols/' target='_blank'>symbols</a>,
 * which are
 ...
 * <li>"com.balsamiq.mockups::ButtonBar": {@link
