 ...
 * application:&#010 <ul>&#010 <li> <b>call Spring beans via SmartGWT DMI</b> <span&#010
 * style="color:red">[Recommended]</span>: use SmartGWT Direct Method Invocation&#010 (DMI) to map {@link
 ...
 * Beans, such&#010 as EJB or Hibernate-managed beans, can be directly returned to SmartGWT as the result of&#010 a DMI
 ...
 * 'dropExtraFields'}.  In this integration scenario, the&#010 majority of the features of the SmartGWT Server framework
 ...
 * different type of View in order to output XML or&#010 JSON data instead of complete HTML pages.  The SmartGWT {@link
 ...
 * Spring applications, all existing Spring workflows can be made callable by&#010 SmartGWT with a generic View class
 * capable of serializing the Model to XML or JSON,&#010 combined with a Controller that always uses this View.  Consider
 * the following Java&#010 anonymous class, which uses the SmartGWT JSTranslater class to dump the entire &#010 Spring
 * Model as a JSON response.&#010 <pre>&#010  new View() {&#010        public void render(Map model, HttpServletRequest
 * request,&#010                           HttpServletResponse response) throws IOException {&#010                final
 * ServletOutputStream outputStream = response.getOutputStream();&#010               
 ...
 * easiest path.&#010 </ul>&#010 <P>&#010 <b>Using Spring Controllers with SmartGWT DMI</b>&#010 <P>&#010 You can create a
 * Controller that invokes standard SmartGWT server request processing,&#010 including DMI, like so:&#010 <pre>&#010 public
 * class SmartGWTRPCController extends AbstractController&#010 {&#010     public ModelAndView
