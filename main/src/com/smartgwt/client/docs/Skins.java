 ...
 * <li><code>skin_styles.css</code>: a .css file defining the set of      classes to apply to SmartGWT components' visual
 * elements</li> <li><code>images/</code>: a directory of image files used as part of visual      components</li>
 * <li><code>load_skin.js</code>: a .js file containing overrides for various      SmartGWT component properties that
 ...
 * contains a {@link com.smartgwt.client.util.Page#setSkinDir}  directive to set up the skin dir (used to ensure media is
 * retrieved from the appropriate directory), and a {@link com.smartgwt.client.util.Page#loadStyleSheet} directive to load
 * the .css file. <P> See the {@link com.smartgwt.client.docs.Skinning 'Skinning Overview'} for more information.
