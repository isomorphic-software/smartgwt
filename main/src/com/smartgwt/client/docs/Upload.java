 ...
 * record in a related DataSource. <P> See the {@link
 ...
 * com.smartgwt.client.widgets.form.DynamicForm#getEncoding encoding} to "multipart" <li> include
 * an {@link com.smartgwt.client.widgets.form.fields.UploadItem} to get a basic HTML upload
 * control <li> set {@link com.smartgwt.client.widgets.form.DynamicForm#getAction action} to a URL
 * where you have deployed server-side code to handle the upload <li> call {@link
