 ...
 * com.smartgwt.client.widgets.grid.ListGrid#getFixedRecordHeights 'fixedRecordHeights:false'}) <li> headers that autoFit
 * to titles (normally enabled via      <code>field.overflow:"visible"</code>) <li> the {@link
 * com.smartgwt.client..CubeGrid} subclass of ListGrid <li> nested grids </ul> The frozen fields feature <b>is</b>
 * compatible with column resize and reorder, selection and multi-selection, loading data on demand, inline editing, drag
 * and drop and reorder of records, the {@link com.smartgwt.client.widgets.tree.TreeGrid} subclass of ListGrid, and all
 * dynamic styling-related and formatting-related features.
