 ...
 *  <h4>CSS3 mode</h4>
 *  <P>
 *  3 of Smart GWT's most commonly used skins - Enterprise, EnterpriseBlue and Graphite - now
 ...
 *  <P>
 *  By default CSS3 mode is automatically used in modern browsers such as Firefox, Chrome and
 *  Safari.  Internet Explorer 9 does not have sufficient CSS support to create a close match to
 *  the existing image-based skin, so CSS3 mode is not enabled by default.  If CSS3 mode is
 *  manually enabled for IE, this will result in a degraded appearance that is similar across
 *  IE6, 7, 8 and 9: rounded elements such as tabs will become square, and gradient backgrounds
 *  will have subtly lower quality (due to lack of CSS color stop support).
 *  <P>
 ...
 *  <P>
 *  <ul>
 *   <li>"supported"</li>: <i>(default setting)</i> CSS3 mode will be used for browsers that fully
 *        support it (including rounded edges and full gradient support)
 *    <li>"off"</li>: CSS3 mode will never be used
 *    <li>"on"</li>: CSS3 mode will be used for all browser
 *  </ul>
 *  <P>
 ...
 *  
 *  
 * look for methods like set<i>Subcomponent</i>Properties(), such as
 * Window.setPaneContainerProperties().
 *  
 *  </ul>
 *  
 *  <P>
 ...
 *  is used principally for colors and fonts.  See  this discussion for
 ...
 * separately skinnable component for PaletteWindow, use {@link
 * com.smartgwt.client.util.isc#defineClass isc.defineClass}.  For
 *  example:
 *  <pre>
 ...
 * make your SmartGWT widget use the settings on this Smart GWT class, call setScClassName()
 * passing
