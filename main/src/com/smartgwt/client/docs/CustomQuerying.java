 ...
 * The SmartGWT server provides a number of ways to let you customize the SQL or Hibernate&#010 query it generates to fetch
 * data from or update your database.  You can provide full &#010 custom queries in either {@link
 ...
 * letting&#010 SmartGWT generate the rest.  Full custom queries provide complete flexibility, but &#010 they cannot be
 ...
 * variables <b>$criteria</b> and <b>$values</b> in your queries or &#010 clause snippets, and SmartGWT will insert the
 * appropriate values.  A simple &#010 {@link com.smartgwt.client.docs.serverds.OperationBinding#whereClause 'whereClause'}
 * example:&#010 <p>&#010 <code>&lt;whereClause&gt;continent = $critieria.continent AND population >
 * $criteria.minPop&lt;/whereClause&gt;</code>&#010 <p>&#010 Please see {@link com.smartgwt.client.docs.VelocitySupport}
 * for full details of accessing SmartGWT &#010 Server context variables using Velocity. &#010 &#010 <h4>Other template
 ...
 * com.smartgwt.client..DefaultQueryClause} generated by &#010 SmartGWT.  You can use these in full custom queries to allow
 * a certain part of the query&#010 code to be generated:<p>&#010 <code>SELECT foo, bar FROM $defaultTableClause WHERE baz
 * > $criteria.baz</code>.  &#010 <p>&#010 You can also use them, with care, as a foundation for your own
 ...
 * which would of course return every row.  With SmartGWT custom queries, this does not happen; &#010 the client-provided
 ...
 * you can still use mixed-case DataSource field names; SmartGWT&#010 will map DataSource field "orderNumber" to Oracle
 ...
 * @see com.smartgwt.client.data.OperationBinding#getSqlType
