 ...
 * the official <a href="http://github.smartclient.com/isc-maven-plugin/">Isomorphic plugin for
 * Maven</a>. For others, the following is a description of what functionality is contained in
 ...
 * <P> All of the libraries that Smart GWT depends upon have either an Apache 1.0 or Apache 2.0
 * license, with the following exceptions:<br> 1. Optional Hibernate support requires
 * LGPL-licensed .jars from Hibernate<br> 2. Optional bean annotation support requires an
 ...
 * varies by provider.<br> 3. Optional support for Java as a JSR223 server-side scripting language
 ...
 * &nbsp;&nbsp;&nbsp;&nbsp;slf4j-api<br> &nbsp;&nbsp;&nbsp;&nbsp;commons-jxpath<br>
 * &nbsp;&nbsp;&nbsp;&nbsp;commons-httpclient<br> &nbsp;&nbsp;&nbsp;&nbsp;velocity<br>
 * &nbsp;&nbsp;&nbsp;&nbsp;commons-fileupload<br> &nbsp;&nbsp;&nbsp;&nbsp;joda-time<br>
 * &nbsp;&nbsp;&nbsp;&nbsp;commons-io<br> &nbsp;&nbsp;<u>Optionally Requires</u>:<br>
 * &nbsp;&nbsp;&nbsp;&nbsp;isomorphic_js_parser - if you're using the built-in support for REST
 * via the RESTHandler servlet with JSON payloads<br> &nbsp;&nbsp;&nbsp;&nbsp;xercesImpl - if
 * you're using JDK &lt; 1.5<br> &nbsp;&nbsp;&nbsp;&nbsp;xml-apis - if you're using JDK &lt;
 * 1.5<br> &nbsp;&nbsp;&nbsp;&nbsp;mail - if you plan to use the Mail messaging feature<br>
 ...
 * poi-ooxml-schemas, dom4j, xmlbeans<br><br> &nbsp;&nbsp;&nbsp;&nbsp;PDF Export - Additional
 * .jars are required if PDF Export is to be used. These .jars are:<br>
 ...
 * generated DataSources will not require JPA at runtime if you are not using JPA.<br><br> 
 * &nbsp;&nbsp;&nbsp;&nbsp;slf4j-log4j12 - if you plan to use slf4j with log4j (for example), or
 * any other slf4j bridge library depending on which logging framework will be used, see {@link
 * com.smartgwt.client.docs.ServerLogging} for information on server-side  logging and how to
 * configure it.<br><br> &nbsp;&nbsp;&nbsp;&nbsp;groovy - if you plan to use Groovy with the
 * {@link com.smartgwt.client.docs.ServerScript} feature.  </li> <p>
 * <li><b>isomorphic_contentexport.jar</b>: Optional support for PDF Export requires Flying
 * Saucer, iText and jTidy, introducing:<br> &nbsp;&nbsp;- Flying Saucer: core-renderer.jar: <a
 ...
 * see {@link com.smartgwt.client.docs.Messaging Messaging}:<br> &nbsp;&nbsp;<u>Requires</u>:<br>
 ...
 * &nbsp;&nbsp;&nbsp;&nbsp;hibernate and its dependencies<br> &nbsp;&nbsp;<u>Optionally
 * Requires</u>:<br> &nbsp;&nbsp;&nbsp;&nbsp;hsqldb - not required for linking, but needed for
 * actually connecting to databases of this type, and hsqldb is what's used in the SDK examples.
 * Note that for production use you will need a JDBC driver for your database type.<br> </li>
 ...
 * <li><b>isomorphic_autotest</b>: Support for  {@link com.smartgwt.client.docs.AutomatedTesting
 * automated testing and Continuous Integration}<br> &nbsp;&nbsp;<u>Requires</u>:<br>
 ...
 * isomorphic_core_rpc). <br> &nbsp;&nbsp;<u>Requires</u>:<br>
 ...
 * &nbsp;&nbsp;&nbsp;&nbsp;isomorphic_core_rpc<br>  </li> <li><b>isomorphic_struts</b>: Contains
 ...
 * the important note  below).  An example of this style of validation is available here:  <a
 * href='/examples/struts/forms/welcome.do'
 ...
 * &nbsp;&nbsp;&nbsp;&nbsp;commons-logging<br> &nbsp;&nbsp;&nbsp;&nbsp;commons-validator<br> </li>
 * </ul>
 */
