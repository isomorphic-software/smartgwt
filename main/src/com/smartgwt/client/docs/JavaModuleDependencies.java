 ...
 * <div class="jmd-optional">       Optional Dependencies       </div>       <ul>        
 * <li><i>isomorphic_js_parser</i> - if you're using the built-in support for REST via the
 * RESTHandler servlet with JSON payloads         <li><i>xercesImpl</i> - if you're using JDK &lt;
 ...
 * com.smartgwt.client.rpc.RPCManager#exportImage RPCManager.exportImage()}, or when using {@link
 * com.smartgwt.client.rpc.RPCManager#exportContent RPCManager.exportContent()} to export a
 ...
 * Between iText 2.0.x and iText 2.1.x there is a binary (but not source) incompatibility that
 * causes a server-side <code>NoSuchMethodError</code> when exporting, e.g., charts in Internet
 * Explorer.                This is a <a
 * href='http://code.google.com/p/flying-saucer/issues/detail?id=126' target='_blank'>known
 * issue</a> with the Flying Saucer product that is fixed by using core-renderer-R8-isomorphic.jar
 * and iText-2.1.7.jar in the               lib-iTextAlternate/ directory instead of
 * core-renderer.jar and iText-2.0.8.jar in the lib/ directory.                 To use iText 2.1.7
 * with the Server Framework, exclude lib/core-renderer.jar and lib/iText-2.0.x.jar from the
 * application's classpath and instead add lib-iTextAlternate/core-renderer-R8-isomorphic.jar and
 * lib-iTextAlternate/iText-2.1.7.jar.       </ul>     </td> </tr> <tr>   <td
 * class="jmd-module"><a target="_blank"
 * href="./mavendoc/isomorphic-tools.html">isomorphic_tools</a></td>   <td>     Contains back-end
 * logic for the "Admin Console" tool visible in the Developer Console, and also standalone from
 * the SDK home page.       Also contains the various data importers and exporters, and the
 * server-side components of the BatchUploader.   </td> </tr> <tr>   <td class="jmd-module"><a
 * target="_blank" href="./mavendoc/isomorphic-cdi.html">isomorphic_cdi</a></td>   <td>    
 * Support for {@link com.smartgwt.client.docs.DmiOverview DMI} dispatches to Spring beans (via
 * {@link com.smartgwt.client.docs.serverds.ServerObject#lookupStyle ServerObject.lookupStyle} :
 * "cdi").   </td> </tr> <tr>   <td class="jmd-module"><a target="_blank"
 ...
 * href="./mavendoc/isomorphic-messaging.html">isomorphic_realtime_messaging</a></td>   <td>    
 * Server support required for the Smart GWT Realtime Messaging Module.  Install this if you're
 * using this 'push' technology.  For more information, see {@link
 * com.smartgwt.client.docs.Messaging Messaging}.   </td> </tr> <tr>   <td class="jmd-module"><a
 * target="_blank" href="./mavendoc/isomorphic-hibernate.html">isomorphic_hibernate</a></td>  
 * <td>     Contains support for Hibernate DataSources as described here: {@link
 * com.smartgwt.client.docs.HibernateIntegration}.   </td> </tr> <tr>   <td class="jmd-module"><a
 * target="_blank" href="./mavendoc/isomorphic-jpa.html">isomorphic_jpa</a></td>   <td>    
 * Contains support for JPA DataSources as described {@link
 * com.smartgwt.client.docs.JpaIntegration here}   </td> </tr> <tr>   <td class="jmd-module"><a
 * target="_blank" href="./mavendoc/isomorphic-sql.html">isomorphic_sql</a></td>   <td>     The
 * Smart GWT SQLDataSource.   </td> </tr> <tr>   <td class="jmd-module"><a target="_blank"
 * href="./mavendoc/isomorphic-autotest.html">isomorphic_autotest</a></td>   <td>     Support for
 ...
 * case is that it will conflict with the container's own implementation of the Servlets API.    
 * </ul>   </td> </tr> <tr>   <td class="jmd-module"><a target="_blank"
 * href="./mavendoc/isomorphic-js-parser.html">isomorphic_js_parser</a></td>   <td>     A parser
 * capable of reading a JSON byte stream and creating an in-memory Java object structure to match.
 * Used by any mechanism that relies on JSON-style configuration.       Examples include
 * FileAssembly definitions in JSON format, any use of the rulesFile with a URIRegexFilter (Java
 * Servlet) or subclass.     </td> </tr> <tr>   <td class="jmd-module"><a target="_blank"
 * href="./mavendoc/isomorphic-compression.html">isomorphic_compression</a></td>   <td>     This
 ...
 * information, see: {@link com.smartgwt.client.docs.Compression}.   </td> </tr> <tr>   <td
 * class="jmd-module"><a target="_blank"
 * href="./mavendoc/isomorphic-assembly.html">isomorphic_assembly</a></td>   <td>     This is part
 * of the Network Performance Module.  The isomorphic_assembly module is required for file
 * assembly and stripping.  For more information, see: {@link
 * com.smartgwt.client.docs.FileAssembly}.   </td> </tr> <tr>   <td class="jmd-module"><a
 * target="_blank" href="./mavendoc/isomorphic-struts.html">isomorphic_struts</a></td>   <td>    
 ...
 * is available here:  <a href='/examples/struts/forms/welcome.do'
 * target='_blank'>/examples/struts/forms/welcome.do</a> - read the info on this page, and follow 
 ...
 * by Isomorphic Support.   </td> </tr> </table>
 */
