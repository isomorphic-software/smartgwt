 ...
 * DataSource.autoDeriveSchema} is supported for deriving DataSource fields from JPA
 ...
 *  <p>
 * In case of "pre-existing beans" approach, see {@link com.smartgwt.client.docs.HbBeans} for the
 ...
 * The transaction mechanism should be configured in the {@link
 ...
 * the {@link com.smartgwt.client.docs.Server_properties server.properties} file.  The value of
 * this property needs
 *       to be set to
 ...
 * it.<br/>
 * This implementation reads two properties from the {@link
 * com.smartgwt.client.docs.Server_properties server.properties}
 *       file:
 ...
 *       not used.<br/>
 * From the {@link com.smartgwt.client.docs.Server_properties server.properties} file this
 ...
 * have additional
 * configurations in {@link com.smartgwt.client.docs.Server_properties server.properties} file.
 ...
 *  details, see {@link com.smartgwt.client.docs.DsRequestBeanTypes}.
 *  <p>
