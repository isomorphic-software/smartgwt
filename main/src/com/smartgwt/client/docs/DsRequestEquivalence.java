 ...
 * a "fetch"), {@link com.smartgwt.client.data.DSRequest#getOperationId operationId} is the only
 * property that will cause two DSRequests to be considered distinct (non-equivalent) requests. 
 * <P> Bearing this in mind, the best practice is: <ul> <li> everything that will be treated as
 * criteria or as values on the server side should be part of {@link
 * com.smartgwt.client.data.DSRequest#getData data}.  Do not "smuggle" data that will ultimately
 * be used as criteria or values in other dsRequest properties, such as  {@link
 * com.smartgwt.client.rpc.RPCRequest#getParams HTTP parameters}. <li> use {@link
 * com.smartgwt.client.data.DSRequest#getOperationId operationId} as the sole piece of information
 ...
 * in {@link com.smartgwt.client.data.DSRequest#getData data} instead. </ul> <p> {@link
 * com.smartgwt.client.data.DataSource#cloneDSRequest DataSource.cloneDSRequest} can be used to
 * create an equivalent DSRequest.
 */
