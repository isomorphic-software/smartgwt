...
public class IconButton extends Button implements com.smartgwt.client.widgets.menu.events.HasMenuIconClickHandlers {
     ...
     * This attribute is not supported in this subclass.  However, RTL mode is still supported.
     *
     * @param iconOrientation  Default value is null
     */
     ...
     *
     * @param largeIconSize  Default value is 32
     */
     ...
     * is displayed.
     *
     * @param showButtonTitle  Default value is true
     */
     ...
     *
     * @param showIcon  Default value is null
     */
     ...
     * clicked.
     *
     * @param showMenuIcon  Default value is false
     */
     ...
     *
     * @param showMenuIconDisabled  Default value is true
     */
     ...
     *
     * @param showMenuIconOver  Default value is true
     */
    ...
    /**
     * If set to true, shows this button's {@link com.smartgwt.client.widgets.IconButton#getMenu menu} when a user clicks
     * anywhere  in the button, rather than specifically on the {@link com.smartgwt.client.widgets.IconButton#getMenuIcon
     * menuIcon}.
     *
     * @param showMenuOnClick  Default value is null
     */
     ...
     *
     * @param valign  Default value is null
     * @see com.smartgwt.client.docs.Appearance Appearance overview and related methods
     */
     ...
     * com.smartgwt.client.widgets.IconButton#getIcon icon} or the {@link com.smartgwt.client.widgets.IconButton#getMenuIcon
     ...
     * prevent this notification from firing. <P> If a {@link com.smartgwt.client.widgets.IconButton#getMenu menu} is installed
     * then, by default, it is only displayed when a  user clicks on the {@link
     * com.smartgwt.client.widgets.IconButton#getMenuIcon menuIcon}.  This can be altered via  {@link
     * com.smartgwt.client.widgets.IconButton#getShowMenuOnClick showMenuOnClick}.
     *
