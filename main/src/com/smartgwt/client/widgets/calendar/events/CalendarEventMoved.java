...
public class CalendarEventMoved extends BrowserEvent<EventMovedHandler>  implements Cancellable {
     ...
     *
     * @return new start date and time that the event is being moved to
     */
     ...
     *
     * @return the event as it will be after this movement
     */
	...
	/**
     * the lane into which the event was moved
     *
     * @return the lane into which the event was moved
     */
    public native String getNewLane() /*-{
        var self = this.@com.smartgwt.client.event.AbstractSmartEvent::jsObj;
        var ret = self.newLane;
        return ret;
    }-*/;
