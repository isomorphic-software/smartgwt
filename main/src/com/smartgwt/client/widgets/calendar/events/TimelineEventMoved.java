...
public class TimelineEventMoved extends BrowserEvent<TimelineEventMovedHandler>  implements Cancellable {
     ...
     * Handler type.
     */
    private static Type<TimelineEventMovedHandler> TYPE;
     ...
     */
    public static <S extends HasTimelineEventMovedHandlers & HasHandlers> void fire(
        S source, JavaScriptObject jsObj) {
        if (TYPE != null) {
            TimelineEventMoved event = new TimelineEventMoved(jsObj);
     ...
     */
    public static Type<TimelineEventMovedHandler> getType() {
        if (TYPE == null) {
            TYPE = new Type<TimelineEventMovedHandler>();
        }
        return TYPE;
    }
    ...
    protected void dispatch(TimelineEventMovedHandler handler) {
        handler.onTimelineEventMoved(this);
    }
    ...
    @Override
    public final Type<TimelineEventMovedHandler> getAssociatedType() {
        return TYPE;
    }
     ...
     *
     * @return new start date of the passed event
     */
     ...
     *
     * @return new end date of the passed event
     */
     ...
     *
     * @return the Lane in which this event has been dropped
     */
