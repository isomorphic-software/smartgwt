...
public class HeaderLevel extends RefDataClass {
    ...
    public static HeaderLevel getOrCreateRef(JavaScriptObject jsObj) {
        ...
        if (existingObj instanceof HeaderLevel) {
            existingObj.setJsObj(jsObj);
            return (HeaderLevel)existingObj;
        } else
     ...
     * innermost headerLevel.
     *
     * @return Current headerWidth value. Default value is null
     */
     ...
     * further customization.
     *
     * @return Current titles value. Default value is null
     */
     ...
     * Unit of time shown at this level of header.
     *
     * @return Current unit value. Default value is null
     */
