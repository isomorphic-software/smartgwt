...
public class ImageClickEvent extends BrowserEvent<ImageClickHandler>  {

    /**
     * Handler type.
     */
    private static Type<ImageClickHandler> TYPE;
     ...
     */
    public static <S extends HasImageClickHandlers & HasHandlers> void fire(
        S source, JavaScriptObject jsObj) {
        if (TYPE != null) {
            ImageClickEvent event = new ImageClickEvent(jsObj);
    ...
    public static Type<ImageClickHandler> getType() {
        if (TYPE == null) {
            TYPE = new Type<ImageClickHandler>();
        }
        return TYPE;
    }
    ...
    @Override
    public final Type<ImageClickHandler> getAssociatedType() {
        return TYPE;
    }

    public ImageClickEvent(JavaScriptObject jsObj) {
        super(jsObj);
    }
