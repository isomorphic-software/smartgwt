...
public class LinearGradient extends Gradient {
     ...
     * to which it is applied.
     *
     * @return Current x1 value. Default value is null
     */
    public String getX1()  {
     ...
     * which it is applied.
     *
     * @return Current x2 value. Default value is null
     */
    public String getX2()  {
     ...
     * to which it is applied.
     *
     * @return Current y1 value. Default value is null
     */
    public String getY1()  {
     ...
     * which it is applied.
     *
     * @return Current y2 value. Default value is null
     */
    public String getY2()  {
