...
public class Gauge extends DrawPane {
     ...
     *
     * @param borderWidth borderWidth Default value is 1
     * @throws IllegalStateException this property cannot be changed after the component has been created
     ...
     *
     * @param sectors list of sectors to show in gauge. Default value is null
     */
     ...
     * @return the index of the newly-added sector.
     */
    public native int addSector(double value) /*-{
        var self = this.@com.smartgwt.client.widgets.BaseWidget::getOrCreateJsObj()();
        var ret = self.addSector(value);
        return ret;
    }-*/;
