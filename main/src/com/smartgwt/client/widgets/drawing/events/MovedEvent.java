...
public class MovedEvent extends AbstractSmartEvent<MovedHandler>  {
     ...
     * Handler type.
     */
    private static Type<MovedHandler> TYPE;
    ...
    public static <S extends HasMovedHandlers & HasHandlers> void fire(
        ...
        if (TYPE != null) {
            MovedEvent event = new MovedEvent(jsObj);
    ...
    @Override
    public final Type<MovedHandler> getAssociatedType() {
        return TYPE;
    }

    public MovedEvent(JavaScriptObject jsObj) {
        super(jsObj);
    }
