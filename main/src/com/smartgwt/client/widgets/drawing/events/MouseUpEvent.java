...
public class MouseUpEvent extends AbstractSmartEvent<MouseUpHandler>  implements Cancellable {
    private boolean cancel = false;

    /**
     * Handler type.
     */
    private static Type<MouseUpHandler> TYPE;
