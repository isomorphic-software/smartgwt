...
public class DragStop extends AbstractSmartEvent<DragStopHandler>  {
     ...
     * Handler type.
     */
    private static Type<DragStopHandler> TYPE;
    ...
    public static <S extends HasDragStopHandlers & HasHandlers> void fire(
        ...
        if (TYPE != null) {
            DragStop event = new DragStop(jsObj);
     ...
     */
    public static Type<DragStopHandler> getType() {
        if (TYPE == null) {
            TYPE = new Type<DragStopHandler>();
        }
        return TYPE;
    }
    ...
    @Override
    public final Type<DragStopHandler> getAssociatedType() {
        return TYPE;
    }
