 ...
 * is initialized with a set of {@link com.smartgwt.client.widgets.menu.MenuItem}s specified as
 * ${isc.DocUtils.linkForRef('menu.','items')}, each of which represents one row in the menu's display and specifies the
 * action to take when that menu item is selected. <p> Each <code>MenuItem</code> can have a {@link
...
public class Menu extends ListGrid implements com.smartgwt.client.widgets.menu.events.HasItemClickHandlers {
    ...
    /**
     * Alternative style for the menu used whenever {@link com.smartgwt.client.widgets.menu.Menu#getPlacement placement}
     ...
     *
     * @param fillSpaceStyleName  See {@link com.smartgwt.client.docs.CSSStyleName CSSStyleName} . Default value is "menuFill"
     * @throws IllegalStateException this property cannot be changed after the component has been created
     */
     ...
     * iconBodyStyleName is suffixed with "RTL", which allows skins to apply different styles in LTR and RTL modes. <p> Note:
     * Any skin which uses iconBodyStyleName should add "RTL" styles as well, even if identical to LTR styles. Otherwise, menus
     * may lose their styling in RTL mode.
     *
