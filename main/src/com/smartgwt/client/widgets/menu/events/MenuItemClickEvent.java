...
public class MenuItemClickEvent extends AbstractSmartEvent<ClickHandler>  {
     ...
     *
     * @return for a menu shown as a context menu, the Canvas the menu was shown                        on.  Otherwise the {@link
     * com.smartgwt.client.widgets.menu.Menu} instance of which this                        {@link
     * com.smartgwt.client.widgets.menu.MenuItem} is a member.
     */
     ...
     *
     * @return The {@link com.smartgwt.client.widgets.menu.MenuItem} that was clicked on.
     */
     ...
     * com.smartgwt.client.widgets.menu.MenuItem} is a                          member.
     *
     * @return The {@link com.smartgwt.client.widgets.menu.Menu} instance of which this {@link
     * com.smartgwt.client.widgets.menu.MenuItem} is a                          member.
     */
     ...
     * event.
     *
     * @return Index of the column the user clicked. May be null if the                          user activated the menu via a keyboard
     * event.
     */
