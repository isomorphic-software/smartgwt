...
public class HTMLPane extends HTMLFlow {
    ...
    public native static HTMLPane getOrCreateRef(JavaScriptObject jsObj) /*-{
        if (jsObj == null) return null;
        var instance = jsObj["__ref"];
        if (instance == null) {
            return @com.smartgwt.client.util.ObjectFactory::createCanvas(Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)("HTMLPane",jsObj);
        } else {
            return instance;
        }
    }-*/;
    ...
    public static native void changeAutoChildDefaults(String autoChildName, Canvas defaults) /*-{
        $wnd.isc["HTMLPane"].changeDefaults(autoChildName + "Defaults", defaults.@com.smartgwt.client.widgets.Canvas::getConfig()());
    }-*/;
    ...
    public static native void changeAutoChildDefaults(String autoChildName, FormItem defaults) /*-{
        $wnd.isc["HTMLPane"].changeDefaults(autoChildName + "Defaults", defaults.@com.smartgwt.client.widgets.form.fields.FormItem::getJsObj()());
    }-*/;
    ...
    public static native void setDefaultProperties(HTMLPane hTMLPaneProperties) /*-{
    	var properties = $wnd.isc.addProperties({},hTMLPaneProperties.@com.smartgwt.client.widgets.BaseWidget::getConfig()());
