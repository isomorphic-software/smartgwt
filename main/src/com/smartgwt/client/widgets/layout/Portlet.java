...
public class Portlet extends Window {
    ...
    public static native void changeAutoChildDefaults(String autoChildName, Canvas defaults) /*-{
        if (defaults.@com.smartgwt.client.widgets.BaseWidget::isCreated()()) {
            @com.smartgwt.client.util.ConfigUtil::warnOfPreConfigInstantiation(Ljava/lang/Class;Ljava/lang/String;Ljava/lang/String;)(Portlet.@java.lang.Object::getClass()(), "changeAutoChildDefaults", "Canvas");
        }
        defaults.@com.smartgwt.client.widgets.BaseWidget::setConfigOnly(Z)(true);
        var cleanDefaultsJS = @com.smartgwt.client.util.JSOHelper::cleanProperties(Lcom/google/gwt/core/client/JavaScriptObject;Z)(defaults.@com.smartgwt.client.widgets.BaseWidget::getConfig()(), true);
        $wnd.isc.Portlet.changeDefaults(autoChildName + "Defaults", cleanDefaultsJS);
    }-*/;
    ...
    public static native void changeAutoChildDefaults(String autoChildName, FormItem defaults) /*-{
        if (defaults.@com.smartgwt.client.widgets.form.fields.FormItem::isCreated()()) {
            @com.smartgwt.client.util.ConfigUtil::warnOfPreConfigInstantiation(Ljava/lang/Class;Ljava/lang/String;Ljava/lang/String;)(Portlet.@java.lang.Object::getClass()(), "changeAutoChildDefaults", "FormItem");
        }
     ...
     * its title, etc).
     *
     * @return Current closeConfirmationDialogProperties value. Default value is null
     */
     ...
     * com.smartgwt.client.widgets.layout.Portlet#getShowCloseConfirmationMessage showCloseConfirmationMessage} is true.
     *
     * @return Current closeConfirmationMessage value. Default value is "Close portlet?"
     */
     ...
     * Whether to call {@link com.smartgwt.client.widgets.Canvas#destroy destroy()} when closing the Portlet.
     *
     * @return Current destroyOnClose value. Default value is false
     */
    public Boolean getDestroyOnClose()  {
        Boolean result = getAttributeAsBoolean("destroyOnClose");
     ...
     * {@link com.smartgwt.client.widgets.Canvas#setEditMode first placed into edit mode}.
     *
     * @return Current editProxyConstructor value. Default value is "PortletEditProxy"
     * @see com.smartgwt.client.docs.SCClassName SCClassName 
     */
     ...
     * in that row.
     *
     * @return Current minHeight value. Default value is 60
     ...
     * Specifies a minimum width for the Portlet.
     *
     * @return Current minWidth value. Default value is 70
     ...
     * displayed before portlets are closed
     *
     * @return Current showCloseConfirmationMessage value. Default value is true
     */
    public Boolean getShowCloseConfirmationMessage()  {
        Boolean result = getAttributeAsBoolean("showCloseConfirmationMessage");
    ...
    public native PortalLayout getPortalLayout() /*-{
        if (this.@com.smartgwt.client.widgets.BaseWidget::isConfigOnly()()) {
            @com.smartgwt.client.util.ConfigUtil::warnOfPostConfigInstantiation(Ljava/lang/Class;Ljava/lang/String;Ljava/lang/String;)(this.@java.lang.Object::getClass()(), "getPortalLayout", "");
        }
        var self = this.@com.smartgwt.client.widgets.BaseWidget::getOrCreateJsObj()();
    ...
    public native PortalPosition getPortalPosition() /*-{
        if (this.@com.smartgwt.client.widgets.BaseWidget::isConfigOnly()()) {
            @com.smartgwt.client.util.ConfigUtil::warnOfPostConfigInstantiation(Ljava/lang/Class;Ljava/lang/String;Ljava/lang/String;)(this.@java.lang.Object::getClass()(), "getPortalPosition", "");
        }
        var self = this.@com.smartgwt.client.widgets.BaseWidget::getOrCreateJsObj()();
    ...
    public static native void setDefaultProperties(Portlet portletProperties) /*-{
        if (portletProperties.@com.smartgwt.client.widgets.BaseWidget::isCreated()()) {
            @com.smartgwt.client.util.ConfigUtil::warnOfPreConfigInstantiation(Ljava/lang/Class;Ljava/lang/String;Ljava/lang/Class;)(Portlet.@java.lang.Object::getClass()(), "setDefaultProperties", portletProperties.@java.lang.Object::getClass()());
        }
        portletProperties.@com.smartgwt.client.widgets.BaseWidget::setConfigOnly(Z)(true);
    	var properties = portletProperties.@com.smartgwt.client.widgets.BaseWidget::getConfig()();
    ...
    public LogicalStructureObject setLogicalStructure(PortletLogicalStructure s) {
        ...
        try {
            ...
            s.logicalStructureErrors += "Portlet.editProxyConstructor:" + t.getMessage() + "\n";
        }
        try {
