...
public class PortalLayout extends Layout {
     ...
     * automatically shrink and stretch to accomodate the width of {@link com.smartgwt.client.widgets.layout.Portlet Portlets}
     ...
     * when not necessary to stretch or shrink to accomodate Portlet widths.
     *
     ...
     *
     * @param dropTypes  Default value is ["PortalColumn"]
     ...
     *
     * @param numColumns  Default value is 2
     * @throws IllegalStateException this property cannot be changed after the component has been created
     ...
     * need to set an equivalent {@link com.smartgwt.client.widgets.Canvas#getDragType dragType} on anything to be dragged into
     * this <code>PortalLayout</code> (including {@link com.smartgwt.client.widgets.layout.Portlet Portlets}).</p> <p>As a
     * convenience, {@link com.smartgwt.client.widgets.layout.Portlet#getDragType dragType} defaults to <code>"Portlet"</code>.
     * Thus, if you want  to allow {@link com.smartgwt.client.widgets.layout.Portlet Portlets} to be dropped on this
     * <code>PortalLayout</code>, but disable  auto-wrapping of other components, you can set <code>portletDropTypes</code> to 
     * <code>["Portlet"]</code>.</p> <p>If you want to allow some {@link com.smartgwt.client.widgets.layout.Portlet Portlets}
     * to be dropped on this <code>PortalLayout</code> but  not others, then set a custom {@link
     * com.smartgwt.client.widgets.layout.Portlet#getDragType dragType} for the {@link
     ...
     *
     * @param portlets  Default value is null
     * @throws IllegalStateException this property cannot be changed after the component has been created
     * @see com.smartgwt.client.widgets.layout.PortalLayout#getPortlets
     ...
     *
     * @param preventColumnUnderflow  Default value is true
     * @see com.smartgwt.client.docs.Sizing Sizing overview and related methods
     * 
     */
    ...
    public native PortalPosition getPortalPosition(Portlet portlet) /*-{
        var self = this.@com.smartgwt.client.widgets.BaseWidget::getOrCreateJsObj()();
        var ret = self.getPortalPosition(portlet.@com.smartgwt.client.widgets.BaseWidget::getOrCreateJsObj()());
