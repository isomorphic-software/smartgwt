...
public class ToolStripGroup extends VLayout {
    ...
    public HLayout getBody() throws IllegalStateException {
        ...
        return HLayout.getOrCreateRef(getAttributeAsJavaScriptObject("body"));
    }
    ...
    /**
     * Label autoChild that presents the title for this ToolStripGroup. This can be customized via the standard AutoChild
     * pattern.
     * <p>
     * For an overview of how to use and configure AutoChildren, see {@link com.smartgwt.client.docs.AutoChildUsage Using AutoChildren}.
     *
    ...
    public HLayout getLabel() throws IllegalStateException {
        ...
        return HLayout.getOrCreateRef(getAttributeAsJavaScriptObject("label"));
    }
    ...
    public Label getTitleProperties() throws IllegalStateException {
        ...
        return Label.getOrCreateRef(getAttributeAsJavaScriptObject("titleProperties"));
    }
