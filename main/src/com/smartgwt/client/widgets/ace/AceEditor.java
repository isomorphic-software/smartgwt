...
public class AceEditor extends Canvas implements com.smartgwt.client.widgets.ace.events.HasAceEditorChangedHandlers {
    ...
    public void setAutoComplete(Boolean autoComplete) {
        setAttribute("autoComplete", autoComplete, true);
    }
     ...
     * Internal use only.
     */
    public void setLiveAutoComplete(Boolean liveAutoComplete) {
        setAttribute("liveAutoComplete", liveAutoComplete, true);
    }
