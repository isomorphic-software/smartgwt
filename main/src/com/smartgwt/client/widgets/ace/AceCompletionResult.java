...
public class AceCompletionResult extends DataClass {
    ...
    public static AceCompletionResult getOrCreateRef(JavaScriptObject jsObj) {
        if(jsObj == null) return null;
        return new AceCompletionResult(jsObj);
    }
    ...
    public AceCompletionResult(JavaScriptObject jsObj){
