...
public interface HasFacetValueContextClickHandlers extends HasHandlers {
    /**
     ...
     */
    HandlerRegistration addFacetValueContextClickHandler(FacetValueContextClickHandler handler);
}
