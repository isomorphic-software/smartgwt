...
public class DragMoveEvent extends BrowserEvent<DragMoveHandler>  implements Cancellable {
  ...
  @Override
  protected final Type<DragMoveHandler> getAssociatedType() {
    return TYPE;
  }

    public DragMoveEvent(JavaScriptObject jsObj) {
        super(jsObj);
    }
