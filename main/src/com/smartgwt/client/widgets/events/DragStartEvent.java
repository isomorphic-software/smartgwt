...
public class DragStartEvent extends BrowserEvent<DragStartHandler>  implements Cancellable {
  ...
  public static <S extends HasDragStartHandlers & HasHandlers> void fire(
    ...
    if (TYPE != null) {
      ...
      if (handlers != null) {
        DragStartEvent event = new DragStartEvent(jsObj);
  ...
  @Override
  protected final Type<DragStartHandler> getAssociatedType() {
    return TYPE;
  }
