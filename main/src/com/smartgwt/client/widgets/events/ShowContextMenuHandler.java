...
public interface ShowContextMenuHandler extends EventHandler {
     ...
     * Menu.showContextMenu()} on it to show it. <p> If you want to show a standard context menu, you can simply define your
     * Menu and set it as the contextMenu property on your component - you do not need to override this method. <p> If you want
     * to do some other processing before showing a menu or do something else entirely, then you should override this method. 
     * Note that the return value from this method controls whether or not the native browser context menu is shown.
     *
     * @param event the event
     */
    void onShowContextMenu(com.smartgwt.client.widgets.events.ShowContextMenuEvent event);
}
