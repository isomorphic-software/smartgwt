...
public class RuleContextChangedEvent extends BrowserEvent<RuleContextChangedHandler>  {
     ...
     * Handler type.
     */
    private static Type<RuleContextChangedHandler> TYPE;
     ...
     */
    public static <S extends HasRuleContextChangedHandlers & HasHandlers> void fire(
        S source, JavaScriptObject jsObj) {
        if (TYPE != null) {
            RuleContextChangedEvent event = new RuleContextChangedEvent(jsObj);
     ...
     */
    public static Type<RuleContextChangedHandler> getType() {
        if (TYPE == null) {
            TYPE = new Type<RuleContextChangedHandler>();
        }
        return TYPE;
    }
    ...
    protected void dispatch(RuleContextChangedHandler handler) {
        handler.onRuleContextChanged(this);
    }
    ...
    @Override
    public final Type<RuleContextChangedHandler> getAssociatedType() {
        return TYPE;
    }
