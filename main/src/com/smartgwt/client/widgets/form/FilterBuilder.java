...
public class FilterBuilder extends Layout implements com.smartgwt.client.widgets.form.events.HasFilterChangedHandlers, com.smartgwt.client.widgets.form.events.HasSearchHandlers {
     ...
     * using {@link com.smartgwt.client.widgets.form.FilterBuilder#getDataSource dataSource}.  The FieldPicker  will default to
     * being a {@link com.smartgwt.client.widgets.form.fields.ComboBoxItem} rather than a {@link
    ...
    protected native void onInit_FilterBuilder () /*-{
        ...
        self.getFieldOperators = $entry(function (fieldName) {
            var jObj = this.__ref;
            if (jObj == null) return this.__getFieldOperators(fieldName);
            var arrayJ = jObj.@com.smartgwt.client.widgets.form.FilterBuilder::getFieldOperators(Ljava/lang/String;)(fieldName);
            if (arrayJ == null) return null;
            return @com.smartgwt.client.util.JSOHelper::convertToJavaScriptArray([Ljava/lang/Object;)(arrayJ);
        });
    ...
    /**
     * Get the list of {@link com.smartgwt.client.types.OperatorId operatorIds} that are valid for the passed field.  By 
     * default, all operators returned by {@link com.smartgwt.client.data.DataSource#getFieldOperators
     * DataSource.getFieldOperators} are used. <P> Called automatically by the default implementation of the same method on
     * each {@link com.smartgwt.client.widgets.form.FilterClause#getFieldOperators clause}, whenever its fieldName is changed.
    ...
    public native OperatorId[] getFieldOperators(String fieldName) /*-{
        var self = this.@com.smartgwt.client.widgets.BaseWidget::getOrCreateJsObj()();
        var ret = self.__getFieldOperators(fieldName);
        if(ret == null) return null;
