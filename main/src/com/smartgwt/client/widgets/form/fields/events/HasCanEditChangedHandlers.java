...
public interface HasCanEditChangedHandlers extends HasHandlers {
    /**
     ...
     * <li>{@link com.smartgwt.client.widgets.form.fields.CanvasItem#shouldDisableCanvas shouldDisableCanvas()} is called to
     ...
     */
    HandlerRegistration addCanEditChangedHandler(CanEditChangedHandler handler);
}
