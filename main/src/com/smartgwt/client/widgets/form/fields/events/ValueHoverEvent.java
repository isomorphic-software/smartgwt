...
public class ValueHoverEvent extends AbstractSmartEvent<ValueHoverHandler>  {
     ...
     * Handler type.
     */
    private static Type<ValueHoverHandler> TYPE;
     ...
     */
    public static <S extends HasValueHoverHandlers & HasHandlers> void fire(
        S source, JavaScriptObject jsObj) {
        if (TYPE != null) {
            ValueHoverEvent event = new ValueHoverEvent(jsObj);
     ...
     */
    public static Type<ValueHoverHandler> getType() {
        if (TYPE == null) {
            TYPE = new Type<ValueHoverHandler>();
        }
        return TYPE;
    }

    @Override
    protected void dispatch(ValueHoverHandler handler) {
        handler.onValueHover(this);
    }
    ...
    @Override
    public final Type<ValueHoverHandler> getAssociatedType() {
        return TYPE;
    }

    public ValueHoverEvent(JavaScriptObject jsObj) {
        super(jsObj);
    }
