...
public class ColorItem extends TextItem implements com.smartgwt.client.widgets.form.fields.events.HasPickerColorSelectedHandlers {
    ...
    public static native void changeAutoChildDefaults(String autoChildName, DrawItem defaults) /*-{
        $wnd.isc.ColorItem.changeDefaults(autoChildName + "Defaults", defaults.@com.smartgwt.client.widgets.drawing.DrawItem::getJsObj()());
    }-*/;
     ...
     *
     * @param pickerIconPrompt  See {@link com.smartgwt.client.docs.HTMLString HTMLString} . Default value is "Click to select a new color"
     */
