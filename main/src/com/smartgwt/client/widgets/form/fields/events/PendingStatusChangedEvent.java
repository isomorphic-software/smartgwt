...
public class PendingStatusChangedEvent extends AbstractSmartEvent<PendingStatusChangedHandler>  implements Cancellable {
     ...
     * Handler type.
     */
    private static Type<PendingStatusChangedHandler> TYPE;
     ...
     */
    public static <S extends HasPendingStatusChangedHandlers & HasHandlers> void fire(
        S source, JavaScriptObject jsObj) {
        if (TYPE != null) {
            PendingStatusChangedEvent event = new PendingStatusChangedEvent(jsObj);
     ...
     */
    public static Type<PendingStatusChangedHandler> getType() {
        if (TYPE == null) {
            TYPE = new Type<PendingStatusChangedHandler>();
        }
        return TYPE;
    }
    ...
    protected void dispatch(PendingStatusChangedHandler handler) {
        handler.onPendingStatusChanged(this);
    }
    ...
    @Override
    public final Type<PendingStatusChangedHandler> getAssociatedType() {
        return TYPE;
    }

    public PendingStatusChangedEvent(JavaScriptObject jsObj) {
        super(jsObj);
    }
	...
	/**
     * the managing <code>DynamicForm</code> instance.
     *
     * @return the managing <code>DynamicForm</code> instance.
     */
	...
	/**
     * <code>true</code> if the item should show its pending visual state; <code>false</code> otherwise.
     *
     * @return <code>true</code> if the item should show its pending visual state; <code>false</code> otherwise.
     */
    public native boolean getPendingStatus() /*-{
        var self = this.@com.smartgwt.client.event.AbstractSmartEvent::jsObj;
        var ret = self.pendingStatus;
     ...
     *
     * @return the current form item value.
     */
	...
	/**
     * the value that would be restored by a call to {@link com.smartgwt.client.widgets.form.DynamicForm#resetValues
     * DynamicForm.resetValues()}.
     *
     * @return the value that would be restored by a call to {@link com.smartgwt.client.widgets.form.DynamicForm#resetValues
     * DynamicForm.resetValues()}.
     */
