...
public class FormItem extends RefDataClass implements com.smartgwt.client.widgets.form.fields.events.HasBlurHandlers, com.smartgwt.client.widgets.form.fields.events.HasChangeHandlers, com.smartgwt.client.widgets.form.fields.events.HasChangedHandlers, com.smartgwt.client.widgets.form.fields.events.HasClickHandlers, com.smartgwt.client.widgets.form.fields.events.HasDoubleClickHandlers, com.smartgwt.client.widgets.form.fields.events.HasEditorEnterHandlers, com.smartgwt.client.widgets.form.fields.events.HasEditorExitHandlers, com.smartgwt.client.widgets.form.fields.events.HasFocusHandlers, com.smartgwt.client.widgets.form.fields.events.HasIconClickHandlers, com.smartgwt.client.widgets.form.fields.events.HasIconKeyPressHandlers, com.smartgwt.client.widgets.form.fields.events.HasItemHoverHandlers, com.smartgwt.client.widgets.form.fields.events.HasKeyDownHandlers, com.smartgwt.client.widgets.form.fields.events.HasKeyPressHandlers, com.smartgwt.client.widgets.form.fields.events.HasKeyUpHandlers, com.smartgwt.client.widgets.form.fields.events.HasPickerIconClickHandlers, com.smartgwt.client.widgets.form.fields.events.HasTitleClickHandlers, com.smartgwt.client.widgets.form.fields.events.HasTitleDoubleClickHandlers, com.smartgwt.client.widgets.form.fields.events.HasTitleHoverHandlers, com.smartgwt.client.widgets.form.fields.events.HasValueHoverHandlers, com.smartgwt.client.widgets.form.fields.events.HasValueIconClickHandlers {
    ...
    public static FormItem getOrCreateRef(JavaScriptObject jsObj) {
		...
		if(obj != null && JSOHelper.getAttribute(jsObj,"__ref")==null) {
            return com.smartgwt.client.util.ObjectFactory.createFormItem("FormItem",jsObj);
    ...
    public static native void changeAutoChildDefaults(String autoChildName, Canvas defaults) /*-{
        $wnd.isc.FormItem.changeDefaults(autoChildName + "Defaults", defaults.@com.smartgwt.client.widgets.Canvas::getConfig()());
    }-*/;
    ...
    public static native void changeAutoChildDefaults(String autoChildName, FormItem defaults) /*-{
        $wnd.isc.FormItem.changeDefaults(autoChildName + "Defaults", defaults.@com.smartgwt.client.widgets.form.fields.FormItem::getJsObj()());
    }-*/;
    ...
    public FormItem(){
        setAttribute("name", SC.generateID(getClass().getName()));
     ...
     *
     * @param accessKey  Default value is null
     ...
     *
     * @param align  Default value is Canvas.LEFT
     ...
     * only for numeric or date/time types. <P> Note that if the user does not type a prefix or use other special notation as
     * described above, the operator specified via {@link com.smartgwt.client.widgets.form.fields.FormItem#getOperator
     * operator} is used, or if <code>formItem.operator</code> is unspecified, a default operator chosen as described under
     * {@link com.smartgwt.client.widgets.form.fields.FormItem#getOperator operator}.   <p> Also note that whatever you enter
     * will be used literally, including any whitespace characters. For example if you input '== China ' then ' China ' will be
     * the value. <p> The <code>allowExpression</code> behavior can be enabled for every field in a form via {@link
     * com.smartgwt.client.widgets.form.DynamicForm#getAllowExpressions allowExpressions}. <P> Finally, note that, like {@link
     * com.smartgwt.client.widgets.form.fields.FormItem#getOperator operator}, enabling <code>allowExpressions:true</code>
     * causes {@link com.smartgwt.client.widgets.form.DynamicForm#getValuesAsCriteria form.getValuesAsCriteria()}) to return
     * {@link com.smartgwt.client.data.AdvancedCriteria}.
     *
     * @param allowExpressions  Default value is null
     */
     ...
     *
     * @param alwaysFetchMissingValues  Default value is false
     */
     ...
     * com.smartgwt.client.widgets.form.fields.FormItem#shouldApplyHeightToTextBox FormItem.shouldApplyHeightToTextBox}
     * <p><b>Note : </b> This is an advanced setting</p>
     *
     * @param applyHeightToTextBox  Default value is null
     */
    ...
    public Boolean getApplyHeightToTextBox()  {
        return getAttributeAsBoolean("applyHeightToTextBox");
    }
     ...
     * enabled via user settings. <P> If unset, defaults to {@link com.smartgwt.client.widgets.form.DynamicForm#getAutoComplete
     * autoComplete}. <P> Note that even with this value set to <code>"none"</code>, native browser  auto-completion may occur
     * for log in forms (forms containing username and  {@link com.smartgwt.client.widgets.form.fields.PasswordItem password}
     * fields). This behavior varies by browser, and is a result of an  <a
     * href='https://www.google.com/search?q=password+ignores+autocomplete+off'
     * onclick="window.open('https://www.google.com/search?q=password+ignores+autocomplete+off');return false;">intentional
     * change by some browser developers</a> to disregard the HTML setting <i>autocomplete=off</i> for password items or log-in
     * forms. <P> In some browsers any form redraw (including a redraw from  a call to  {@link
     ...
     * <p><b>Note : </b> This is an advanced setting</p>
     *
     * @param browserSpellCheck  Default value is null
     ...
     * com.smartgwt.client.data.SimpleType#getStoreAtomicValue storeAtomicValue()}.  Note, if you set this flag on a FormItem
     ...
     * <p><b>Note : </b> This is an advanced setting</p>
     *
     * @param canEditOpaqueValues  Default value is null
     */
    ...
    public Boolean getCanEditOpaqueValues()  {
        return getAttributeAsBoolean("canEditOpaqueValues");
    }
     ...
     * <p><b>Note : </b> This is an advanced setting</p>
     *
     * @param canFocus  Default value is null
     * @see com.smartgwt.client.docs.Focus Focus overview and related methods
     */
     ...
     *
     * @param cellHeight  Default value is null
     */
     ...
     * Applied to the cell containing the form item. <P> NOTE: See the {@link
     ...
     *
     * @param cellStyle the new <code>cellStyle</code> value. See {@link com.smartgwt.client.docs.FormItemBaseStyle FormItemBaseStyle} . Default value is "formCell"
     * @see com.smartgwt.client.docs.Appearance Appearance overview and related methods
     */
     ...
     *
     * @param clipTitle  Default value is null
     */
     ...
     * com.smartgwt.client.docs.CompoundFormItem_skinning} discussion for special skinning considerations.
     *
     * @param controlStyle  See {@link com.smartgwt.client.docs.FormItemBaseStyle FormItemBaseStyle} . Default value is null
     ...
     *
     * @param criteriaField  Default value is null
     */
     ...
     * disableOnReadOnly}.
     *
     * @param disableIconsOnReadOnly  Default value is true
     */
    ...
    /**
     * Specifies an alternative field from which display values should be retrieved for this item.  <P> The display field can
     * be either another field value in the same record or a field that must be retrieved from a related {@link
     * com.smartgwt.client.widgets.form.fields.FormItem#getOptionDataSource optionDataSource}. For fields with an {@link
     * com.smartgwt.client.widgets.form.fields.FormItem#getOptionDataSource optionDataSource}, developers may explicitly
     * specify {@link com.smartgwt.client.widgets.form.fields.FormItem#getForeignDisplayField foreignDisplayField}. If that
     * property is unset, the standard  <code>displayField</code> value will be used by default. <P> If this item is not
     ...
     * <code>displayField</code> value from that record. (Even if specified, the field  may not be used if it does not match
     * any fields present in the optionDataSource - see {@link
     * com.smartgwt.client.widgets.form.fields.FormItem#getDisplayFieldName FormItem.getDisplayFieldName} for details).  Note
     * that if <code>optionDataSource</code> is set and no valid display field is specified (via {@link
     * com.smartgwt.client.widgets.form.fields.FormItem#getForeignDisplayField foreignDisplayField}, or this property),  {@link
     * com.smartgwt.client.widgets.form.fields.FormItem#getDisplayFieldName FormItem.getDisplayFieldName} will return the
     * dataSource title  field by default. <P> This essentially enables the specified <code>optionDataSource</code> to be used
     * as a server based {@link valueMap}.
     *
     ...
     *
     * @param emptyDisplayValue  Default value is ""
     */
     ...
     *
     * @param emptyValueIcon  Default value is null
     */
     ...
     *
     * @param endRow  Default value is false
     ...
     *
     * @param errorMessageWidth  Default value is 80
     ...
     * <p><b>Note : </b> This is an advanced setting</p>
     *
     * @param fetchMissingValues  Default value is true
     ...
     * <p><b>Note : </b> This is an advanced setting</p>
     *
     * @param filterLocally  Default value is null
     */
     ...
     *
     * @param foreignDisplayField  Default value is null
     * @see com.smartgwt.client.widgets.form.fields.FormItem#getDisplayFieldName
     */
     ...
     * <p><b>Note : </b> This is an advanced setting</p>
     *
     * @param globalTabIndex  Default value is null
     * @see com.smartgwt.client.docs.Focus Focus overview and related methods
     */
     ...
     * return -1.  Use  +sgwtLink{getHeightAsString()} in this case.<p>     For form items having a {@link
     ...
     * {@link com.smartgwt.client.widgets.form.fields.SpinnerItem}s, if {@link com.smartgwt.client.docs.Skinning spriting} is
     * enabled, it is not recommended to change the height of the form item from the default because the image sprites are set
     * up assuming a specific, fixed height of the item. If the item height must be changed, then the {@link
     * com.smartgwt.client.widgets.form.fields.FormItem#getPickerIconStyle pickerIconStyle} should be changed to a custom CSS
     * style name. Or, in the case of {@link com.smartgwt.client.widgets.form.fields.SpinnerItem}s, the {@link
     * com.smartgwt.client.widgets.form.fields.FormItemIcon#getBaseStyle baseStyle} and {@link
     ...
     * com.smartgwt.client.widgets.form.fields.SpinnerItem#getDecreaseIcon decreaseIcon} AutoChildren should be customized. <p>
     * Note that when FormItem is rendered as read-only with <code>readOnlyDisplay</code> as "static" the property {@link
     * com.smartgwt.client.widgets.form.fields.FormItem#getStaticHeight staticHeight} is used instead.
     *
    ...
    public int getHeight()  {
        if(getAttributeAsObject("height") instanceof String) { return -1; }
     ...
     *
     * @param hintStyle new style for hint text See {@link com.smartgwt.client.docs.CSSStyleName CSSStyleName} . Default value is "formHint"
     ...
     * <p><b>Note : </b> This is an advanced setting</p>
     *
     * @param iconHeight  Default value is 20
     */
     ...
     *
     * @param iconHSpace  Default value is 3
     */
     ...
     * <p><b>Note : </b> This is an advanced setting</p>
     *
     * @param iconPrompt  See {@link com.smartgwt.client.docs.HTMLString HTMLString} . Default value is ""
     */
     ...
     * <p><b>Note : </b> This is an advanced setting</p>
     *
     * @param iconVAlign  Default value is "bottom"
     */
     ...
     * <p><b>Note : </b> This is an advanced setting</p>
     *
     * @param iconWidth  Default value is 20
     */
     ...
     * editorExit.
     *
     * @param implicitSave  Default value is false
     */
     ...
     *
     * @param implicitSaveOnBlur  Default value is false
     */
     ...
     * fetchMissingValues} is active and a fetch is pending. The field is also read-only while fetch is pending. <P> Set to
     * <code>null</code> to show actual value until display value is loaded.
     *
     * @param loadingDisplayValue  Default value is "Loading..."
     */
     ...
     * by link{isc.AutoTest.getLocator()} for this form item, should the item be identified? By default if the item has a name
     ...
     * the item to identify it (often used  for items with a static defaultValue such as HeaderItems</li>
     * <li><code>"index"</code> use the index within the form's items array. </ul>  If unset, and the item has no specified
     * name, default behavior is to identify by title (if available), otherwise by index.
     * <p><b>Note : </b> This is an advanced setting</p>
     *
     * @param locateItemBy  Default value is null
     */
     ...
     * The default operator for all other fields is controlled by {@link
     * com.smartgwt.client.widgets.form.DynamicForm#getDefaultSearchOperator defaultSearchOperator}.  <P> <b>Note:</b>
     * <code>formItem.operator</code> is only supported for a form that has a  {@link
     ...
     * FormItem.showPicker} is called due to a click on the {@link
     * com.smartgwt.client.widgets.form.fields.FormItem#getShowPickerIcon picker icon}. <P> Can be specified directly as a
     * Canvas, or created automatically via the {@link com.smartgwt.client.types.AutoChild} pattern. <P> Note that the picker
     * is not automatically destroyed with the FormItem that uses it, in order to allow recycling of picker components.  To
     * destroy a single-use picker, override {@link com.smartgwt.client.widgets.Canvas#destroy Canvas.destroy}.
     * <p>
     ...
     * <p><b>Note : </b> This is an advanced setting</p>
     *
     * @param pickerIconName  Default value is "picker"
     */
     ...
     *
     * @param pickerIconPrompt  See {@link com.smartgwt.client.docs.HTMLString HTMLString} . Default value is null
     */
     ...
     * <p><b>Note : </b> This is an advanced setting</p>
     *
     * @param pickerIconProperties  Default value is null
     */
    public void setPickerIconProperties(FormItemIcon pickerIconProperties) {
        setAttribute("pickerIconProperties", pickerIconProperties.getJsObj());
    }
     ...
     *
     * @param pickerIconStyle  See {@link com.smartgwt.client.docs.FormItemBaseStyle FormItemBaseStyle} . Default value is null
     * @see com.smartgwt.client.widgets.form.fields.FormItem#setCellStyle
     * @see com.smartgwt.client.docs.Appearance Appearance overview and related methods
     */
     ...
     *
     * @param prompt new prompt for the item. See {@link com.smartgwt.client.docs.HTMLString HTMLString} . Default value is null
     ...
     *
     * @param readOnlyClipValue  Default value is false
     */
     ...
     *
     * @param redrawOnChange  Default value is false
     */
     ...
     * <p><b>Note : </b> This is an advanced setting</p>
     *
     * @param rejectInvalidValueOnChange  Default value is false
     */
     ...
     *
     * @param rowSpan  Default value is 1
     * @see com.smartgwt.client.docs.FormLayout FormLayout overview and related methods
     */
     ...
     *
     * @param showClippedValueOnHover  Default value is true
     */
     ...
     * them. See {@link com.smartgwt.client.docs.FormItemBaseStyle} for a  discussion for how error styling is calculated.
     *
     * @param showErrorIcon  Default value is null
     * @see com.smartgwt.client.docs.Appearance Appearance overview and related methods
     */
     ...
     * them. See {@link com.smartgwt.client.docs.FormItemBaseStyle} for a  discussion for how error styling is calculated.
     *
     * @param showErrorStyle  Default value is null
     * @see com.smartgwt.client.widgets.form.fields.FormItem#setCellStyle
     * @see com.smartgwt.client.docs.Appearance Appearance overview and related methods
     */
     ...
     * them. See {@link com.smartgwt.client.docs.FormItemBaseStyle} for a  discussion for how error styling is calculated.
     *
     * @param showErrorText  Default value is null
     * @see com.smartgwt.client.docs.Appearance Appearance overview and related methods
     */
     ...
     * <p><b>Note : </b> This is an advanced setting</p>
     *
     * @param showFocusedErrorState  Default value is false
     * @see com.smartgwt.client.widgets.form.fields.FormItem#setCellStyle
     * @see com.smartgwt.client.docs.Appearance Appearance overview and related methods
     */
    ...
    public Boolean getShowFocusedErrorState()  {
        return getAttributeAsBoolean("showFocusedErrorState");
    }
     ...
     * <p><b>Note : </b> This is an advanced setting</p>
     *
     * @param showFocusedIcons  Default value is null
     */
     ...
     *
     * @param showFocusedPickerIcon  Default value is false
     */
     ...
     * <p><b>Note : </b> This is an advanced setting</p>
     *
     * @param showHint  Default value is true
     * @see com.smartgwt.client.docs.Appearance Appearance overview and related methods
     */
     ...
     * <p><b>Note : </b> This is an advanced setting</p>
     *
     * @param showOverIcons  Default value is null
     */
     ...
     *
     * @param showPickerIcon  Default value is null
     */
     ...
     * <p><b>Note : </b> This is an advanced setting</p>
     *
     * @param showRTL  Default value is false
     * @see com.smartgwt.client.widgets.form.fields.FormItem#setCellStyle
     * @see com.smartgwt.client.docs.Appearance Appearance overview and related methods
     */
     ...
     *
     * @param startRow  Default value is false
     * @see com.smartgwt.client.docs.FormLayout FormLayout overview and related methods
     */
     ...
     *
     * @param staticHeight  Default value is null
     ...
     *
     * @param stopOnError  Default value is null
     */
     ...
     *
     * @param synchronousValidation  Default value is null
     */
     ...
     *
     * @param tabIndex  Default value is null
     * @see com.smartgwt.client.docs.Focus Focus overview and related methods
     */
     ...
     *
     * @param textAlign  Default value is Canvas.LEFT
     * @see com.smartgwt.client.docs.Appearance Appearance overview and related methods
     */
     ...
     *
     * @param titleAlign  Default value is null
     */
     ...
     *
     * @param titleColSpan  Default value is 1
     * @see com.smartgwt.client.docs.FormLayout FormLayout overview and related methods
     */
     ...
     *
     * @param titleOrientation  Default value is Canvas.LEFT
     ...
     * also affected by {@link com.smartgwt.client.widgets.form.DynamicForm#getTitlePrefix titlePrefix}/{@link
     ...
     * <code>"right"</code>.
     *
     * @param titleVAlign  Default value is Canvas.CENTER
     */
     ...
     *
     * @param validateOnChange  Default value is false
     ...
     *
     * @param validateOnExit  Default value is false
     ...
     * client-server validation, validators must be specified on the DataSource.
     *
     ...
     * com.smartgwt.client.widgets.form.fields.FormItem#shouldApplyHeightToTextBox FormItem.shouldApplyHeightToTextBox} is
     * true, for this to have a visible effect, the cell height must exceed the specified height of the item, either due to an
     * explicit {@link com.smartgwt.client.widgets.form.fields.FormItem#getCellHeight cellHeight} specification, or due to the
     * row being expanded by another taller item. <P> Has no effect if {@link
     * com.smartgwt.client.widgets.form.DynamicForm#getItemLayout itemLayout} is set to <code>"absolute"</code> for the form.
     *
     ...
     * icon.
     *
     * @param valueIconLeftPadding  Default value is 0
     ...
     *
     * @param valueIconRightPadding  Default value is 3
     * @see com.smartgwt.client.widgets.form.fields.FormItem#setValueIcons
     */
     ...
     *
     * @param visible  Default value is true
     * @see com.smartgwt.client.docs.Appearance Appearance overview and related methods
     */
     ...
     * column spanning} item). <P> If width is specified as a String, getWidth() will return -1.  Use 
     * +sgwtLink{getWidthAsString()} in this case.<p> See the {@link com.smartgwt.client.docs.FormLayout} overview for details.
     *
     ...
     */
    public int getWidth()  {
        if(getAttributeAsObject("width") instanceof String) { return -1; }
     ...
     *
     * @param wrapTitle  Default value is null
     */
    ...
    private native void setupPickerIconClickEvent() /*-{
        ...
        obj = this.@com.smartgwt.client.core.DataClass::getJsObj()();
        var selfJ = this;
        var pickerIconClick = $entry(function(){
            var param = {"form" : arguments[0], "item" : arguments[1], "pickerIcon" : arguments[2]};
        ...
        obj.pickerIconClick =  pickerIconClick 
        ;
   }-*/;
	/**
     ...
     * will be available via {@link com.smartgwt.client.widgets.form.fields.FormItem#getSelectedRecord
     * this.getSelectedRecord()}. <P> Default behavior will return false if {@link
     * com.smartgwt.client.widgets.form.fields.FormItem#getFetchMissingValues this.fetchMissingValues} is  set to false.
     * Otherwise it will return true if {@link com.smartgwt.client.widgets.form.fields.FormItem#getAlwaysFetchMissingValues
     * this.alwaysFetchMissingValues} is set to true, or if a {@link
     ...
     * new value for this item. <P> This method is intended to provide a way for custom formItems - most commonly  {@link
     ...
     * com.smartgwt.client.widgets.form.fields.CanvasItem#getCanvas canvas}, or a pop-up dialog launched from an {@link
     * com.smartgwt.client.widgets.form.fields.FormItemIcon icon}, etc.  Developers should call this method when the user
     * interacts with this custom  interface in order to store out the changed value. <P> If you cannot easily detect
     * interactions that should change the value as the  user performs them, a workaround is to call <code>storeValue</code>
     * right before the form saves. <P> Note that this method is not designed for customizing a value which is already being
     * saved by a standard user interaction. For example you should not call this method from a {@link
    ...
    public static native void setDefaultProperties(FormItem formItemProperties) /*-{
    	var properties = $wnd.isc.addProperties({},formItemProperties.@com.smartgwt.client.core.RefDataClass::getJsObj()());
    ...
    public Boolean getAttributeAsBoolean(String attribute) {
        if (isCreated()) {
            return _getAttributeAsBoolean(attribute);
        } else {
    ...
    public native JavaScriptObject getConfig() /*-{
        ...
        for(var k in self) {
            ...
            if(k != '__ref' && k != '__module' && k != 'type'  && k != 'editorType' && k != 'name') {
                config[k] = self[k];
            }
        }
    ...
    */
     ...
     * valueMap}. Note that this method will not be applied to values displayed in a free-form text entry field (such as a
    ...
    public native void setCriterionGetter(FormItemCriterionGetter getter) /*-{
        var me = this,
            self = me.@com.smartgwt.client.core.DataClass::getJsObj()();
    	self._hasCustomCriteriaMethod = true;
