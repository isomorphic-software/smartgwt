...
public class PickerIconClickEvent extends AbstractSmartEvent<PickerIconClickHandler>  implements Cancellable {
    private boolean cancel = false;

    /**
     * Handler type.
     */
    private static Type<PickerIconClickHandler> TYPE;
     ...
     */
    public static <S extends HasPickerIconClickHandlers & HasHandlers> void fire(
        S source, JavaScriptObject jsObj) {
        if (TYPE != null) {
            PickerIconClickEvent event = new PickerIconClickEvent(jsObj);
     ...
     */
    public static Type<PickerIconClickHandler> getType() {
        if (TYPE == null) {
            TYPE = new Type<PickerIconClickHandler>();
        }
        return TYPE;
    }
    ...
    protected void dispatch(PickerIconClickHandler handler) {
        handler.onPickerIconClick(this);
    }
    ...
    @Override
    public final Type<PickerIconClickHandler> getAssociatedType() {
        return TYPE;
    }

    public PickerIconClickEvent(JavaScriptObject jsObj) {
        super(jsObj);
    }
     ...
     *
     * @return the DynamicForm containing the picker icon's item.
     */
     ...
     *
     * @return the FormItem containing the picker icon.
     */
     ...
     * the picker icon.
     *
     * @return the picker icon.
     */
    public native FormItemIcon getPickerIcon() /*-{
        var self = this.@com.smartgwt.client.event.AbstractSmartEvent::jsObj;
        var ret = self.pickerIcon;
        if(ret == null) return null;
