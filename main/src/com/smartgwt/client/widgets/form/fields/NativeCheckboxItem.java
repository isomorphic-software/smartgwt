...
public class NativeCheckboxItem extends FormItem {
    ...
    public static NativeCheckboxItem getOrCreateRef(JavaScriptObject jsObj) {
        ...
        if (existingObj instanceof NativeCheckboxItem) {
            existingObj.setJsObj(jsObj);
            return (NativeCheckboxItem)existingObj;
        } else
    ...
    public static native void changeAutoChildDefaults(String autoChildName, Canvas defaults) /*-{
        if (defaults.@com.smartgwt.client.widgets.BaseWidget::isCreated()()) {
            @com.smartgwt.client.util.ConfigUtil::warnOfPreConfigInstantiation(Ljava/lang/Class;Ljava/lang/String;Ljava/lang/String;)(NativeCheckboxItem.@java.lang.Object::getClass()(), "changeAutoChildDefaults", "Canvas");
        }
        defaults.@com.smartgwt.client.widgets.BaseWidget::setConfigOnly(Z)(true);
        var cleanDefaultsJS = @com.smartgwt.client.util.JSOHelper::cleanProperties(Lcom/google/gwt/core/client/JavaScriptObject;Z)(defaults.@com.smartgwt.client.widgets.BaseWidget::getConfig()(), true);
        $wnd.isc.NativeCheckboxItem.changeDefaults(autoChildName + "Defaults", cleanDefaultsJS);
    }-*/;
    ...
    public static native void changeAutoChildDefaults(String autoChildName, FormItem defaults) /*-{
        if (defaults.@com.smartgwt.client.widgets.form.fields.FormItem::isCreated()()) {
            @com.smartgwt.client.util.ConfigUtil::warnOfPreConfigInstantiation(Ljava/lang/Class;Ljava/lang/String;Ljava/lang/String;)(NativeCheckboxItem.@java.lang.Object::getClass()(), "changeAutoChildDefaults", "FormItem");
        }
    ...
    public static native void setDefaultProperties(NativeCheckboxItem nativeCheckboxItemProperties) /*-{
        if (nativeCheckboxItemProperties.@com.smartgwt.client.widgets.form.fields.FormItem::isCreated()()) {
            @com.smartgwt.client.util.ConfigUtil::warnOfPreConfigInstantiation(Ljava/lang/Class;Ljava/lang/String;Ljava/lang/Class;)(NativeCheckboxItem.@java.lang.Object::getClass()(), "setDefaultProperties", nativeCheckboxItemProperties.@java.lang.Object::getClass()());
        }
        nativeCheckboxItemProperties.@com.smartgwt.client.widgets.form.fields.FormItem::setConfigOnly(Z)(true);
    	var properties = nativeCheckboxItemProperties.@com.smartgwt.client.widgets.form.fields.FormItem::getConfig()();
