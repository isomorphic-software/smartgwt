...
public class RelativeDateItem extends CanvasItem {
    ...
    public static native void changeAutoChildDefaults(String autoChildName, DrawItem defaults) /*-{
        $wnd.isc.RelativeDateItem.changeDefaults(autoChildName + "Defaults", defaults.@com.smartgwt.client.widgets.drawing.DrawItem::getJsObj()());
    }-*/;
     ...
     * Setting the width globally on the {@link com.smartgwt.client.widgets.form.fields.DateTimeItem#getWidth DateTimeItem}
     * class results in all text-based datetime entry fields assuming the same default width - this caters for custom date-time
     * formatters that need differing amounts of space.
     *
     * @param valueFieldWidth  Default value is -1
     */
    ...
    public int getValueFieldWidth()  {
        if(getAttributeAsObject("valueFieldWidth") instanceof String) { return -1; }
