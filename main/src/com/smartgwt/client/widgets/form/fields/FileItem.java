...
import com.google.gwt.event.logical.shared.HasHandlers;
   /**
    * Binary data interface for use in DynamicForms. Allows users to select a single file for upload. <P> See the Upload Overview for information on using this control.
