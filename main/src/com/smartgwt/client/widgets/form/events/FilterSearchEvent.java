...
public class FilterSearchEvent extends BrowserEvent<SearchHandler>  {
     ...
     */
    public static <S extends HasSearchHandlers & HasHandlers> void fire(
        S source, JavaScriptObject jsObj) {
        if (TYPE != null) {
            FilterSearchEvent event = new FilterSearchEvent(jsObj);
     ...
     *
     * @return The criteria represented by the filterBuilder
     */
    public  native AdvancedCriteria getCriteria() /*-{
        var jsObj = this.@com.smartgwt.client.event.AbstractSmartEvent::jsObj;
        return @com.smartgwt.client.data.AdvancedCriteria::new(Lcom/google/gwt/core/client/JavaScriptObject;)(jsObj.criteria);
    }-*/;
