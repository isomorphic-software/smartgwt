...
public class FilterChangedEvent extends BrowserEvent<FilterChangedHandler>  {

    /**
     * Handler type.
     */
    private static Type<FilterChangedHandler> TYPE;
    ...
    public static Type<FilterChangedHandler> getType() {
        if (TYPE == null) {
            TYPE = new Type<FilterChangedHandler>();
        }
        return TYPE;
    }
    ...
    @Override
    public final Type<FilterChangedHandler> getAssociatedType() {
        return TYPE;
    }

    public FilterChangedEvent(JavaScriptObject jsObj) {
        super(jsObj);
    }
