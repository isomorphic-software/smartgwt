...
public class ItemKeyPressEvent extends BrowserEvent<ItemKeyPressHandler>  {
  ...
  @Override
  protected final Type<ItemKeyPressHandler> getAssociatedType() {
    return TYPE;
  }
     ...
     *
     * @return name of the key that was pressed (EG: "A", "Space")
     */
     ...
     *
     * @return numeric character value of the pressed key.
     */
