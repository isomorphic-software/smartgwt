...
public class ColorChangedEvent extends BrowserEvent<ColorChangedHandler>  {
     ...
     */
    public static <S extends HasColorChangedHandlers & HasHandlers> void fire(
        S source, JavaScriptObject jsObj) {
        if (TYPE != null) {
            ColorChangedEvent event = new ColorChangedEvent(jsObj);
    ...
    @Override
    public final Type<ColorChangedHandler> getAssociatedType() {
        return TYPE;
    }

    public ColorChangedEvent(JavaScriptObject jsObj) {
        super(jsObj);
    }
