...
public class Dialog extends Window  implements com.smartgwt.client.widgets.events.HasButtonClickHandlers {
    ...
    public native static Dialog getOrCreateRef(JavaScriptObject jsObj) /*-{
    	...
    	if(instance==undefined) {
            ...
            return instance;
        //} else {
        //    return @com.smartgwt.client.widgets.Dialog::new(Lcom/google/gwt/core/client/JavaScriptObject;)(jsObj);
        }
    }-*/;
     ...
     *
     * @return Return false to cancel closing the window
     */
    public native Boolean closeClick() /*-{
        var self = this.@com.smartgwt.client.widgets.BaseWidget::getOrCreateJsObj()();
        var retVal =self.closeClick();
