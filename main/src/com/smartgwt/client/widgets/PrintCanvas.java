...
public class PrintCanvas extends Canvas {
    ...
    public static native void changeAutoChildDefaults(String autoChildName, Canvas defaults) /*-{
        if (defaults.@com.smartgwt.client.widgets.BaseWidget::isCreated()()) {
            @com.smartgwt.client.util.ConfigUtil::warnOfPreConfigInstantiation(Ljava/lang/Class;Ljava/lang/String;Ljava/lang/String;)(PrintCanvas.@java.lang.Object::getClass()(), "changeAutoChildDefaults", "Canvas");
        }
        defaults.@com.smartgwt.client.widgets.BaseWidget::setConfigOnly(Z)(true);
        var cleanDefaultsJS = @com.smartgwt.client.util.JSOHelper::cleanProperties(Lcom/google/gwt/core/client/JavaScriptObject;Z)(defaults.@com.smartgwt.client.widgets.BaseWidget::getConfig()(), true);
        $wnd.isc.PrintCanvas.changeDefaults(autoChildName + "Defaults", cleanDefaultsJS);
    }-*/;
    ...
    public static native void changeAutoChildDefaults(String autoChildName, FormItem defaults) /*-{
        if (defaults.@com.smartgwt.client.widgets.form.fields.FormItem::isCreated()()) {
            @com.smartgwt.client.util.ConfigUtil::warnOfPreConfigInstantiation(Ljava/lang/Class;Ljava/lang/String;Ljava/lang/String;)(PrintCanvas.@java.lang.Object::getClass()(), "changeAutoChildDefaults", "FormItem");
        }
     ...
     * @return {@link com.smartgwt.client.widgets.PrintCanvas PrintCanvas} instance, for chaining setter calls
     */
    public PrintCanvas setExternalStylesheet(String externalStylesheet) {
        return (PrintCanvas)setAttribute("externalStylesheet", externalStylesheet, true);
    }
     ...
     * should be specified as a URL to load.
     *
     * @return Current externalStylesheet value. Default value is null
     */
     ...
     * <p><b>Note : </b> This is an advanced setting</p>
     *
     * @param printFrameURL New printFrameURL value. Default value is "[HELPERS]printFrame.html"
     * @return {@link com.smartgwt.client.widgets.PrintCanvas PrintCanvas} instance, for chaining setter calls
     * @throws IllegalStateException this property cannot be changed after the component has been created
     */
    public PrintCanvas setPrintFrameURL(String printFrameURL)  throws IllegalStateException {
        return (PrintCanvas)setAttribute("printFrameURL", printFrameURL, false);
    }
     ...
     * the specified location for the printCanvas printing APIs.
     *
     * @return Current printFrameURL value. Default value is "[HELPERS]printFrame.html"
     */
     ...
     * when the canvas is drawn. <P> Note that if the printCanvas is {@link com.smartgwt.client.widgets.Canvas#redraw redrawn},
     * or  {@link com.smartgwt.client.widgets.Canvas#clear cleared} and then {@link com.smartgwt.client.widgets.Canvas#draw
     * drawn} again, the HTML will be redisplayed inside the print canvas, and the specified callback will be fired again.
    ...
    public native void setHTML(String HTML, PrintCanvasCallback callback) /*-{
        if (this.@com.smartgwt.client.widgets.BaseWidget::isConfigOnly()()) {
            @com.smartgwt.client.util.ConfigUtil::warnOfPostConfigInstantiation(Ljava/lang/Class;Ljava/lang/String;Ljava/lang/String;)(this.@java.lang.Object::getClass()(), "setHTML", "String,PrintCanvasCallback");
        }
        var self = this.@com.smartgwt.client.widgets.BaseWidget::getOrCreateJsObj()();
        self.setHTML(HTML, 
			$entry( function(printPreview) { 
				if(callback!=null) callback.@com.smartgwt.client.util.PrintCanvasCallback::execute(Lcom/smartgwt/client/widgets/PrintCanvas;)(
					printPreview != null ? @com.smartgwt.client.widgets.Canvas::getByJSObject(Lcom/google/gwt/core/client/JavaScriptObject;)(printPreview) : null
				);
			}));
    }-*/;
    ...
    public static native void setDefaultProperties(PrintCanvas printCanvasProperties) /*-{
        if (printCanvasProperties.@com.smartgwt.client.widgets.BaseWidget::isCreated()()) {
            @com.smartgwt.client.util.ConfigUtil::warnOfPreConfigInstantiation(Ljava/lang/Class;Ljava/lang/String;Ljava/lang/Class;)(PrintCanvas.@java.lang.Object::getClass()(), "setDefaultProperties", printCanvasProperties.@java.lang.Object::getClass()());
        }
        printCanvasProperties.@com.smartgwt.client.widgets.BaseWidget::setConfigOnly(Z)(true);
    	var properties = printCanvasProperties.@com.smartgwt.client.widgets.BaseWidget::getConfig()();
