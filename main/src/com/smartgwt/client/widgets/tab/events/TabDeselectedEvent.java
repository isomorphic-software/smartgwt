...
public class TabDeselectedEvent extends BrowserEvent<TabDeselectedHandler>  implements Cancellable {
     ...
     *
     * @return the index of the deselected tab
     */
     ...
     *
     * @return the deselected tab's pane if set
     */
     ...
     *
     * @return the ID of the deselected tab
     */
     ...
     *
     * @return the name of the deselected tab
     */
    ...
    public native TabSet getTabSet() /*-{
        ...
        var ret = self.tabSet;
        if (ret == null) {
            return this.@com.smartgwt.client.widgets.tab.events.TabDeselectedEvent::getFiringCanvas()();
        }
        return @com.smartgwt.client.widgets.Canvas::getByJSObject(Lcom/google/gwt/core/client/JavaScriptObject;)(ret);
    }-*/;
