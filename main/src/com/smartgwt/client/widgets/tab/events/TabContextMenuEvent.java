...
public class TabContextMenuEvent extends BrowserEvent<TabContextMenuHandler>  implements Cancellable {
     ...
     * Handler type.
     */
    private static Type<TabContextMenuHandler> TYPE;
     ...
     */
    public static <S extends HasTabContextMenuHandlers & HasHandlers> void fire(
        S source, JavaScriptObject jsObj) {
        if (TYPE != null) {
            TabContextMenuEvent event = new TabContextMenuEvent(jsObj);
     ...
     */
    public static Type<TabContextMenuHandler> getType() {
        if (TYPE == null) {
            TYPE = new Type<TabContextMenuHandler>();
        }
        return TYPE;
    }
    ...
    @Override
    public final Type<TabContextMenuHandler> getAssociatedType() {
        return TYPE;
    }

    public TabContextMenuEvent(JavaScriptObject jsObj) {
        super(jsObj);
    }
    ...
    public native TabSet getTabSet() /*-{
        ...
        var ret = self.tabSet;
        return @com.smartgwt.client.widgets.tab.TabSet::getByJSObject(Lcom/google/gwt/core/client/JavaScriptObject;)(ret);
    }-*/;
