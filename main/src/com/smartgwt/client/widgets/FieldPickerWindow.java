...
public class FieldPickerWindow extends Window {
    ...
    public static native void changeAutoChildDefaults(String autoChildName, Canvas defaults) /*-{
        if (defaults.@com.smartgwt.client.widgets.BaseWidget::isCreated()()) {
            @com.smartgwt.client.util.ConfigUtil::warnOfPreConfigInstantiation(Ljava/lang/Class;Ljava/lang/String;Ljava/lang/String;)(FieldPickerWindow.@java.lang.Object::getClass()(), "changeAutoChildDefaults", "Canvas");
        }
        defaults.@com.smartgwt.client.widgets.BaseWidget::setConfigOnly(Z)(true);
        var cleanDefaultsJS = @com.smartgwt.client.util.JSOHelper::cleanProperties(Lcom/google/gwt/core/client/JavaScriptObject;Z)(defaults.@com.smartgwt.client.widgets.BaseWidget::getConfig()(), true);
        $wnd.isc.FieldPickerWindow.changeDefaults(autoChildName + "Defaults", cleanDefaultsJS);
    }-*/;
    ...
    public static native void changeAutoChildDefaults(String autoChildName, FormItem defaults) /*-{
        if (defaults.@com.smartgwt.client.widgets.form.fields.FormItem::isCreated()()) {
            @com.smartgwt.client.util.ConfigUtil::warnOfPreConfigInstantiation(Ljava/lang/Class;Ljava/lang/String;Ljava/lang/String;)(FieldPickerWindow.@java.lang.Object::getClass()(), "changeAutoChildDefaults", "FormItem");
        }
    ...
    /**
     * By default, a FieldPickerWindow will close automatically if the mouse is clicked outside of it.  To have the window
     * shown with true modality, set this attribute to false.
     *
     * @param autoDismiss New autoDismiss value. Default value is true
     * @return {@link com.smartgwt.client.widgets.FieldPickerWindow FieldPickerWindow} instance, for chaining setter calls
     * @throws IllegalStateException this property cannot be changed after the component has been created
     */
    public FieldPickerWindow setAutoDismiss(Boolean autoDismiss)  throws IllegalStateException {
        return (FieldPickerWindow)setAttribute("autoDismiss", autoDismiss, false);
    }
     ...
     * <p>
     * This component is an AutoChild named "fieldPicker".  For an overview of how to use and
     * configure AutoChildren, see {@link com.smartgwt.client.docs.AutoChildUsage Using AutoChildren}.
     *
     * @return Current fieldPicker value. Default value is null
     ...
     * 
     *
     * @param title New title value. Default value is "Field Picker"
     * @throws IllegalStateException this property cannot be changed after the component has been created
     */
     ...
     * 
     *
     * @return Current title value. Default value is "Field Picker"
     */
    ...
    public static native void setDefaultProperties(FieldPickerWindow fieldPickerWindowProperties) /*-{
        if (fieldPickerWindowProperties.@com.smartgwt.client.widgets.BaseWidget::isCreated()()) {
            @com.smartgwt.client.util.ConfigUtil::warnOfPreConfigInstantiation(Ljava/lang/Class;Ljava/lang/String;Ljava/lang/Class;)(FieldPickerWindow.@java.lang.Object::getClass()(), "setDefaultProperties", fieldPickerWindowProperties.@java.lang.Object::getClass()());
        }
        fieldPickerWindowProperties.@com.smartgwt.client.widgets.BaseWidget::setConfigOnly(Z)(true);
    	var properties = fieldPickerWindowProperties.@com.smartgwt.client.widgets.BaseWidget::getConfig()();
    ...
    public LogicalStructureObject setLogicalStructure(FieldPickerWindowLogicalStructure s) {
        ...
        try {
            ...
            s.logicalStructureErrors += "FieldPickerWindow.autoDismiss:" + t.getMessage() + "\n";
        }
        try {
