...
public class FieldPickerWindow extends Window {
    ...
    public native static FieldPickerWindow getOrCreateRef(JavaScriptObject jsObj) /*-{
        if (jsObj == null) return null;
        var instance = jsObj["__ref"];
        if (instance == null) {
            return @com.smartgwt.client.util.ObjectFactory::createCanvas(Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)("FieldPickerWindow",jsObj);
        } else {
            return instance;
        }
    }-*/;
     ...
     * 
     *
     * @param title . See {@link com.smartgwt.client.docs.String String}. Default value is "Field Picker"
