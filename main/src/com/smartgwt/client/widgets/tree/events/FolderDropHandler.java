...
public interface FolderDropHandler extends EventHandler {
     ...
     * For a drop from another widget, {@link com.smartgwt.client.widgets.tree.TreeGrid#transferDragData transferDragData()} is
     * called which, depending on the {@link com.smartgwt.client.widgets.tree.TreeGrid#getDragDataAction dragDataAction}
     ...
     * above). <P> If these default persistence behaviors are undesirable, Call {@link com.smartgwt.client.widgets.tree.events.FolderDropEvent#cancel()} from within {@link com.smartgwt.client.widgets.tree.events.FolderDropHandler#onFolderDrop} to cancel them, then and implement your
     * own behavior, typically by using grid.updateData() or addData() to add new records. <p><b>NOTE:</b> the records you
     * receive in this event are the actual Records from the source component.  Use {@link
     ...
     */
    void onFolderDrop(com.smartgwt.client.widgets.tree.events.FolderDropEvent event);
}
