...
public class NodeClickEvent extends BrowserEvent<NodeClickHandler>  {

    /**
     * Handler type.
     */
    private static Type<NodeClickHandler> TYPE;
     ...
     */
    public static Type<NodeClickHandler> getType() {
        if (TYPE == null) {
            TYPE = new Type<NodeClickHandler>();
        }
        return TYPE;
    }
    ...
    @Override
    public final Type<NodeClickHandler> getAssociatedType() {
        return TYPE;
    }

    public NodeClickEvent(JavaScriptObject jsObj) {
        super(jsObj);
    }
     ...
     *
     * @return The TreeGrid on which leafClick() occurred.
     */
    public native TreeGrid getViewer() /*-{
        var self = this.@com.smartgwt.client.event.AbstractSmartEvent::jsObj;
        var ret = self.viewer;
        if(ret == null) return null;
        return @com.smartgwt.client.widgets.tree.TreeGrid::getOrCreateRef(Lcom/google/gwt/core/client/JavaScriptObject;)(ret);
    }-*/;
	/**
     * The node (record) that was clicked
     *
     * @return The node (record) that was clicked
     */
