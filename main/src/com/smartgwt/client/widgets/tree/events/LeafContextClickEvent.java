...
public class LeafContextClickEvent extends BrowserEvent<LeafContextClickHandler>  implements Cancellable {
   ...
   * Handler type.
   */
  private static Type<LeafContextClickHandler> TYPE;
   ...
   */
  public static Type<LeafContextClickHandler> getType() {
    if (TYPE == null) {
      TYPE = new Type<LeafContextClickHandler>();
    }
    return TYPE;
  }
  ...
  @Override
  protected void dispatch(LeafContextClickHandler handler) {
    handler.onLeafContextClick(this);
  }
  ...
  protected final Type<LeafContextClickHandler> getAssociatedType() {
    ...
    public LeafContextClickEvent(JavaScriptObject jsObj) {
        super(jsObj);
    }
     ...
     *
     * @return The leaf (record) on which the contextclick occurred.
     */
    public  native TreeNode getLeaf() /*-{
        var jsObj = this.@com.smartgwt.client.event.AbstractSmartEvent::jsObj;
            var retVal = @com.smartgwt.client.widgets.tree.TreeNode::getOrCreateRef(Lcom/google/gwt/core/client/JavaScriptObject;)(jsObj.leaf);
            if(retVal == null) {
                retVal = @com.smartgwt.client.widgets.tree.TreeNode::new(Lcom/google/gwt/core/client/JavaScriptObject;)(jsObj.leaf);
            }
            return retVal;
    }-*/;
