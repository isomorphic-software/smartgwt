...
public interface ChartBackgroundDrawnHandler extends EventHandler {
     ...
     * com.smartgwt.client.widgets.chart.FacetChart#getChartLeft getChartLeft()}) may return bad values if called at other
     * times. <P> Additional DrawItems added in this method will appear underneath data elements such as bars or columns.  See
     * {@link com.smartgwt.client.widgets.chart.FacetChart#addChartDrawnHandler FacetChart.chartDrawn()} for placing DrawItems
