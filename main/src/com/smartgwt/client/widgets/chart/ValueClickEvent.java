...
public class ValueClickEvent extends BrowserEvent<ValueClickHandler>  {
     ...
     */
    public static <S extends HasValueClickHandlers & HasHandlers> void fire(
        S source, JavaScriptObject jsObj) {
        if (TYPE != null) {
            ValueClickEvent event = new ValueClickEvent(jsObj);
     ...
     */
    public static Type<ValueClickHandler> getType() {
        if (TYPE == null) {
    ...
    @Override
    public final Type<ValueClickHandler> getAssociatedType() {
        return TYPE;
    }

    public ValueClickEvent(JavaScriptObject jsObj) {
        super(jsObj);
    }
     ...
     *
     * @return information about the value that was clicked
     */
    public native DrawnValue getDrawnValue() /*-{
        var self = this.@com.smartgwt.client.event.AbstractSmartEvent::jsObj;
        var ret = self.drawnValue;
