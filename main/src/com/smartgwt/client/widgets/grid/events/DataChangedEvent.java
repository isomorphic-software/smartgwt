...
public class DataChangedEvent extends BrowserEvent<DataChangedHandler>  {
     ...
     *
     * @return optionally passed operation causing the change
     */
    public native String getOperationType() /*-{
        var self = this.@com.smartgwt.client.event.AbstractSmartEvent::jsObj;
        var ret = self.operationType;
