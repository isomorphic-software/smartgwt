...
public class FilterEditorSubmitEvent extends BrowserEvent<FilterEditorSubmitHandler>  implements Cancellable {
     ...
     * Handler type.
     */
    private static Type<FilterEditorSubmitHandler> TYPE;
     ...
     */
    public static <S extends HasFilterEditorSubmitHandlers & HasHandlers> void fire(
        S source, JavaScriptObject jsObj) {
        if (TYPE != null) {
            FilterEditorSubmitEvent event = new FilterEditorSubmitEvent(jsObj);
     ...
     */
    public static Type<FilterEditorSubmitHandler> getType() {
        if (TYPE == null) {
            TYPE = new Type<FilterEditorSubmitHandler>();
        }
        return TYPE;
    }
    ...
    @Override
    public final Type<FilterEditorSubmitHandler> getAssociatedType() {
        return TYPE;
    }

    public FilterEditorSubmitEvent(JavaScriptObject jsObj) {
        super(jsObj);
    }
