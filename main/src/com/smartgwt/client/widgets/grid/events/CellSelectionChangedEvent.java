...
public class CellSelectionChangedEvent extends BrowserEvent<CellSelectionChangedHandler>  implements Cancellable {
     ...
     */
    public static <S extends HasCellSelectionChangedHandlers & HasHandlers> void fire(
        S source, JavaScriptObject jsObj) {
        if (TYPE != null) {
            CellSelectionChangedEvent event = new CellSelectionChangedEvent(jsObj);
    ...
    @Override
    public final Type<CellSelectionChangedHandler> getAssociatedType() {
        return TYPE;
    }
     ...
     *
     * @return Array of cells whos selected state was modified.
     */
    public int[][] getCellList() {
        JavaScriptObject jsCells = getCellListJS();
        if (jsCells == null) return null;
        return JSOHelper.getCellArray(jsCells);
    }
    private native JavaScriptObject getCellListJS() /*-{
        var jsObj = this.@com.smartgwt.client.event.AbstractSmartEvent::jsObj;
        return jsObj.cellList;
    }-*/;
