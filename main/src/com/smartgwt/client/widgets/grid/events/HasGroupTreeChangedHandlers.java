...
public interface HasGroupTreeChangedHandlers extends HasHandlers {
    /**
     ...
     * of the operation.
     *
     * @param handler the groupTreeChanged handler
     * @return {@link HandlerRegistration} used to remove this handler
     */
    HandlerRegistration addGroupTreeChangedHandler(GroupTreeChangedHandler handler);
}
