...
public class HiliteEditor extends VLayout {
     ...
     * button.
     *
     * @param addAdvancedRuleButtonTitle  Default value is "Add Advanced Rule"
     ...
     * fieldList}.
     *
     * @param availableFieldsColumnTitle  Default value is "Available Fields"
     * @throws IllegalStateException this property cannot be changed after the component has been created
     */
     ...
     * If the user picks an icon, the created hiliting rule will have {@link com.smartgwt.client.data.Hilite#getIcon icon} set
     * to  the chosen icon.  {@link com.smartgwt.client.widgets.grid.ListGridField#getHiliteIconPosition hiliteIconPosition}
     * controls where the icon will  appear for that field -- the default is that it appears in front of the normal cell
     * content.
     *
     ...
     *
     * @param saveButtonTitle  Default value is "Save"
     * @throws IllegalStateException this property cannot be changed after the component has been created
     */
