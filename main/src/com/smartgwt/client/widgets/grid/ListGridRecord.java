...
public class ListGridRecord extends Record {
     ...
     * com.smartgwt.client.widgets.grid.ListGrid#getRecordEditProperty recordEditProperty}.
     *
     * @param _canEdit  Default value is null
     ...
     * com.smartgwt.client.widgets.grid.ListGrid#getRecordCanRemoveProperty recordCanRemoveProperty}.
     *
     * @param _canRemove  Default value is null
     * @see com.smartgwt.client.docs.Editing Editing overview and related methods
     */
     ...
     * properties specified for {@link com.smartgwt.client.widgets.grid.ListGrid#getBackgroundComponent backgroundComponent}
     * and displayed behind this record in the page's z-order, meaning it will only be visible if the cell styling is
     * transparent.
     *
     * @param backgroundComponent  Default value is null
     */
     ...
     *
     * @param canExpand  Default value is null
     */
     ...
     * {@link com.smartgwt.client.widgets.grid.ListGrid#getRecordCanSelectProperty recordCanSelectProperty}.
     *
     ...
     *
     * @param includeInSummary  Default value is null
     */
     ...
     *
     * @param isGridSummary  Default value is null
     */
    ...
    public Boolean getIsGridSummary()  {
        return getAttributeAsBoolean("isGridSummary", true);
    }
     ...
     *
     * @param isGroupSummary  Default value is null
     */
    ...
    public Boolean getIsGroupSummary()  {
        return getAttributeAsBoolean("isGroupSummary", true);
    }
     ...
     *
     * @param isSeparator  Default value is null
     */
     ...
     *
     * @param singleCellValue  Default value is null
     */
