...
public class AdvancedHiliteEditor extends VLayout {
     ...
     *
     * @param appearanceGroupTitle  Default value is "Appearance"
     ...
     *
     * @param filterGroupTitle  Default value is "Filter"
     * @throws IllegalStateException this property cannot be changed after the component has been created
     */
     ...
     * hiliting rule will have {@link com.smartgwt.client.data.Hilite#getIcon icon} set to  the chosen icon.  {@link
     ...
     *
     * @param invalidHilitePrompt  Default value is "Enter at least one rule, a color or icon, and a target field, or press 'Cancel' to abandon changes."
     * @throws IllegalStateException this property cannot be changed after the component has been created
     */
     ...
     *
     * @param targetFieldsItemTitle  Default value is "Target Field(s)"
     * @throws IllegalStateException this property cannot be changed after the component has been created
     */
     ...
     *
     * @param title  Default value is "Advanced Hilite Editor"
     * @throws IllegalStateException this property cannot be changed after the component has been created
     */
