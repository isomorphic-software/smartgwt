 ...
 * formats. <P> By default, a BatchUploader consists of a single {@link com.smartgwt.client.widgets.form.fields.FileItem}
 * form field. This form field will upload a file using the special "batchUpload" built-in DataSource. The uploaded file
 * data will be parsed and validated using the {@link com.smartgwt.client.widgets.BatchUploader#getUploadDataSource
 * uploadDataSource}, then streamed back to the browser, along with any errors, for display in a ListGrid.   <P> The user
 * can then correct any errors and submit the final dataset, which will be added to the DataSource via a series of "add"
 * DSRequests, all submitted as a single HTTP request via {@link com.smartgwt.client.rpc.RPCManager#startQueue request
 * queuing}. <P> Additional form fields can be added to the form that uploads the data file via  {@link
...
public class BatchUploader extends BaseWidget {
    ...
    public native static BatchUploader getOrCreateRef(JavaScriptObject jsObj) /*-{
    	...
    	if(instance==undefined) {
            return @com.smartgwt.client.util.ObjectFactory::createCanvas(Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)("BatchUploader",jsObj);
        } else if(instance != null) {
            return instance;
        //} else {
        //    return @com.smartgwt.client.widgets.BatchUploader::new(Lcom/google/gwt/core/client/JavaScriptObject;)(jsObj);
        }
    }-*/;
