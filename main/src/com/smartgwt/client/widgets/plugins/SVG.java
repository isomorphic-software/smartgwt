...
public class SVG extends BrowserPlugin {
    ...
    public static SVG getOrCreateRef(JavaScriptObject jsObj) {
        ...
        if (refInstance == null) {
            ...
            assert refInstance instanceof SVG;
            return (SVG)refInstance;
        }
    }
    ...
    public static native void changeAutoChildDefaults(String autoChildName, Canvas defaults) /*-{
        if (defaults.@com.smartgwt.client.widgets.BaseWidget::isCreated()()) {
            @com.smartgwt.client.util.ConfigUtil::warnOfPreConfigInstantiation(Ljava/lang/Class;Ljava/lang/String;Ljava/lang/String;)(SVG.@java.lang.Object::getClass()(), "changeAutoChildDefaults", "Canvas");
        }
        defaults.@com.smartgwt.client.widgets.BaseWidget::setConfigOnly(Z)(true);
        var cleanDefaultsJS = @com.smartgwt.client.util.JSOHelper::cleanProperties(Lcom/google/gwt/core/client/JavaScriptObject;Z)(defaults.@com.smartgwt.client.widgets.BaseWidget::getConfig()(), true);
        $wnd.isc.SVG.changeDefaults(autoChildName + "Defaults", cleanDefaultsJS);
    }-*/;
    ...
    public static native void changeAutoChildDefaults(String autoChildName, FormItem defaults) /*-{
        if (defaults.@com.smartgwt.client.widgets.form.fields.FormItem::isCreated()()) {
            @com.smartgwt.client.util.ConfigUtil::warnOfPreConfigInstantiation(Ljava/lang/Class;Ljava/lang/String;Ljava/lang/String;)(SVG.@java.lang.Object::getClass()(), "changeAutoChildDefaults", "FormItem");
        }
     ...
     * @return {@link com.smartgwt.client.widgets.plugins.SVG SVG} instance, for chaining setter calls
     * @throws IllegalStateException this property cannot be changed after the component has been created
     * @see com.smartgwt.client.docs.URL URL 
     */
    public SVG setPluginsPage(String pluginsPage)  throws IllegalStateException {
        return (SVG)setAttribute("pluginsPage", pluginsPage, false);
    }
     ...
     *
     * @param src New src value. Default value is [HELPERS]svgCanvas.svg
     * @return {@link com.smartgwt.client.widgets.plugins.SVG SVG} instance, for chaining setter calls
     * @throws IllegalStateException this property cannot be changed after the component has been created
     * @see com.smartgwt.client.docs.URL URL 
     */
    public SVG setSrc(String src)  throws IllegalStateException {
        return (SVG)setAttribute("src", src, false);
    }
     ...
     * placeholder SVG files.  <p>
     *
     * @return Current src value. Default value is [HELPERS]svgCanvas.svg
     * @see com.smartgwt.client.docs.URL URL 
     */
    ...
    public static native void setDefaultProperties(SVG sVGProperties) /*-{
        if (sVGProperties.@com.smartgwt.client.widgets.BaseWidget::isCreated()()) {
            @com.smartgwt.client.util.ConfigUtil::warnOfPreConfigInstantiation(Ljava/lang/Class;Ljava/lang/String;Ljava/lang/Class;)(SVG.@java.lang.Object::getClass()(), "setDefaultProperties", sVGProperties.@java.lang.Object::getClass()());
        }
        sVGProperties.@com.smartgwt.client.widgets.BaseWidget::setConfigOnly(Z)(true);
    	var properties = sVGProperties.@com.smartgwt.client.widgets.BaseWidget::getConfig()();
