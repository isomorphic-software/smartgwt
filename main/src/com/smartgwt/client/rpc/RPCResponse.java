...
public class RPCResponse extends DataClass {
    ...
    /** 
     * Indicates that a response with invalid format has been received from server. If the datasource is using "iscServer"
     * dataFormat, this means that the response is not recognized as a valid ISC frame. <p> One possible cause for this error
     * can be the reception of a RestDataSource JSON response that lacks a valid {@link
     * com.smartgwt.client.data.RestDataSource#getJsonPrefix RestDataSource.jsonPrefix} and/or {@link
     * com.smartgwt.client.data.RestDataSource#getJsonSuffix RestDataSource.jsonSuffix} <p> If it is using "xml" or "json"
     * dataFormat, the response could not be parsed as XML or JSON.
     */
    public final static int INVALID_RESPONSE_FORMAT = -16;

    /** 
     * Indicates a {@link com.smartgwt.client.docs.DeclarativeSecurity Declarative Security} failure on the server. See the
     * error handling section in {@link com.smartgwt.client.rpc.RPCManager RPCManager documentation} for more information.
     */
    public final static int STATUS_AUTHORIZATION_FAILURE = -3;
     ...
     */
    public final static int STATUS_FILE_REQUIRED_ERROR = -15;
     ...
     *  is pre-configured to limit post size to 2mb, where the default max post-size in 
     *  Jetty, used by default in Eclipse, is just 200k.
     *  <P>
     ...
     * RPCManager.  To do so, set {@link com.smartgwt.client.rpc.RPCRequest#getWillHandleError RPCRequest.willHandleError} to
     * <code>true</code>.
     *
     * @return Current httpResponseCode value. Default value is null
     */
     ...
     *
     * @return Current httpResponseText value. Default value is null
     */
     ...
     * @see com.smartgwt.client.rpc.RPCRequest#setReportDownloadErrorsAsDocuments
     */
     ...
     * com.smartgwt.client.docs.Relogin Relogin\n Overview} for details.
     *
     * @return Current status value. Default value is 0
     * @see com.smartgwt.client.rpc.RPCRequest#getReportDownloadErrorsAsDocuments
     */
     ...
     *
     * @return Current transactionNum value. Default value is null
     */
