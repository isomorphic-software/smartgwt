...
public abstract class BeanValueType<ValueType> {
    ...
    */
    ...
    /**
     * Is the SmartClient object an instance (or subclass) of the SamrtClient class?
     *
     ...
     *
     * <p>This is similar to {@link JSOHelper#convertToJava()}, but has several
     * differences which are needed for {@link BeanFactory} to work properly. 
     *
     * Note that this method may return a {@link JavaScriptObject} --
     * either the value itself, or possibly a new <code>JavaScriptObject</code>
     * constructed from a config block. In those cases, it may be that {@link
     * #convertFrom()} can still do some <i>further</i> conversion on the return
     * value, since it can take into account opportunities for conversion that
     * are specific to the desired type. In other words, this is a
     * <i>generic</i> conversion function.
     *
     ...
     * with {@link #convertabilityFrom()}. The target classes which are
