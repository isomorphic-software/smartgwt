...
public class DSRequest extends RPCRequest {
    ...
    */
    ...
    /**
    * Type of operation being performed: "fetch", "add", "remove", "update" or "custom".&#010 <P>&#010 This property is generally automatically populated, for example when calling&#010 <code>fetchData()</code> on a DataSource or DataBound component the operationType is&#010 automatically set to "fetch".  Note that "custom" operations are never generated&#010 automatically, they are always fired by your code.
    *
    ...
    */
    ...
    /**
     * Automatically generated unique ID for this request. This ID will be required by developers &#010 making use of the {@link com.smartgwt.client.types.DSProtocol}.
     *
     *
     * @return String
     *
    ...
    */
    ...
    /**
    * Specifies whether the exported data will be downloaded to the file-system or displayed in a &#010 new window. See {@link com.smartgwt.client.types.ExportDisplay} for more information.
    *
