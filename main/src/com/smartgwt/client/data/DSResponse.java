...
import com.google.gwt.event.shared.HasHandlers;
   /**
    * Response sent by the server in response to a {@link com.smartgwt.client.data.DSRequest}.  Contains all the properties available on the basic {@link com.smartgwt.client.rpc.RPCResponse}, in addition to the properties listed here.
...
public class DSResponse extends RPCResponse {
    ...
    /**
     * Starting row of returned server results, when using paged result fetching <p> Note that startRow and endRow are zero-based - the first record is row zero.
     *
     *
     * @return Integer
     *
    ...
    /**
     * End row of returned server results, when using paged result fetching <p> Note that startRow and endRow are zero-based - the first record is row zero.
     *
     *
     * @return Integer
     *
