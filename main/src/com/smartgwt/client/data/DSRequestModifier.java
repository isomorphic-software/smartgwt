 ...
 * com.smartgwt.client.data.DSRequestModifier#getFieldName fieldName}, a {@link
 * com.smartgwt.client.data.DSRequestModifier#getValue value} and possibly an {@link
 * com.smartgwt.client.data.DSRequestModifier#getOperator operator} (optional, and applicable to criteria only).  The value
 * can be static, or - with Power or better  licenses - it can be an expression in the Velocity template language, which
 * will be resolved at runtime, immediately before the DSRequest is executed.
 */
