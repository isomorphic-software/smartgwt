 ...
 * errors: &#010              {   field1:[&#010                      {errorMessage:"First error on field1"},&#010          
 * {errorMessage:"Second error on field1"}&#010                  ]&#010              }&#010      }&#010 }&#010 </pre>&#010
 * <P>&#010 As with the XML format above, an unrecoverable error is indicated by setting the&#010 <code>status</code>
 * attribute to -1 and the <code>data</code> property to the error message.&#010 <P>&#010 <b>Server inbound data
 * formats</b>&#010 <P>&#010 The format of data sent to the server is determined by the {@link
 * com.smartgwt.client.data.OperationBinding#getDataProtocol dataProtocol}&#010 specified for the operation. Request data
 * is sent as parameters if the format is &#010 specified as <code>"getParams"</code> or <code>"postParams"</code>.&#010
 * <P>&#010 In this case, the parameters sent to the server will consist of the DSRequest's data, and any&#010 parameters
 * explicitly specified on the DSRequest object (as {@link com.smartgwt.client.rpc.RPCRequest#getParams params}.<br> &#010
 * If {@link com.smartgwt.client.data.RestDataSource#getSendMetaData sendMetaData} is true, the DSRequest meta &#010 data
 * properties will also be present as parameters, prefixed with &#010 {@link
 * com.smartgwt.client.data.RestDataSource#getMetaDataPrefix metaDataPrefix}.&#010 <P>&#010 Example URL constructed with
 * the metaDataPrefix set to <code>"_"</code> (the default):&#010 <p>&#010 <code>&#010
 ...
 * com.smartgwt.client.widgets.tree.TreeGrid} component. TreeGrids&#010 automatically create a {@link
 * com.smartgwt.client..ResultTree} data object, which requests data directly&#010 from the DataSource.  ResultTrees load
 * data on demand, only requesting currently visible &#010 (open) nodes from the server. This is handled by including a
 * specified value for the parent &#010 id field in the request criteria.<br>&#010 To implement a standard load-on-demand
 * tree RestDataSource back end, you should therefore &#010 simply return the set of nodes that match the criteria passed
 * in. &#010 For example, if your DataSource was defined as the "supplyItem" code snippet above, &#010 a fetch request for
 * all children of a node with <code>itemId</code> set to <code>12</code> &#010 would have <code>"parentId"</code> set to
 * <code>12</code> in the request criteria.&#010 A valid response would then contain all the records that matched this
 * criteria. For example:&#010 <pre>&#010 &lt;response&gt;&#010    &lt;status&gt;0&lt;/status&gt;&#010    &lt;data&gt;&#010
 * &lt;record&gt;&#010          &lt;itemId&gt;15&lt;/itemId&gt;&#010          &lt;parentId&gt;12&lt;/parentId&gt;&#010     
 * &lt;/record&gt;&#010      &lt;record&gt;&#010          &lt;itemId&gt;16&lt;/itemId&gt;&#010         
 * &lt;parentId&gt;12&lt;/parentId&gt;&#010      &lt;/record&gt;&#010    &lt;/data&gt;&#010 &lt;/response&gt;&#010
 * </pre>&#010 The structure of responses for Add, Update and Delete type requests will be the &#010 same regardless of
 * whether the data is hierachical. However you should be aware that &#010 the underlying data storage may need to be
 * managed slightly differently in some cases.<br>&#010 Specifically, Add and Update operations may change the structure of
 * the tree by returning a &#010 new parent id field value for the modified node. Depending on how your data is stored you
 * &#010 may need to include special back-end logic to handle this.<br>&#010 Also, if a user deletes a folder within a
 * databound tree, any children of that folder will &#010 also be dropped from the tree, and can be removed from the
 * back-end data storage.<br>&#010 Note: For a general overview of binding components to Tree structured data, see &#010
