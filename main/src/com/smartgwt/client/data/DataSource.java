...
public class DataSource extends BaseClass implements com.smartgwt.client.data.events.HasHandleErrorHandlers {
     ...
     * supportsAdvancedCriteria()} for further information on this. <p> <b>NOTE:</b> If you specify this property in a
     ...
     *   all data available (<code>startRow:0</code> and <code>endRow:totalRows</code>).  </li> </ul>
     *
     * @return Current autoCacheAllData value. Default value is false
     */
     ...
     * com.smartgwt.client.data.DataSource#getAutoTitle getAutoTitle()}.
     *
     * @return Current autoDeriveTitles value. Default value is true
     */
    ...
    /**
     * Causes {@link com.smartgwt.client.widgets.tree.Tree#discoverTree Tree.discoverTree()} to be called on dsResponse.data in
     * order to automatically discover tree structures in the response data. <P> If autoDiscoverTree is set, discoverTree() is
     * called after the default dsResponse.data has been derived ({@link
     * com.smartgwt.client.data.OperationBinding#getRecordXPath recordXPath} and {@link
     * com.smartgwt.client.data.DataSourceField#getValueXPath valueXPath} have been applied) and after {@link
     * com.smartgwt.client.data.DataSource#transformResponse transformResponse()} has been called. <P> If a DataSourceField is
     * declared with {@link com.smartgwt.client.data.DataSourceField#getChildrenProperty childrenProperty:true}, discoverTree()
     * will be invoked with {@link com.smartgwt.client.widgets.tree.DiscoverTreeSettings#getNewChildrenProperty
     * settings.newChildrenProperty} set to the name of the field marked as the childrenField.  Similarly, if the DataSource
     * has a {@link com.smartgwt.client.data.DataSource#getTitleField titleField} it will be used as the {@link
     ...
     * com.smartgwt.client.widgets.tree.DiscoverTreeSettings#getNameProperty settings.nameProperty}.
     *
     * @return Current autoDiscoverTree value. Default value is false
     */
    public boolean getAutoDiscoverTree()  {
        Boolean result = getAttributeAsBoolean("autoDiscoverTree");
        return result == null ? false : result;
    }
     ...
     * com.smartgwt.client.data.DSRequest#getOperationId DSRequest.operationId}, or are used only for "fetch" requests that use
     * the <code>cacheAllOperationId</code>, allowing other requests to go to server normally. <p> Default of <code>true</code>
     ...
     * while allowing all other requests to go to the server normally.
     *
     * @return Current cacheAcrossOperationIds value. Default value is true
     */
     ...
     * {@link com.smartgwt.client.data.DataSource#setCacheAllData setCacheAllData()}; setting {@link
     ...
     * regardless of whether {@link com.smartgwt.client.data.DSRequest#getOperationId DSRequest.operationId} has been set. 
     * However, "fetch" operationBindings used as a {@link com.smartgwt.client.data.OperationBinding#getCacheSyncOperation
     * OperationBinding.cacheSyncOperation} will work normally, so long as they return all data fields that are returned by the
     * default "fetch" operation, so that the cache can be updated. <P> To specify which operationId to use for fetching all
     * data, use {@link com.smartgwt.client.data.DataSource#getCacheAllOperationId cacheAllOperationId}. <p> To use the cache
     * only for requests that have the <code>cacheAllOperationId</code>, allowing any other operationId (or absence of an
     * operationId) to contact the server as normal, set {@link com.smartgwt.client.data.DataSource#getCacheAcrossOperationIds
     ...
     * cacheAcrossOperationIds}.
     *
     * @return Current cacheAllData value. Default value is null
     */
    ...
    /**
     * {@link com.smartgwt.client.data.DSRequest#getOperationId DSRequest.operationId} to use for fetching data in case {@link
     ...
     * used (with no <code>operationId</code> specified).
     *
     * @return Current cacheAllOperationId value. Default value is null
     */
     ...
     * the current cache will be dropped and another complete cache fetched.
     *
     * @return Current cacheMaxAge value. Default value is 60
     */
     ...
     *  <code>multiple</code> to false in the appropriate dataSource field definition.
     *
     * @return Current childrenField value. Default value is null
     ...
     * addData()}, {@link com.smartgwt.client.data.DataSource#updateData updateData()} and {@link
     ...
     * com.smartgwt.client.data.DataSource#getClientOnlyDataSource getClientOnlyDataSource()} lets you easily obtain a
     ...
     * com.smartgwt.client.data.ResultSet#getCriteria ResultSet.criteria} changes.
     * <p><b>Note : </b> This is an advanced setting</p>
     *
     ...
     * com.smartgwt.client.data.ResultSet#getCriteria ResultSet.criteria} changes.
     *
     * @return Current criteriaPolicy value. Default value is "dropOnShortening"
     * @see com.smartgwt.client.data.DataSource#compareCriteria
     */
     ...
     * determined in the absence of an explicit setting.
     *
     * @return Current dataField value. Default value is null
     * @see com.smartgwt.client.docs.DsSpecialFields DsSpecialFields overview and related methods
     */
     ...
     * com.smartgwt.client.data.OperationBinding#getCallbackParam OperationBinding.callbackParam} to match the name of the
     ...
     * com.smartgwt.client.data.OperationBinding#getDataURL OperationBinding.dataURL}. <P> NOTE: Best practice is to use the
     * same <code>dataURL</code> for all DataSources which fulfill DSRequests via the server-side RPCManager API.  Otherwise,
     ...
     * com.smartgwt.client.widgets.grid.ListGrid#getAutoFetchTextMatchStyle ListGrid.autoFetchTextMatchStyle}, for example).
     *
     * @return Current defaultTextMatchStyle value. Default value is "exact"
     * @see com.smartgwt.client.docs.ServerDataIntegration ServerDataIntegration overview and related methods
     * @see <a href="http://www.smartclient.com/smartgwt/showcase/#grid_databinding_json_datasource" target="examples">JSON DataSource Example</a>
     * @see <a href="http://www.smartclient.com/smartgwt/showcase/#json_integration_category_simple" target="examples">Simple JSON Example</a>
     */
     ...
     * field (greater than 255 characters) in the record, or null if no such field exists.
     *
     * @return Current descriptionField value. Default value is null
     * @see com.smartgwt.client.docs.DsSpecialFields DsSpecialFields overview and related methods
     */
    ...
    /**
     * Settings to use when discoverTree() is automatcially called because {@link
     ...
     * com.smartgwt.client.data.DataSource#getAutoDiscoverTree autoDiscoverTree} is set to true for this DataSource
     *
     * @return Current discoverTreeSettings value. Default value is null
     */
     ...
     * record values for these fields and as such the client-side filtering logic should ignore them.
     *
     * @return Current dropUnknownCriteria value. Default value is true
     */
     ...
     *  "http://www.w3.org/1999/XMLSchema-instance" instead.
     *
     * @return Current globalNamespaces value. Default value is ...
     */
     ...
     * set iconField to <code>null</code>.
     *
     * @return Current iconField value. Default value is see below
     * @see com.smartgwt.client.docs.DsSpecialFields DsSpecialFields overview and related methods
     */
     ...
     * documentation} for a discussion of the nuances of case-sensitive matching.
     *
     * @return Current ignoreTextMatchStyleCaseSensitive value. Default value is false
     */
    ...
    /**
     * Criteria that are implicitly applied to all fetches made through this DataSource.  These criteria are never shown to or
     * edited by the user and are cumulative with any other  criteria provided on the DSRequest. <P> For example, a DataSource
     * might *always* implicitly limit its fetch results to records  owned by the current user's department.  Components and
     * ResultSets requesting data  from the DataSource can then apply further implicitCriteria of their own, separately  from
     * their regular, user-editable criteria. <P> For instance, a grid bound to this dataSource might be further limited to 
     * implicitly show only the subset of records created by the current user.  See  {@link
     * com.smartgwt.client.widgets.DataBoundComponent#getImplicitCriteria DataBoundComponent.implicitCriteria} and {@link
     * com.smartgwt.client.data.ResultSet#getImplicitCriteria ResultSet.implicitCriteria} for  more on these localized options.
     * <P> Note that, while <code>implicitCriteria</code> can be declared in a server DataSource  file using {@link
     * com.smartgwt.client.docs.ComponentXML Component XML}, it is an entirely client-side  feature, added by client-side
     ...
     * not automatically determined in the absence of an explicit setting.
     *
     * @return Current infoField value. Default value is null
     * @see com.smartgwt.client.docs.DsSpecialFields DsSpecialFields overview and related methods
     */
     ...
     * target='_blank'>javascript hijacking</a>. <P> Only applies to responses formatted as json objects. Does not apply to
     * responses returned via scriptInclude type transport.<br> Note: If the prefix / suffix served by your backend is not a
     * constant, you can use  {@link com.smartgwt.client.data.OperationBinding#getDataFormat dataFormat:"custom"} instead and
     * explicitly parse the prefix out as part of {@link com.smartgwt.client.data.DataSource#transformResponse
     * transformResponse()}.
     * <p><b>Note : </b> This is an advanced setting</p>
     *
     ...
     * transformResponse()}.
     *
     * @return Current jsonPrefix value. Default value is null
     ...
     * responses returned via scriptInclude type transport.
     *
     * @return Current jsonSuffix value. Default value is null
     * @see com.smartgwt.client.data.OperationBinding#getDataFormat
     * @see com.smartgwt.client.data.OperationBinding#getDataTransport
     */
     ...
     * ({@link com.smartgwt.client.data.OperationBinding#getCustomSQL OperationBinding.customSQL}, {@link
     * com.smartgwt.client.data.OperationBinding#getCustomJQL OperationBinding.customJQL} and {@link
     * com.smartgwt.client.data.OperationBinding#getCustomHQL OperationBinding.customHQL}).
     ...
     * treated as a literal character.
     *
     * @return Current patternEscapeChar value. Default value is "\"
     */
     ...
     * Pass multiple strings to provide multiple alternative wildcards.
     *
     * @return Current patternMultiWildcard value. Default value is "*"
     */
     ...
     * strings to provide multiple alternative wildcards.
     *
     * @return Current patternSingleWildcard value. Default value is ["?","%"]
     */
     ...
     * Defaults to <code>dataSource.title</code> + "s".
     *
     * @return Current pluralTitle value. Default value is dataSource.ID
     */
     ...
     * performed by {@link com.smartgwt.client.data.ResultSet}.
     *
     * @return Current preventHTTPCaching value. Default value is true
     */
     ...
     * operationBindings.
     *
     * @return Current qualifyColumnNames value. Default value is true
     * @see com.smartgwt.client.docs.serverds.OperationBinding#qualifyColumnNames
     */
    ...
    /**
     * Provides a default value for {@link com.smartgwt.client.data.OperationBinding#getRecordName
    ...
    /**
     * Additional properties to pass through to the {@link com.smartgwt.client.data.DSRequest}s made by this DataSource.  This
     * must be set before any {@link com.smartgwt.client.data.DSRequest}s are issued and before any component is bound to the
     * DataSource. <p> These properties are applied before {@link com.smartgwt.client.data.DataSource#transformRequest
     ...
     * required} is not filled in by the user. <p> Note that {@link com.smartgwt.client.data.DataSourceField#getRequiredMessage
     ...
     * number lower.
     *
     * @return Current resultBatchSize value. Default value is 150
     */
     ...
     * integration with web services.
     *
     * @return Current resultSetClass value. Default value is null
     */
     ...
     * com.smartgwt.client.widgets.tree.ResultTree}. <P> This can be set to a custom subclass of ResultTree that, for example,
     * hangs on to extra information necessary for integration with web services.
     * <p><b>Note : </b> This is an advanced setting</p>
     *
     ...
     * hangs on to extra information necessary for integration with web services.
     *
     * @return Current resultTreeClass value. Default value is null
     */
     ...
     *
     * @return Current schemaNamespace value. Default value is null
     ...
     * com.smartgwt.client.data.DataSource#transformRequest transformRequest()} and ultimately sent to the server.
     *
     * @return Current sendExtraFields value. Default value is true
     * @see com.smartgwt.client.docs.ClientDataIntegration ClientDataIntegration overview and related methods
     */
     ...
     * Set this attribute if you need to send the dsRequest.parentNode to the server-side.
     *
     * @return Current sendParentNode value. Default value is false
     */
     ...
     * com.smartgwt.client.data.OperationBinding#getWsOperation OperationBinding.wsOperation} will cause a DataSource to invoke
     * web service operations to fulfill DataSource requests ({@link com.smartgwt.client.data.DSRequest DSRequests}). <P>
     * Setting <code>serviceNamespace</code> also defaults {@link com.smartgwt.client.data.DataSource#getDataURL dataURL} to
     * the service's location, {@link com.smartgwt.client.data.DataSource#getDataFormat dataFormat} to "xml" and {@link
     ...
     * this DataSource should be shown.  All other inherited parent fields will be marked "hidden:true".
     *
     * @return Current showLocalFieldsOnly value. Default value is null
     */
     ...
     * RPCRequest.showPrompt} in order to block user interactions until the request completes.   <p> DataSource requests
     * default to blocking UI interaction because, very often, if the user continues to interact with an application that is
     * waiting for a server response, some kind of invalid or ambiguous situation can arise. <p> Examples include pressing a
     * "Save" button a second time before the first save completes, making further edits while edits are still being saved, or
     * trying to initiate editing on a grid that hasn't loaded data. <p> Defaulting to blocking the UI prevents these bad
     * interactions, or alternatively, avoids the developer having to write repetitive code to block invalid interactions on
     * every screen. <p> If an operation should ever be non-blocking, methods that initiate DataSource requests (such as {@link
     * com.smartgwt.client.data.DataSource#fetchData fetchData()}) will generally have a <code>requestProperties</code>
     ...
     * argument allowing <code>showPrompt</code> to be set to false for a specific request.
     *
     * @return Current showPrompt value. Default value is true
     */
    ...
    /**
     * Sets what level of JSON validation will apply for this DataSource. <P> Note that the point of "partial" validation mode
     * is that if the JSON ihat's delivered is correct, we'll still need to validate to get "date" and such in the correct
     ...
     * time, but shouldn't need to for the rest.
     *
     * @return Current skipJSONValidation value. Default value is "none"
     */
    public SkipJSONValidation getSkipJSONValidation()  {
        return EnumUtil.getEnum(SkipJSONValidation.values(), getAttribute("skipJSONValidation"));
    }
     ...
     *  SQL DataSource; the other built-in types (Hibernate and JPA/JPA2) do not offer this mode.
     *
     * @return Current strictSQLFiltering value. Default value is false
     */
     ...
     * Tag name to use when serializing to XML.  If unspecified, the <code>dataSource.ID</code> will be used.
     *
     * @return Current tagName value. Default value is null
     * @see com.smartgwt.client.docs.ClientDataIntegration ClientDataIntegration overview and related methods
     */
     ...
     * "Team Member".
     *
     * @return Current title value. Default value is dataSource.ID
     */
     ...
     * contains) <p> Also supported: one startsWith, multiple contains, one endsWith.
     *
     * @return Current translatePatternOperators value. Default value is false
     */
     ...
     * from client to server or vice versa.  By default,  millisecond information is preserved (ie, it is not trimmed).  You
     * only need to consider trimming millisecond values if their presence causes a problem - for example, a custom server that
     * is not expecting that extra information and so fails parsing. <p> Note that there is no inherent support for millisecond
     ...
     * accuracy to the nearest second by default; you can switch on millisecond precision per-field with the  {@link
     ...
     * com.smartgwt.client.docs.serverds.DataSourceField#storeMilliseconds storeMilliseconds} attribute.
     *
     * @return Current trimMilliseconds value. Default value is null
     */
    ...
    /**
     * Like {@link com.smartgwt.client.widgets.DataBoundComponent#getUseFlatFields DataBoundComponent.useFlatFields}, but
    ...
    /**
     * Like {@link com.smartgwt.client.data.OperationBinding#getUseHttpProxy OperationBinding.useHttpProxy}, but serves as a
     ...
     * is enabled. <p> Disabling client-side validation entirely is a good way to test server-side validation.
     *
     * @return Current useLocalValidators value. Default value is null
     * @see com.smartgwt.client.docs.Validation Validation overview and related methods
     */
     ...
     * connect to the server).   Note that by default we do NOT use offline storage for a dataSource.
     *
     * @return Current useOfflineStorage value. Default value is null
     */
     ...
     * end.
     *
     * @return Current useParentFieldOrder value. Default value is null
     * @see <a href="http://www.smartclient.com/smartgwt/showcase/#featured_xsd_ds" target="examples">Schema Chaining Example</a>
     */
     ...
     * or unset and a dataURL or testFileName is specified on the DataSource.
     *
     * @return Current useTestDataFetch value. Default value is null
     */
     ...
     * com.smartgwt.client.data.DataSourceField#getForeignKey foreignKey} defined.
     *
     * @return Current validateRelatedRecords value. Default value is null
     */
     ...
     * not use repeated calls to <code>addData()</code> to provide the initial dataset for a {@link
     * com.smartgwt.client.data.DataSource#getClientOnly clientOnly} DataSource, instead, provide initial data via {@link
     * com.smartgwt.client.data.DataSource#getCacheData cacheData}.  Using <code>addData()</code> for subsequent, incremental
     * updates from sources like user editing is fine.
    ...
    public native DSRequest cloneDSRequest(DSRequest dsRequest) /*-{
        if (this.@com.smartgwt.client.core.BaseClass::isConfigOnly()()) {
            @com.smartgwt.client.util.ConfigUtil::warnOfPostConfigInstantiation(Ljava/lang/Class;Ljava/lang/String;Ljava/lang/String;)(this.@java.lang.Object::getClass()(), "cloneDSRequest", "DSRequest");
        }
        var self = this.@com.smartgwt.client.core.BaseClass::getOrCreateJsObj()();
    ...
    public native DSResponse cloneDSResponse(DSResponse dsResponse) /*-{
        if (this.@com.smartgwt.client.core.BaseClass::isConfigOnly()()) {
            @com.smartgwt.client.util.ConfigUtil::warnOfPostConfigInstantiation(Ljava/lang/Class;Ljava/lang/String;Ljava/lang/String;)(this.@java.lang.Object::getClass()(), "cloneDSResponse", "DSResponse");
        }
        var self = this.@com.smartgwt.client.core.BaseClass::getOrCreateJsObj()();
     ...
     * com.smartgwt.client.data.AdvancedCriteria} are made via recursively calling {@link
     * com.smartgwt.client.data.Operator#compareCriteria Operator.compareCriteria()} for all criteria involved. <P> For simple
     * {@link com.smartgwt.client.data.Criteria}, by default ({@link
     ...
     * compared using {@link com.smartgwt.client.util.DateUtil#compareDates DateUtil.compareDates()}; in the latter case, or if
     * the supplied fieldName is null or unknown to this DataSource, the dates are compared using {@link
    ...
    public native int compareDates(Date date1, Date date2, String fieldName) /*-{
        if (this.@com.smartgwt.client.core.BaseClass::isConfigOnly()()) {
            @com.smartgwt.client.util.ConfigUtil::warnOfPostConfigInstantiation(Ljava/lang/Class;Ljava/lang/String;Ljava/lang/String;)(this.@java.lang.Object::getClass()(), "compareDates", "Date,Date,String");
        }
        var self = this.@com.smartgwt.client.core.BaseClass::getOrCreateJsObj()();
     ...
     * differs from the class method {@link com.smartgwt.client.data.DataSource#convertCriteria convertCriteria()} in that it
     * makes use of the dataSource  as schema to help in the conversion.  For example, this method is able to honor  {@link
     * com.smartgwt.client.data.DataSourceField#getIgnoreTextMatchStyle DataSourceField.ignoreTextMatchStyle} and use the
     * dataSource's  {@link com.smartgwt.client.data.DataSource#getDefaultTextMatchStyle defaultTextMatchStyle} rather than
     * assuming "substring"
    ...
    public native AdvancedCriteria convertDataSourceCriteria(Criteria criteria) /*-{
        if (this.@com.smartgwt.client.core.BaseClass::isConfigOnly()()) {
            @com.smartgwt.client.util.ConfigUtil::warnOfPostConfigInstantiation(Ljava/lang/Class;Ljava/lang/String;Ljava/lang/String;)(this.@java.lang.Object::getClass()(), "convertDataSourceCriteria", "Criteria");
        }
        var self = this.@com.smartgwt.client.core.BaseClass::getOrCreateJsObj()();
    ...
    public native AdvancedCriteria convertDataSourceCriteria(Criteria criteria, TextMatchStyle textMatchStyle) /*-{
        if (this.@com.smartgwt.client.core.BaseClass::isConfigOnly()()) {
            @com.smartgwt.client.util.ConfigUtil::warnOfPostConfigInstantiation(Ljava/lang/Class;Ljava/lang/String;Ljava/lang/String;)(this.@java.lang.Object::getClass()(), "convertDataSourceCriteria", "Criteria,TextMatchStyle");
        }
        var self = this.@com.smartgwt.client.core.BaseClass::getOrCreateJsObj()();
	    if(@com.smartgwt.client.data.Criterion::instanceOf(Ljava/lang/Object;)(criteria)){
	    	@com.smartgwt.client.util.JSOHelper::setAttribute(Lcom/google/gwt/core/client/JavaScriptObject;Ljava/lang/String;Ljava/lang/String;)(criteria.@com.smartgwt.client.data.Criterion::getJsObj()(),"_constructor","AdvancedCriteria");
    ...
    public native Criteria convertRelativeDates(Criteria criteria) /*-{
        if (this.@com.smartgwt.client.core.BaseClass::isConfigOnly()()) {
            @com.smartgwt.client.util.ConfigUtil::warnOfPostConfigInstantiation(Ljava/lang/Class;Ljava/lang/String;Ljava/lang/String;)(this.@java.lang.Object::getClass()(), "convertRelativeDates", "Criteria");
        }
        var self = this.@com.smartgwt.client.core.BaseClass::getOrCreateJsObj()();
	    if(@com.smartgwt.client.data.Criterion::instanceOf(Ljava/lang/Object;)(criteria)){
	    	@com.smartgwt.client.util.JSOHelper::setAttribute(Lcom/google/gwt/core/client/JavaScriptObject;Ljava/lang/String;Ljava/lang/String;)(criteria.@com.smartgwt.client.data.Criterion::getJsObj()(),"_constructor","AdvancedCriteria");
     ...
     * com.smartgwt.client.widgets.DateChooser#getFirstDayOfWeek DateChooser.firstDayOfWeek}
    ...
    public native Criteria convertRelativeDates(Criteria criteria, String timezoneOffset, Integer firstDayOfWeek, Date baseDate) /*-{
        if (this.@com.smartgwt.client.core.BaseClass::isConfigOnly()()) {
            @com.smartgwt.client.util.ConfigUtil::warnOfPostConfigInstantiation(Ljava/lang/Class;Ljava/lang/String;Ljava/lang/String;)(this.@java.lang.Object::getClass()(), "convertRelativeDates", "Criteria,String,Integer,Date");
        }
        var self = this.@com.smartgwt.client.core.BaseClass::getOrCreateJsObj()();
	    if(@com.smartgwt.client.data.Criterion::instanceOf(Ljava/lang/Object;)(criteria)){
	    	@com.smartgwt.client.util.JSOHelper::setAttribute(Lcom/google/gwt/core/client/JavaScriptObject;Ljava/lang/String;Ljava/lang/String;)(criteria.@com.smartgwt.client.data.Criterion::getJsObj()(),"_constructor","AdvancedCriteria");
     ...
     * {@link com.smartgwt.client.data.DataSource#copyRecord copyRecord()} for each item in the array.
    ...
    public native Record[] copyRecords(Record... records) /*-{
        if (this.@com.smartgwt.client.core.BaseClass::isConfigOnly()()) {
            @com.smartgwt.client.util.ConfigUtil::warnOfPostConfigInstantiation(Ljava/lang/Class;Ljava/lang/String;Ljava/lang/String;)(this.@java.lang.Object::getClass()(), "copyRecords", "Record...");
        }
        var self = this.@com.smartgwt.client.core.BaseClass::getOrCreateJsObj()();
    ...
    public native void downloadFile(Record data) /*-{
        if (this.@com.smartgwt.client.core.BaseClass::isConfigOnly()()) {
            @com.smartgwt.client.util.ConfigUtil::warnOfPostConfigInstantiation(Ljava/lang/Class;Ljava/lang/String;Ljava/lang/String;)(this.@java.lang.Object::getClass()(), "downloadFile", "Record");
        }
        var self = this.@com.smartgwt.client.core.BaseClass::getOrCreateJsObj()();
     ...
     * download a file. <P> See the overview of {@link com.smartgwt.client.docs.BinaryFields Binary Fields} for more details.
     * @param data Record to download.  Only required to have a value for the                        primary key field.
     * @param fieldName Optional name of the binary field containing the file.                                   If not provided, the first
    ...
    public native void downloadFile(Record data, String fieldName, DSRequest requestProperties) /*-{
        if (this.@com.smartgwt.client.core.BaseClass::isConfigOnly()()) {
            @com.smartgwt.client.util.ConfigUtil::warnOfPostConfigInstantiation(Ljava/lang/Class;Ljava/lang/String;Ljava/lang/String;)(this.@java.lang.Object::getClass()(), "downloadFile", "Record,String,DSRequest");
        }
        var self = this.@com.smartgwt.client.core.BaseClass::getOrCreateJsObj()();
        if(!self.viewFile) { @com.smartgwt.client.util.SC::requiresServerComponents()(); }
	...
	/**
     * Evaluate the given criterion with respect to the passed record. <P> Typically called by the {@link
     * com.smartgwt.client.data.Operator#condition condition} function of a custom {@link com.smartgwt.client.data.Operator} to
     * evaluate {@link com.smartgwt.client.data.Criterion#getCriteria sub-criteria}.
    ...
    public native boolean evaluateCriterion(Record record, Criterion criterion) /*-{
        if (this.@com.smartgwt.client.core.BaseClass::isConfigOnly()()) {
            @com.smartgwt.client.util.ConfigUtil::warnOfPostConfigInstantiation(Ljava/lang/Class;Ljava/lang/String;Ljava/lang/String;)(this.@java.lang.Object::getClass()(), "evaluateCriterion", "Record,Criterion");
        }
        var self = this.@com.smartgwt.client.core.BaseClass::getOrCreateJsObj()();
     ...
     * com.smartgwt.client.data.DataSource#transformRequest transformRequest()} override and calling execute() on the DSRequest
     * at a later time.
     * @param dsRequest the DSRequest to execute.
     */
    public native void execute(DSRequest dsRequest) /*-{
        if (this.@com.smartgwt.client.core.BaseClass::isConfigOnly()()) {
            @com.smartgwt.client.util.ConfigUtil::warnOfPostConfigInstantiation(Ljava/lang/Class;Ljava/lang/String;Ljava/lang/String;)(this.@java.lang.Object::getClass()(), "execute", "DSRequest");
        }
        var self = this.@com.smartgwt.client.core.BaseClass::getOrCreateJsObj()();
     ...
     * exporting the results.  See  {@link com.smartgwt.client.data.OperationBinding#getExportResults
     * OperationBinding.exportResults} or {@link com.smartgwt.client.data.DSRequest#getExportResults DSRequest.exportResults}
     * and for more information.
     * @see com.smartgwt.client.docs.Operations Operations overview and related methods
     */
    public native void exportData() /*-{
        if (this.@com.smartgwt.client.core.BaseClass::isConfigOnly()()) {
            @com.smartgwt.client.util.ConfigUtil::warnOfPostConfigInstantiation(Ljava/lang/Class;Ljava/lang/String;Ljava/lang/String;)(this.@java.lang.Object::getClass()(), "exportData", "");
        }
        var self = this.@com.smartgwt.client.core.BaseClass::getOrCreateJsObj()();
        self.exportData();
    }-*/;
     ...
     * com.smartgwt.client.data.DSRequest#getExportToClient DSRequest.exportToClient} is                                  
    ...
    public native void exportData(Criteria criteria, DSRequest requestProperties, DSCallback callback) /*-{
        if (this.@com.smartgwt.client.core.BaseClass::isConfigOnly()()) {
            @com.smartgwt.client.util.ConfigUtil::warnOfPostConfigInstantiation(Ljava/lang/Class;Ljava/lang/String;Ljava/lang/String;)(this.@java.lang.Object::getClass()(), "exportData", "Criteria,DSRequest,DSCallback");
        }
        var self = this.@com.smartgwt.client.core.BaseClass::getOrCreateJsObj()();
	    if(@com.smartgwt.client.data.Criterion::instanceOf(Ljava/lang/Object;)(criteria)){
	    	@com.smartgwt.client.util.JSOHelper::setAttribute(Lcom/google/gwt/core/client/JavaScriptObject;Ljava/lang/String;Ljava/lang/String;)(criteria.@com.smartgwt.client.data.Criterion::getJsObj()(),"_constructor","AdvancedCriteria");
     ...
     *  <P>
     * See also {@link com.smartgwt.client.data.DataSource#getClientOnlyDataSource getClientOnlyDataSource()} and {@link
     * com.smartgwt.client.data.DataSource#getCacheAllData cacheAllData} for
     ...
     * This simply calls {@link com.smartgwt.client.data.DataSource#fetchData fetchData()} after creating {@link
    ...
    public native void fetchRecord(Object pkValue) /*-{
        if (this.@com.smartgwt.client.core.BaseClass::isConfigOnly()()) {
            @com.smartgwt.client.util.ConfigUtil::warnOfPostConfigInstantiation(Ljava/lang/Class;Ljava/lang/String;Ljava/lang/String;)(this.@java.lang.Object::getClass()(), "fetchRecord", "Object");
        }
        var self = this.@com.smartgwt.client.core.BaseClass::getOrCreateJsObj()();
    ...
    public native void fetchRecord(Object pkValue, DSCallback callback, DSRequest requestProperties) /*-{
        if (this.@com.smartgwt.client.core.BaseClass::isConfigOnly()()) {
            @com.smartgwt.client.util.ConfigUtil::warnOfPostConfigInstantiation(Ljava/lang/Class;Ljava/lang/String;Ljava/lang/String;)(this.@java.lang.Object::getClass()(), "fetchRecord", "Object,DSCallback,DSRequest");
        }
        var self = this.@com.smartgwt.client.core.BaseClass::getOrCreateJsObj()();
        self.fetchRecord(pkValue, 
			$entry( function(dsResponse, data, dsRequest) { 
     ...
     * com.smartgwt.client.data.DSRequest#getTextMatchStyle DSRequest.textMatchStyle} in the passed
     * <code>requestProperties</code>,      regardless of the actual field type <li> if the filter value is an Array, the
     * comparison is a logical OR.  If textMatchStyle      is "exact", it matches if fieldValue (or any of it's entries, if
     * it's also an array)       is contained in the filterValue Array.  If textMatchStyle if substring, it matches       if
     * any of the entries in filterValue appear as a case-insensitive substring of any      of the entries in fieldValue.
     * <li>Dates are compared as logical dates if either the field value or the filter value is a logical date.     Only if
     * none of them is a logical date they will be compared as standard Dates </ul>
    ...
    public native boolean fieldMatchesFilter(Object fieldValue, Object filterValue) /*-{
        if (this.@com.smartgwt.client.core.BaseClass::isConfigOnly()()) {
            @com.smartgwt.client.util.ConfigUtil::warnOfPostConfigInstantiation(Ljava/lang/Class;Ljava/lang/String;Ljava/lang/String;)(this.@java.lang.Object::getClass()(), "fieldMatchesFilter", "Object,Object");
        }
        var self = this.@com.smartgwt.client.core.BaseClass::getOrCreateJsObj()();
    ...
    public native boolean fieldMatchesFilter(Object fieldValue, Object filterValue, DSRequest requestProperties) /*-{
        if (this.@com.smartgwt.client.core.BaseClass::isConfigOnly()()) {
            @com.smartgwt.client.util.ConfigUtil::warnOfPostConfigInstantiation(Ljava/lang/Class;Ljava/lang/String;Ljava/lang/String;)(this.@java.lang.Object::getClass()(), "fieldMatchesFilter", "Object,Object,DSRequest");
        }
        var self = this.@com.smartgwt.client.core.BaseClass::getOrCreateJsObj()();
     ...
     * <P> This is identical to {@link com.smartgwt.client.data.DataSource#fetchData fetchData()} except that {@link
     * com.smartgwt.client.data.DSRequest#getTextMatchStyle DSRequest.textMatchStyle} is set to "substring" to cause case
     ...
     * com.smartgwt.client.widgets.grid.ListGrid#getAutoSaveEdits ListGrid.autoSaveEdits} for more fine-grained tracking of 
     * edits (eg, special styling for uncommitted changes). <P> The new DataSource is returned via the "callback" argument.  If
     * {@link com.smartgwt.client.data.DataSource#getCacheAllData cacheAllData} is enabled and {@link
     * com.smartgwt.client.data.DataSource#hasAllData hasAllData()} returns true, the new DataSource is synchronously returned
    ...
    public native void getClientOnlyDataSource(Criteria criteria, ClientOnlyDataSourceCallback callback) /*-{
        if (this.@com.smartgwt.client.core.BaseClass::isConfigOnly()()) {
            @com.smartgwt.client.util.ConfigUtil::warnOfPostConfigInstantiation(Ljava/lang/Class;Ljava/lang/String;Ljava/lang/String;)(this.@java.lang.Object::getClass()(), "getClientOnlyDataSource", "Criteria,ClientOnlyDataSourceCallback");
        }
        var self = this.@com.smartgwt.client.core.BaseClass::getOrCreateJsObj()();
	    if(@com.smartgwt.client.data.Criterion::instanceOf(Ljava/lang/Object;)(criteria)){
	    	@com.smartgwt.client.util.JSOHelper::setAttribute(Lcom/google/gwt/core/client/JavaScriptObject;Ljava/lang/String;Ljava/lang/String;)(criteria.@com.smartgwt.client.data.Criterion::getJsObj()(),"_constructor","AdvancedCriteria");
    ...
    public native void getClientOnlyDataSource(Criteria criteria, ClientOnlyDataSourceCallback callback, DSRequest requestProperties, DataSource dataSourceProperties) /*-{
        if (this.@com.smartgwt.client.core.BaseClass::isConfigOnly()()) {
            @com.smartgwt.client.util.ConfigUtil::warnOfPostConfigInstantiation(Ljava/lang/Class;Ljava/lang/String;Ljava/lang/String;)(this.@java.lang.Object::getClass()(), "getClientOnlyDataSource", "Criteria,ClientOnlyDataSourceCallback,DSRequest,DataSource");
        }
        var self = this.@com.smartgwt.client.core.BaseClass::getOrCreateJsObj()();
	    if(@com.smartgwt.client.data.Criterion::instanceOf(Ljava/lang/Object;)(criteria)){
	    	@com.smartgwt.client.util.JSOHelper::setAttribute(Lcom/google/gwt/core/client/JavaScriptObject;Ljava/lang/String;Ljava/lang/String;)(criteria.@com.smartgwt.client.data.Criterion::getJsObj()(),"_constructor","AdvancedCriteria");
    ...
    protected native DSResponse getClientOnlyResponse(DSRequest request, Record... serverData) /*-{
        if (this.@com.smartgwt.client.core.BaseClass::isConfigOnly()()) {
            @com.smartgwt.client.util.ConfigUtil::warnOfPostConfigInstantiation(Ljava/lang/Class;Ljava/lang/String;Ljava/lang/String;)(this.@java.lang.Object::getClass()(), "getClientOnlyResponse", "DSRequest,Record...");
        }
        var self = this.@com.smartgwt.client.core.BaseClass::getOrCreateJsObj()();
	...
	/**
     * Given a fieldName and a dataValue, apply any {@link com.smartgwt.client.data.DataSourceField#getValueMap
    ...
    public native Object getDisplayValue(String fieldName, Object value) /*-{
        if (this.@com.smartgwt.client.core.BaseClass::isConfigOnly()()) {
            @com.smartgwt.client.util.ConfigUtil::warnOfPostConfigInstantiation(Ljava/lang/Class;Ljava/lang/String;Ljava/lang/String;)(this.@java.lang.Object::getClass()(), "getDisplayValue", "String,Object");
        }
        var self = this.@com.smartgwt.client.core.BaseClass::getOrCreateJsObj()();
    ...
    public native String getFetchDataURL(Criteria criteria) /*-{
        if (this.@com.smartgwt.client.core.BaseClass::isConfigOnly()()) {
            @com.smartgwt.client.util.ConfigUtil::warnOfPostConfigInstantiation(Ljava/lang/Class;Ljava/lang/String;Ljava/lang/String;)(this.@java.lang.Object::getClass()(), "getFetchDataURL", "Criteria");
        }
        var self = this.@com.smartgwt.client.core.BaseClass::getOrCreateJsObj()();
	    if(@com.smartgwt.client.data.Criterion::instanceOf(Ljava/lang/Object;)(criteria)){
	    	@com.smartgwt.client.util.JSOHelper::setAttribute(Lcom/google/gwt/core/client/JavaScriptObject;Ljava/lang/String;Ljava/lang/String;)(criteria.@com.smartgwt.client.data.Criterion::getJsObj()(),"_constructor","AdvancedCriteria");
    ...
    public native String getFetchDataURL(Criteria criteria, DSRequest requestProperties) /*-{
        if (this.@com.smartgwt.client.core.BaseClass::isConfigOnly()()) {
            @com.smartgwt.client.util.ConfigUtil::warnOfPostConfigInstantiation(Ljava/lang/Class;Ljava/lang/String;Ljava/lang/String;)(this.@java.lang.Object::getClass()(), "getFetchDataURL", "Criteria,DSRequest");
        }
        var self = this.@com.smartgwt.client.core.BaseClass::getOrCreateJsObj()();
	    if(@com.smartgwt.client.data.Criterion::instanceOf(Ljava/lang/Object;)(criteria)){
	    	@com.smartgwt.client.util.JSOHelper::setAttribute(Lcom/google/gwt/core/client/JavaScriptObject;Ljava/lang/String;Ljava/lang/String;)(criteria.@com.smartgwt.client.data.Criterion::getJsObj()(),"_constructor","AdvancedCriteria");
    ...
    public native Criteria getFieldCriterion(Criteria criterion, String fieldName) /*-{
        if (this.@com.smartgwt.client.core.BaseClass::isConfigOnly()()) {
            @com.smartgwt.client.util.ConfigUtil::warnOfPostConfigInstantiation(Ljava/lang/Class;Ljava/lang/String;Ljava/lang/String;)(this.@java.lang.Object::getClass()(), "getFieldCriterion", "Criteria,String");
        }
        var self = this.@com.smartgwt.client.core.BaseClass::getOrCreateJsObj()();
    ...
    public native DataSourceField getFieldForDataPath(String dataPath) /*-{
        if (this.@com.smartgwt.client.core.BaseClass::isConfigOnly()()) {
            @com.smartgwt.client.util.ConfigUtil::warnOfPostConfigInstantiation(Ljava/lang/Class;Ljava/lang/String;Ljava/lang/String;)(this.@java.lang.Object::getClass()(), "getFieldForDataPath", "String");
        }
        var self = this.@com.smartgwt.client.core.BaseClass::getOrCreateJsObj()();
    ...
    public native String[] getFieldNames(boolean excludeHidden) /*-{
        if (this.@com.smartgwt.client.core.BaseClass::isConfigOnly()()) {
            @com.smartgwt.client.util.ConfigUtil::warnOfPostConfigInstantiation(Ljava/lang/Class;Ljava/lang/String;Ljava/lang/String;)(this.@java.lang.Object::getClass()(), "getFieldNames", "boolean");
        }
        var self = this.@com.smartgwt.client.core.BaseClass::getOrCreateJsObj()();
        var ret = self.getFieldNames(excludeHidden);
        if(ret == null) return null;
    ...
    public native void getFile(FileSpec fileSpec, GetFileCallback callback) /*-{
        if (this.@com.smartgwt.client.core.BaseClass::isConfigOnly()()) {
            @com.smartgwt.client.util.ConfigUtil::warnOfPostConfigInstantiation(Ljava/lang/Class;Ljava/lang/String;Ljava/lang/String;)(this.@java.lang.Object::getClass()(), "getFile", "FileSpec,GetFileCallback");
        }
        var self = this.@com.smartgwt.client.core.BaseClass::getOrCreateJsObj()();
     ...
     * com.smartgwt.client.data.DataSource#downloadFile downloadFile()} and {@link com.smartgwt.client.data.DataSource#viewFile
     * viewFile()}. <P> The URL returned is not to a static file on disk, rather, the returned URL essentially encodes a
     * DSRequest as URL parameters, in a format understood by the IDACall servlet that comes with the Server Framework.   <P>
     * Hence, this URL will dynamically retrieve whatever file is currently stored in the binary field via executing a normal
     * DSRequest server side.  The request will run through normal security checks, so if your application requires
     * authentication, the user must have a valid session and be authorized to access the binary field. <P> Note that if this
     * method is called for a record with no associated file, the returned URL may not be functional.  By default when
     * dataSources encounter a  {@link com.smartgwt.client.types.FieldType binary type fields}, an additional field,
     ...
     * @param data Record containing at least the primary key field.
     *
     * @return a URL to directly access the stored file
     */
    public native String getFileURL(Record data) /*-{
        if (this.@com.smartgwt.client.core.BaseClass::isConfigOnly()()) {
            @com.smartgwt.client.util.ConfigUtil::warnOfPostConfigInstantiation(Ljava/lang/Class;Ljava/lang/String;Ljava/lang/String;)(this.@java.lang.Object::getClass()(), "getFileURL", "Record");
        }
        var self = this.@com.smartgwt.client.core.BaseClass::getOrCreateJsObj()();
    ...
    public native String getFileURL(Record data, String fieldName, DSRequest requestProperties) /*-{
        if (this.@com.smartgwt.client.core.BaseClass::isConfigOnly()()) {
            @com.smartgwt.client.util.ConfigUtil::warnOfPostConfigInstantiation(Ljava/lang/Class;Ljava/lang/String;Ljava/lang/String;)(this.@java.lang.Object::getClass()(), "getFileURL", "Record,String,DSRequest");
        }
        var self = this.@com.smartgwt.client.core.BaseClass::getOrCreateJsObj()();
     ...
     * "xml"}.                 If fileType and fileFormat are not provided, will return                 the first file with the
     * specified fileName.
     * @param version A version timestamp.  This must exactly match the version                  timestamp recorded in the DataSource.  You
     * can obtain the list of                  versions for a given file with the {@link
     * com.smartgwt.client.data.DataSource#listFileVersions listFileVersions()} API.
     * @param callback Callback executed with the results. The                  <code>data</code> parameter is either a String with the        
     * contents of the file, or null to indicate error (such as                 file not found).                  You can
     * examine <code>{@link com.smartgwt.client.data.DSResponse#getStatus dsResponse.status}</code>                 and
     * <code>{@link com.smartgwt.client.data.DSResponse#getData dsResponse.data}</code>                 for additional
     ...
     * @see com.smartgwt.client.docs.FileSource FileSource overview and related methods
     */
    public native void getFileVersion(FileSpec fileSpec, Date version, GetFileVersionCallback callback) /*-{
        if (this.@com.smartgwt.client.core.BaseClass::isConfigOnly()()) {
            @com.smartgwt.client.util.ConfigUtil::warnOfPostConfigInstantiation(Ljava/lang/Class;Ljava/lang/String;Ljava/lang/String;)(this.@java.lang.Object::getClass()(), "getFileVersion", "FileSpec,Date,GetFileVersionCallback");
        }
        var self = this.@com.smartgwt.client.core.BaseClass::getOrCreateJsObj()();
        self.getFileVersion(fileSpec.@com.smartgwt.client.core.DataClass::getJsObj()(), @com.smartgwt.client.util.JSOHelper::convertToJavaScriptDate(Ljava/util/Date;)(version), 
			$entry( function(dsResponse, data, dsRequest) { 
				if(callback!=null) callback.@com.smartgwt.client.callbacks.GetFileVersionCallback::execute(Lcom/smartgwt/client/data/DSResponse;Ljava/lang/String;Lcom/smartgwt/client/data/DSRequest;)(
					@com.smartgwt.client.data.DSResponse::new(Lcom/google/gwt/core/client/JavaScriptObject;)(dsResponse), 
					data, 
					@com.smartgwt.client.data.DSRequest::new(Lcom/google/gwt/core/client/JavaScriptObject;)(dsRequest)
				);
    ...
    public native void getLegalChildTags() /*-{
        if (this.@com.smartgwt.client.core.BaseClass::isConfigOnly()()) {
            @com.smartgwt.client.util.ConfigUtil::warnOfPostConfigInstantiation(Ljava/lang/Class;Ljava/lang/String;Ljava/lang/String;)(this.@java.lang.Object::getClass()(), "getLegalChildTags", "");
        }
        var self = this.@com.smartgwt.client.core.BaseClass::getOrCreateJsObj()();
    ...
    public native DataSourceField getPrimaryKeyField() /*-{
        if (this.@com.smartgwt.client.core.BaseClass::isConfigOnly()()) {
            @com.smartgwt.client.util.ConfigUtil::warnOfPostConfigInstantiation(Ljava/lang/Class;Ljava/lang/String;Ljava/lang/String;)(this.@java.lang.Object::getClass()(), "getPrimaryKeyField", "");
        }
        var self = this.@com.smartgwt.client.core.BaseClass::getOrCreateJsObj()();
    ...
    public native String getPrimaryKeyFieldName() /*-{
        if (this.@com.smartgwt.client.core.BaseClass::isConfigOnly()()) {
            @com.smartgwt.client.util.ConfigUtil::warnOfPostConfigInstantiation(Ljava/lang/Class;Ljava/lang/String;Ljava/lang/String;)(this.@java.lang.Object::getClass()(), "getPrimaryKeyFieldName", "");
        }
        var self = this.@com.smartgwt.client.core.BaseClass::getOrCreateJsObj()();
    ...
    public native String[] getPrimaryKeyFieldNames() /*-{
        if (this.@com.smartgwt.client.core.BaseClass::isConfigOnly()()) {
            @com.smartgwt.client.util.ConfigUtil::warnOfPostConfigInstantiation(Ljava/lang/Class;Ljava/lang/String;Ljava/lang/String;)(this.@java.lang.Object::getClass()(), "getPrimaryKeyFieldNames", "");
        }
        var self = this.@com.smartgwt.client.core.BaseClass::getOrCreateJsObj()();
    ...
    public native Record getPrimaryKeyFields() /*-{
        if (this.@com.smartgwt.client.core.BaseClass::isConfigOnly()()) {
            @com.smartgwt.client.util.ConfigUtil::warnOfPostConfigInstantiation(Ljava/lang/Class;Ljava/lang/String;Ljava/lang/String;)(this.@java.lang.Object::getClass()(), "getPrimaryKeyFields", "");
        }
        var self = this.@com.smartgwt.client.core.BaseClass::getOrCreateJsObj()();
     ...
     * valid operators for the {@link com.smartgwt.client.types.FieldType} as specified by  {@link
     * com.smartgwt.client.data.SimpleType#getValidOperators SimpleType.validOperators}, otherwise, the system-wide set of
     * valid operators for the type as registered via {@link com.smartgwt.client.data.DataSource#addSearchOperator
     * addSearchOperator()}.
     *
    ...
    public native OperatorId[] getTypeOperators() /*-{
        if (this.@com.smartgwt.client.core.BaseClass::isConfigOnly()()) {
            @com.smartgwt.client.util.ConfigUtil::warnOfPostConfigInstantiation(Ljava/lang/Class;Ljava/lang/String;Ljava/lang/String;)(this.@java.lang.Object::getClass()(), "getTypeOperators", "");
        }
        var self = this.@com.smartgwt.client.core.BaseClass::getOrCreateJsObj()();
    ...
    public native OperatorId[] getTypeOperators(FieldType typeName) /*-{
        if (this.@com.smartgwt.client.core.BaseClass::isConfigOnly()()) {
            @com.smartgwt.client.util.ConfigUtil::warnOfPostConfigInstantiation(Ljava/lang/Class;Ljava/lang/String;Ljava/lang/String;)(this.@java.lang.Object::getClass()(), "getTypeOperators", "FieldType");
        }
        var self = this.@com.smartgwt.client.core.BaseClass::getOrCreateJsObj()();
    ...
    public native OperatorId[] getTypeOperators(String typeName) /*-{
        if (this.@com.smartgwt.client.core.BaseClass::isConfigOnly()()) {
            @com.smartgwt.client.util.ConfigUtil::warnOfPostConfigInstantiation(Ljava/lang/Class;Ljava/lang/String;Ljava/lang/String;)(this.@java.lang.Object::getClass()(), "getTypeOperators", "String");
        }
        var self = this.@com.smartgwt.client.core.BaseClass::getOrCreateJsObj()();
    ...
    private native void setupHandleErrorEvent() /*-{
        ...
        var handleError = $debox($entry(function(param){
                ...
                selfJ.@com.smartgwt.client.data.DataSource::handleTearDownHandleErrorEvent()();
        ...
        if(this.@com.smartgwt.client.core.BaseClass::isCreated()()) {
            ...
            obj.addProperties({handleError: 
                function () {
                    var param = {"_this": this, "response" : arguments[0], "request" : arguments[1]};
    ...
    private void handleTearDownHandleErrorEvent() {
        if (getHandlerCount(com.smartgwt.client.data.events.ErrorEvent.getType()) == 0) tearDownHandleErrorEvent();
    }
    ...
    private native void tearDownHandleErrorEvent() /*-{
        ...
        if (obj && obj.hasOwnProperty("handleError")) delete obj.handleError;
    }-*/;
    ...
    public native Boolean hasAllData() /*-{
        if (this.@com.smartgwt.client.core.BaseClass::isConfigOnly()()) {
            @com.smartgwt.client.util.ConfigUtil::warnOfPostConfigInstantiation(Ljava/lang/Class;Ljava/lang/String;Ljava/lang/String;)(this.@java.lang.Object::getClass()(), "hasAllData", "");
        }
        var self = this.@com.smartgwt.client.core.BaseClass::getOrCreateJsObj()();
    ...
    public native void hasFile(FileSpec fileSpec, HasFileCallback callback) /*-{
        if (this.@com.smartgwt.client.core.BaseClass::isConfigOnly()()) {
            @com.smartgwt.client.util.ConfigUtil::warnOfPostConfigInstantiation(Ljava/lang/Class;Ljava/lang/String;Ljava/lang/String;)(this.@java.lang.Object::getClass()(), "hasFile", "FileSpec,HasFileCallback");
        }
        var self = this.@com.smartgwt.client.core.BaseClass::getOrCreateJsObj()();
     ...
     * "xml"}.                 If fileType or fileFormat are not provided, will indicate whether                 any file with
     * the provided fileName exists.
     * @param version A version timestamp.  This must exactly match the version                  timestamp recorded in the DataSource for
     * <code>hasFileVersion</code> to                 return true.  Note, you can obtain the list of versions for a given      
     *            file with the {@link com.smartgwt.client.data.DataSource#listFileVersions listFileVersions()} API.
     * @param callback Callback                  executed with the results.  The <code>data</code> parameter is a boolean                
     * indicating whether the file version is present.                 You can examine <code>{@link
     ...
     * @see com.smartgwt.client.docs.FileSource FileSource overview and related methods
     */
    public native void hasFileVersion(FileSpec fileSpec, Date version, HasFileCallback callback) /*-{
        if (this.@com.smartgwt.client.core.BaseClass::isConfigOnly()()) {
            @com.smartgwt.client.util.ConfigUtil::warnOfPostConfigInstantiation(Ljava/lang/Class;Ljava/lang/String;Ljava/lang/String;)(this.@java.lang.Object::getClass()(), "hasFileVersion", "FileSpec,Date,HasFileCallback");
        }
        var self = this.@com.smartgwt.client.core.BaseClass::getOrCreateJsObj()();
        self.hasFileVersion(fileSpec.@com.smartgwt.client.core.DataClass::getJsObj()(), @com.smartgwt.client.util.JSOHelper::convertToJavaScriptDate(Ljava/util/Date;)(version), 
			$entry( function(dsResponse, data, dsRequest) { 
				if(callback!=null) callback.@com.smartgwt.client.callbacks.HasFileCallback::execute(Lcom/smartgwt/client/data/DSResponse;ZLcom/smartgwt/client/data/DSRequest;)(
					@com.smartgwt.client.data.DSResponse::new(Lcom/google/gwt/core/client/JavaScriptObject;)(dsResponse), 
					data == null ? false : data, 
     ...
     * com.smartgwt.client.docs.serverds.DataSource#fileTypeField fileType}</code>,                 <code>{@link
     * com.smartgwt.client.docs.serverds.DataSource#fileFormatField fileFormat}</code>,                 <code>{@link
     * com.smartgwt.client.docs.serverds.DataSource#fileLastModifiedField fileLastModified}</code>, and                 
     * <code>{@link com.smartgwt.client.docs.serverds.DataSource#fileVersionField fileVersion}</code> fields populated, but    
     * not the <code>{@link com.smartgwt.client.docs.serverds.DataSource#fileContentsField fileContents}</code> field. (You    
     * can use {@link com.smartgwt.client.data.DataSource#getFile getFile()} to get the <code>fileContents</code>).            
    ...
    public native void listFiles(Criteria criteria, DSCallback callback) /*-{
        if (this.@com.smartgwt.client.core.BaseClass::isConfigOnly()()) {
            @com.smartgwt.client.util.ConfigUtil::warnOfPostConfigInstantiation(Ljava/lang/Class;Ljava/lang/String;Ljava/lang/String;)(this.@java.lang.Object::getClass()(), "listFiles", "Criteria,DSCallback");
        }
        var self = this.@com.smartgwt.client.core.BaseClass::getOrCreateJsObj()();
	    if(@com.smartgwt.client.data.Criterion::instanceOf(Ljava/lang/Object;)(criteria)){
	    	@com.smartgwt.client.util.JSOHelper::setAttribute(Lcom/google/gwt/core/client/JavaScriptObject;Ljava/lang/String;Ljava/lang/String;)(criteria.@com.smartgwt.client.data.Criterion::getJsObj()(),"_constructor","AdvancedCriteria");
	...
	/**
     * Get the list of a given file's versions from the dataSource, sorted in version order  (most recent version first).  If
     * the dataSource does not specify a  {@link com.smartgwt.client.docs.serverds.DataSource#fileVersionField
     * fileVersionField}, this API will return an error
     * @param fileSpec Either a FileSpec, or a String which                 will be parsed to determine the fileName, fileType and fileFormat. 
     * For instance, "employees.ds.xml" would be parsed as                 {fileName: "employees", fileType: "ds", fileFormat:
     * "xml"}.                 If fileType and fileFormat are not provided, will return                 the first file with the
     * specified fileName.
     ...
     * <code>{@link com.smartgwt.client.docs.serverds.DataSource#fileVersionField fileVersion}</code> fields populated, but    
     * not the <code>{@link com.smartgwt.client.docs.serverds.DataSource#fileContentsField fileContents}</code> field. (You    
     * can use {@link com.smartgwt.client.data.DataSource#getFileVersion getFileVersion()} to get the                 
     * <code>fileContents</code>).                 You can examine <code>{@link com.smartgwt.client.data.DSResponse#getStatus
     * dsResponse.status}</code>                 and <code>{@link com.smartgwt.client.data.DSResponse#getData
     * dsResponse.data}</code>                 for additional information about any error.
     * @see com.smartgwt.client.docs.FileSource FileSource overview and related methods
     */
    public native void listFileVersions(FileSpec fileSpec, DSCallback callback) /*-{
        if (this.@com.smartgwt.client.core.BaseClass::isConfigOnly()()) {
            @com.smartgwt.client.util.ConfigUtil::warnOfPostConfigInstantiation(Ljava/lang/Class;Ljava/lang/String;Ljava/lang/String;)(this.@java.lang.Object::getClass()(), "listFileVersions", "FileSpec,DSCallback");
        }
        var self = this.@com.smartgwt.client.core.BaseClass::getOrCreateJsObj()();
        self.listFileVersions(fileSpec.@com.smartgwt.client.core.DataClass::getJsObj()(), 
			$entry( function(dsResponse, data, dsRequest) { 
				if(callback!=null) callback.@com.smartgwt.client.data.DSCallback::execute(Lcom/smartgwt/client/data/DSResponse;Ljava/lang/Object;Lcom/smartgwt/client/data/DSRequest;)(
					@com.smartgwt.client.data.DSResponse::new(Lcom/google/gwt/core/client/JavaScriptObject;)(dsResponse), 
					data, 
	...
	/**
     * Invoke an operation declared with {@link com.smartgwt.client.data.OperationBinding#getOperationType
     * OperationBinding.operationType} "custom". <P> <b>This is a rarely used API.</b>  If the operation you are performing can
     * be thought of as one of the standard "CRUD" {@link com.smartgwt.client.types.DSOperationType operation types}, declare
     * it with a CRUD operationType.  For example, if your operation updates a record, declare it with operationType "update"
     * and invoke it via {@link com.smartgwt.client.data.DataSource#updateData updateData()} - this will cause {@link
     ...
     * implement variants of core CRUD operations ({@link com.smartgwt.client.data.DSRequest#getOperationId
     * DSRequest.operationId} is the correct way to do this) <li> do not use this API just because an operation affects more
     * than one record.  Most kinds of multi-record operations should use {@link com.smartgwt.client.rpc.RPCManager#startQueue
     * queuing}.   However, a custom operation <em>is</em> appropriate for genuine "batch" updates, as  opposed to just a
     * number of ordinary updates by primaryKey - see  {@link
     * com.smartgwt.client.docs.serverds.OperationBinding#allowMultiUpdate OperationBinding.allowMultiUpdate} <li> do not use
     * this API just because you are calling a stored procedure in SQL - if the stored procedure performs some kind of CRUD
     ...
     * {@link com.smartgwt.client.data.DSRequest#getData dsRequest.data}.  With the Smart GWT Server Framework, the data is
     * accessible server-side via DSRequest.getValues() and in {@link com.smartgwt.client.docs.VelocitySupport Velocity
     * templates} (such as &lt;customSQL&gt;) as $values. <P> Note that with SQLDataSource, <code>performCustomOperation</code>
     * must be used if you plan to have a &lt;customSQL&gt; tag in your operationBinding that will execute SQL operations other
     * than SELECT, UPDATE, INSERT, DELETE (such as creating a new table). By declaring {@link
     * com.smartgwt.client.data.OperationBinding#getOperationType OperationBinding.operationType} "custom" in your .ds.xml
    ...
    public native void performCustomOperation(String operationId) /*-{
        if (this.@com.smartgwt.client.core.BaseClass::isConfigOnly()()) {
            @com.smartgwt.client.util.ConfigUtil::warnOfPostConfigInstantiation(Ljava/lang/Class;Ljava/lang/String;Ljava/lang/String;)(this.@java.lang.Object::getClass()(), "performCustomOperation", "String");
        }
        var self = this.@com.smartgwt.client.core.BaseClass::getOrCreateJsObj()();
    ...
    public native void performCustomOperation(String operationId, Record data, DSCallback callback, DSRequest requestProperties) /*-{
        if (this.@com.smartgwt.client.core.BaseClass::isConfigOnly()()) {
            @com.smartgwt.client.util.ConfigUtil::warnOfPostConfigInstantiation(Ljava/lang/Class;Ljava/lang/String;Ljava/lang/String;)(this.@java.lang.Object::getClass()(), "performCustomOperation", "String,Record,DSCallback,DSRequest");
        }
        var self = this.@com.smartgwt.client.core.BaseClass::getOrCreateJsObj()();
     ...
     *  passed to {@link com.smartgwt.client.data.DataSource#transformRequest transformRequest()}.
     *  <P>
    ...
    public native void processResponse(String requestId, DSResponse dsResponse) /*-{
        if (this.@com.smartgwt.client.core.BaseClass::isConfigOnly()()) {
            @com.smartgwt.client.util.ConfigUtil::warnOfPostConfigInstantiation(Ljava/lang/Class;Ljava/lang/String;Ljava/lang/String;)(this.@java.lang.Object::getClass()(), "processResponse", "String,DSResponse");
        }
        var self = this.@com.smartgwt.client.core.BaseClass::getOrCreateJsObj()();
    ...
    public native boolean recordsAreEqual(Object record1, Object record2) /*-{
        if (this.@com.smartgwt.client.core.BaseClass::isConfigOnly()()) {
            @com.smartgwt.client.util.ConfigUtil::warnOfPostConfigInstantiation(Ljava/lang/Class;Ljava/lang/String;Ljava/lang/String;)(this.@java.lang.Object::getClass()(), "recordsAreEqual", "Object,Object");
        }
        var self = this.@com.smartgwt.client.core.BaseClass::getOrCreateJsObj()();
     ...
     * <code>settings</code> parameter for this method, {@link com.smartgwt.client.data.DataSourceField#getExportForceText
    ...
    public native String recordsAsText(Record[] records) /*-{
        if (this.@com.smartgwt.client.core.BaseClass::isConfigOnly()()) {
            @com.smartgwt.client.util.ConfigUtil::warnOfPostConfigInstantiation(Ljava/lang/Class;Ljava/lang/String;Ljava/lang/String;)(this.@java.lang.Object::getClass()(), "recordsAsText", "Record[]");
        }
        var self = this.@com.smartgwt.client.core.BaseClass::getOrCreateJsObj()();
    ...
    public native String recordsAsText(Record[] records, TextExportSettings settings) /*-{
        if (this.@com.smartgwt.client.core.BaseClass::isConfigOnly()()) {
            @com.smartgwt.client.util.ConfigUtil::warnOfPostConfigInstantiation(Ljava/lang/Class;Ljava/lang/String;Ljava/lang/String;)(this.@java.lang.Object::getClass()(), "recordsAsText", "Record[],TextExportSettings");
        }
        var self = this.@com.smartgwt.client.core.BaseClass::getOrCreateJsObj()();
        var ret = self.recordsAsText(@com.smartgwt.client.util.JSOHelper::convertToJavaScriptArray([Ljava/lang/Object;)(records), settings == null ? null : settings.@com.smartgwt.client.core.BaseClass::getConfig()());
        return ret;
    }-*/;
    ...
    public native Record[] recordsFromText(String text) /*-{
        if (this.@com.smartgwt.client.core.BaseClass::isConfigOnly()()) {
            @com.smartgwt.client.util.ConfigUtil::warnOfPostConfigInstantiation(Ljava/lang/Class;Ljava/lang/String;Ljava/lang/String;)(this.@java.lang.Object::getClass()(), "recordsFromText", "String");
        }
        var self = this.@com.smartgwt.client.core.BaseClass::getOrCreateJsObj()();
    ...
    public native Record[] recordsFromText(String text, TextImportSettings settings) /*-{
        if (this.@com.smartgwt.client.core.BaseClass::isConfigOnly()()) {
            @com.smartgwt.client.util.ConfigUtil::warnOfPostConfigInstantiation(Ljava/lang/Class;Ljava/lang/String;Ljava/lang/String;)(this.@java.lang.Object::getClass()(), "recordsFromText", "String,TextImportSettings");
        }
        var self = this.@com.smartgwt.client.core.BaseClass::getOrCreateJsObj()();
        var ret = self.recordsFromText(text, settings == null ? null : settings.@com.smartgwt.client.core.BaseClass::getConfig()());
        if(ret == null) return null;
        return @com.smartgwt.client.util.ConvertTo::arrayOfRecord(Lcom/google/gwt/core/client/JavaScriptObject;)(ret);
    }-*/;
	...
	/**
     * Remove a file stored in this DataSource.  Note, if  {@link com.smartgwt.client.docs.serverds.DataSource#fileVersionField
     * automatic file versioning} is switched on for the dataSource, all versions of the file are removed (to remove an
     * individual file version, use the  {@link com.smartgwt.client.data.DataSource#removeFileVersion removeFileVersion()}
     * API).
     * @param fileSpec Either a FileSpec, or a String which                 will be parsed to determine the fileName, fileType and fileFormat. 
     * For instance, "employees.ds.xml" would be parsed as                 {fileName: "employees", fileType: "ds", fileFormat:
    ...
    public native void removeFile(FileSpec fileSpec) /*-{
        if (this.@com.smartgwt.client.core.BaseClass::isConfigOnly()()) {
            @com.smartgwt.client.util.ConfigUtil::warnOfPostConfigInstantiation(Ljava/lang/Class;Ljava/lang/String;Ljava/lang/String;)(this.@java.lang.Object::getClass()(), "removeFile", "FileSpec");
        }
        var self = this.@com.smartgwt.client.core.BaseClass::getOrCreateJsObj()();
    ...
    public native void removeFile(String fileSpec) /*-{
        if (this.@com.smartgwt.client.core.BaseClass::isConfigOnly()()) {
            @com.smartgwt.client.util.ConfigUtil::warnOfPostConfigInstantiation(Ljava/lang/Class;Ljava/lang/String;Ljava/lang/String;)(this.@java.lang.Object::getClass()(), "removeFile", "String");
        }
        var self = this.@com.smartgwt.client.core.BaseClass::getOrCreateJsObj()();
    ...
    public native void removeFile(FileSpec fileSpec, DSCallback callback) /*-{
        if (this.@com.smartgwt.client.core.BaseClass::isConfigOnly()()) {
            @com.smartgwt.client.util.ConfigUtil::warnOfPostConfigInstantiation(Ljava/lang/Class;Ljava/lang/String;Ljava/lang/String;)(this.@java.lang.Object::getClass()(), "removeFile", "FileSpec,DSCallback");
        }
        var self = this.@com.smartgwt.client.core.BaseClass::getOrCreateJsObj()();
        self.removeFile(fileSpec.@com.smartgwt.client.core.DataClass::getJsObj()(), 
			$entry( function(dsResponse, data, dsRequest) { 
     ...
     * @see com.smartgwt.client.docs.FileSource FileSource overview and related methods
     */
    public native void removeFileVersion(FileSpec fileSpec, Date version) /*-{
        if (this.@com.smartgwt.client.core.BaseClass::isConfigOnly()()) {
            @com.smartgwt.client.util.ConfigUtil::warnOfPostConfigInstantiation(Ljava/lang/Class;Ljava/lang/String;Ljava/lang/String;)(this.@java.lang.Object::getClass()(), "removeFileVersion", "FileSpec,Date");
        }
        var self = this.@com.smartgwt.client.core.BaseClass::getOrCreateJsObj()();
        self.removeFileVersion(fileSpec.@com.smartgwt.client.core.DataClass::getJsObj()(), @com.smartgwt.client.util.JSOHelper::convertToJavaScriptDate(Ljava/util/Date;)(version));
    }-*/;
     ...
     * can obtain the list of                  versions for a given file with the {@link
     * com.smartgwt.client.data.DataSource#listFileVersions listFileVersions()} API.
     * @param callback Callback executed with the results.                  The <code>data</code> parameter is either a record representing the
     * removed file version, or null to indicate an error.                 The record will have its <code>{@link
     * com.smartgwt.client.docs.serverds.DataSource#fileNameField fileName}</code>,                 <code>{@link
     * com.smartgwt.client.docs.serverds.DataSource#fileTypeField fileType}</code>,                 <code>{@link
     * com.smartgwt.client.docs.serverds.DataSource#fileFormatField fileFormat}</code>,                 <code>{@link
     * com.smartgwt.client.docs.serverds.DataSource#fileLastModifiedField fileLastModified}</code>, and                 
     * <code>{@link com.smartgwt.client.docs.serverds.DataSource#fileVersionField fileVersion}</code> fields populated, but    
     * not the <code>{@link com.smartgwt.client.docs.serverds.DataSource#fileContentsField fileContents}</code> field.         
     * You can examine <code>{@link com.smartgwt.client.data.DSResponse#getStatus dsResponse.status}</code>                 and
     * <code>{@link com.smartgwt.client.data.DSResponse#getData dsResponse.data}</code>                 for additional
     * information about any error.
     * @see com.smartgwt.client.docs.FileSource FileSource overview and related methods
     */
    public native void removeFileVersion(FileSpec fileSpec, Date version, DSCallback callback) /*-{
        if (this.@com.smartgwt.client.core.BaseClass::isConfigOnly()()) {
            @com.smartgwt.client.util.ConfigUtil::warnOfPostConfigInstantiation(Ljava/lang/Class;Ljava/lang/String;Ljava/lang/String;)(this.@java.lang.Object::getClass()(), "removeFileVersion", "FileSpec,Date,DSCallback");
        }
        var self = this.@com.smartgwt.client.core.BaseClass::getOrCreateJsObj()();
        self.removeFileVersion(fileSpec.@com.smartgwt.client.core.DataClass::getJsObj()(), @com.smartgwt.client.util.JSOHelper::convertToJavaScriptDate(Ljava/util/Date;)(version), 
			$entry( function(dsResponse, data, dsRequest) { 
	...
	/**
     * Rename a file stored in this DataSource.  Note, if  {@link com.smartgwt.client.docs.serverds.DataSource#fileVersionField
     * automatic file versioning} is switched on for the dataSource, all versions of the file are renamed.
    ...
    public native void renameFile(FileSpec oldFileSpec, FileSpec newFileSpec) /*-{
        if (this.@com.smartgwt.client.core.BaseClass::isConfigOnly()()) {
            @com.smartgwt.client.util.ConfigUtil::warnOfPostConfigInstantiation(Ljava/lang/Class;Ljava/lang/String;Ljava/lang/String;)(this.@java.lang.Object::getClass()(), "renameFile", "FileSpec,FileSpec");
        }
        var self = this.@com.smartgwt.client.core.BaseClass::getOrCreateJsObj()();
    ...
    public native void renameFile(FileSpec oldFileSpec, FileSpec newFileSpec, DSCallback callback) /*-{
        if (this.@com.smartgwt.client.core.BaseClass::isConfigOnly()()) {
            @com.smartgwt.client.util.ConfigUtil::warnOfPostConfigInstantiation(Ljava/lang/Class;Ljava/lang/String;Ljava/lang/String;)(this.@java.lang.Object::getClass()(), "renameFile", "FileSpec,FileSpec,DSCallback");
        }
        var self = this.@com.smartgwt.client.core.BaseClass::getOrCreateJsObj()();
        self.renameFile(oldFileSpec.@com.smartgwt.client.core.DataClass::getJsObj()(), newFileSpec.@com.smartgwt.client.core.DataClass::getJsObj()(), 
			$entry( function(dsResponse, data, dsRequest) { 
    ...
    public native void saveFile(FileSpec fileSpec, String contents) /*-{
        if (this.@com.smartgwt.client.core.BaseClass::isConfigOnly()()) {
            @com.smartgwt.client.util.ConfigUtil::warnOfPostConfigInstantiation(Ljava/lang/Class;Ljava/lang/String;Ljava/lang/String;)(this.@java.lang.Object::getClass()(), "saveFile", "FileSpec,String");
        }
        var self = this.@com.smartgwt.client.core.BaseClass::getOrCreateJsObj()();
     ...
     * the new file, or null to indicate an error. The record will have its                 <code>fileName</code>,
     * <code>fileType</code> and <code>fileFormat</code>                 field populated, but not the <code>fileContents</code>
     * field.                 You can examine <code>{@link com.smartgwt.client.data.DSResponse#getStatus
     * dsResponse.status}</code>                 and <code>{@link com.smartgwt.client.data.DSResponse#getData
     * dsResponse.data}</code>                 for additional information about any error.
     * @see com.smartgwt.client.docs.FileSource FileSource overview and related methods
     */
    public native void saveFile(FileSpec fileSpec, String contents, DSCallback callback) /*-{
        if (this.@com.smartgwt.client.core.BaseClass::isConfigOnly()()) {
            @com.smartgwt.client.util.ConfigUtil::warnOfPostConfigInstantiation(Ljava/lang/Class;Ljava/lang/String;Ljava/lang/String;)(this.@java.lang.Object::getClass()(), "saveFile", "FileSpec,String,DSCallback");
        }
        var self = this.@com.smartgwt.client.core.BaseClass::getOrCreateJsObj()();
        self.saveFile(fileSpec.@com.smartgwt.client.core.DataClass::getJsObj()(), contents, 
			$entry( function(dsResponse, data, dsRequest) { 
    ...
    public native void setTypeOperators(FieldType typeName, OperatorId[] operators) /*-{
        if (this.@com.smartgwt.client.core.BaseClass::isConfigOnly()()) {
            @com.smartgwt.client.util.ConfigUtil::warnOfPostConfigInstantiation(Ljava/lang/Class;Ljava/lang/String;Ljava/lang/String;)(this.@java.lang.Object::getClass()(), "setTypeOperators", "FieldType,OperatorId[]");
        }
        var self = this.@com.smartgwt.client.core.BaseClass::getOrCreateJsObj()();
     ...
     * copyCriteria()} to make a copy to be passed in.
    ...
    public native Criteria splitCriteria(Criteria criteria, String[] fields) /*-{
        if (this.@com.smartgwt.client.core.BaseClass::isConfigOnly()()) {
            @com.smartgwt.client.util.ConfigUtil::warnOfPostConfigInstantiation(Ljava/lang/Class;Ljava/lang/String;Ljava/lang/String;)(this.@java.lang.Object::getClass()(), "splitCriteria", "Criteria,String[]");
        }
        var self = this.@com.smartgwt.client.core.BaseClass::getOrCreateJsObj()();
	    if(@com.smartgwt.client.data.Criterion::instanceOf(Ljava/lang/Object;)(criteria)){
	    	@com.smartgwt.client.util.JSOHelper::setAttribute(Lcom/google/gwt/core/client/JavaScriptObject;Ljava/lang/String;Ljava/lang/String;)(criteria.@com.smartgwt.client.data.Criterion::getJsObj()(),"_constructor","AdvancedCriteria");
    ...
    public native Boolean supportsAdvancedCriteria() /*-{
        if (this.@com.smartgwt.client.core.BaseClass::isConfigOnly()()) {
            @com.smartgwt.client.util.ConfigUtil::warnOfPostConfigInstantiation(Ljava/lang/Class;Ljava/lang/String;Ljava/lang/String;)(this.@java.lang.Object::getClass()(), "supportsAdvancedCriteria", "");
        }
        var self = this.@com.smartgwt.client.core.BaseClass::getOrCreateJsObj()();
    ...
    public native void supportsTextMatchStyle(TextMatchStyle textMatchStyle) /*-{
        if (this.@com.smartgwt.client.core.BaseClass::isConfigOnly()()) {
            @com.smartgwt.client.util.ConfigUtil::warnOfPostConfigInstantiation(Ljava/lang/Class;Ljava/lang/String;Ljava/lang/String;)(this.@java.lang.Object::getClass()(), "supportsTextMatchStyle", "TextMatchStyle");
        }
        var self = this.@com.smartgwt.client.core.BaseClass::getOrCreateJsObj()();
     ...
     * metadata such as {@link com.smartgwt.client.data.DSRequest#getStartRow DSRequest.startRow}, {@link
     ...
     * {@link com.smartgwt.client.data.OperationBinding#getDataProtocol OperationBinding.dataProtocol}.  If using the
     * "getParams" or
     ...
     *  will be serialized as an XML message by {@link com.smartgwt.client.data.DataSource#xmlSerialize xmlSerialize()}.
     *  <P>
     ...
     * data-set and calls {@link com.smartgwt.client.data.DataSource#processResponse processResponse()} when the operation is
     * complete. This
     ...
     * A <code>transformRequest</code> override may also be used to set the {@link
     * com.smartgwt.client.data.DSRequest#getDataProtocol DSRequest.dataProtocol}
    ...
    protected native Object transformRequest(DSRequest dsRequest) /*-{
        if (this.@com.smartgwt.client.core.BaseClass::isConfigOnly()()) {
            @com.smartgwt.client.util.ConfigUtil::warnOfPostConfigInstantiation(Ljava/lang/Class;Ljava/lang/String;Ljava/lang/String;)(this.@java.lang.Object::getClass()(), "transformRequest", "DSRequest");
        }
        var self = this.@com.smartgwt.client.core.BaseClass::getOrCreateJsObj()();
     ...
     * fields in the DSResponse object (such as {@link com.smartgwt.client.data.DSResponse#getStartRow DSResponse.startRow})
     * based on
     *  service-specific metadata fields contained in the service's response.
     *  <P>
     * The DSResponse passed to this method already has {@link com.smartgwt.client.data.DSResponse#getData DSResponse.data},
     * which is
     ...
     *  {@link com.smartgwt.client.data.DataSource#recordsFromXML recordsFromXML()}, which transforms the XML elements to typed
     ...
     * records from the returned JSON data via {@link com.smartgwt.client.data.XMLTools#selectObjects
     * XMLTools.selectObjects()}.  
     * {@link com.smartgwt.client.data.DataSourceField#getValueXPath DataSourceField.valueXPath} is used to derive correctly
     * typed field values.
     ...
     *  </ul> 
     *  <P>
     * In addition to <code>dsResponse.data</code>, {@link com.smartgwt.client.data.DSResponse#getStatus DSResponse.status} is
     * defaulted
     * to 0 (indicating no error), and {@link com.smartgwt.client.data.DSResponse#getStartRow DSResponse.startRow} is assumed
     * to be zero,
     ...
     * {@link com.smartgwt.client.data.DSResponse#getErrors DSResponse.errors} in order to cause validation errors to be shown
     * in
     *       forms and grids.
     *  <li> for services that either do not return cache update data, or return partial data,
     * using {@link com.smartgwt.client.data.DSRequest#getOldValues DSRequest.oldValues} to create cache update data (whether
     * this is
     *       appropriate is application-specific), or setting
     *       {@link com.smartgwt.client.data.DSResponse#getInvalidateCache DSResponse.invalidateCache}.
     *  </ul>
     *  <P>
    ...
    protected native void transformResponse(DSResponse dsResponse, DSRequest dsRequest, Object data) /*-{
        if (this.@com.smartgwt.client.core.BaseClass::isConfigOnly()()) {
            @com.smartgwt.client.util.ConfigUtil::warnOfPostConfigInstantiation(Ljava/lang/Class;Ljava/lang/String;Ljava/lang/String;)(this.@java.lang.Object::getClass()(), "transformResponse", "DSResponse,DSRequest,Object");
        }
        var self = this.@com.smartgwt.client.core.BaseClass::getOrCreateJsObj()();
     ...
     * fetchData()}) you can still call <code>updateCaches()</code>with DSResponses of type "update". Typically DataSource
     * operations that manipulate data operate on a single record at a time, but if you explicitly set the
     * <code>response.data</code> attribute to an array of records, framework code will handle this as it would multiple
     * updates. <P> Example usage: if you had a ListGrid bound to the <code>supplyItem</code> sample DataSource,  and that
     * ListGrid was showing a Record with <code>itemId</code> 23, and you wanted to update  the <code>unitCost</code> field to
     * a new value, you would use the following code:<br><br>      <code>    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// updatedRecord is
     * the record we want to update<br>    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Record record =
     * supplyItemDS.copyRecord(updatedRecord);<br>    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;record.setAttribute("unitCost", 500);<br>  
     ...
     * com.smartgwt.client.data.DSResponse#getInvalidateCache DSResponse.invalidateCache} set. <P> As an alternative to calling
     ...
     * <code>updateCaches()</code> for you - see that method's documentation for details. <P> <b>NOTE:</b>: if
     * <code>updateCaches</code> is called for a {@link com.smartgwt.client.data.DataSource#getClientOnly clientOnly}
     * DataSource, it will update {@link com.smartgwt.client.data.DataSource#getCacheData cacheData} synchronously in addition
     * to notifying all cache managers as normal. <P> If a DataSource has {@link
     ...
     * <b>not</b> go through {@link com.smartgwt.client.data.DataSource#transformResponse transformResponse()} or other
    ...
    public native void updateCaches(DSResponse dsResponse) /*-{
        if (this.@com.smartgwt.client.core.BaseClass::isConfigOnly()()) {
            @com.smartgwt.client.util.ConfigUtil::warnOfPostConfigInstantiation(Ljava/lang/Class;Ljava/lang/String;Ljava/lang/String;)(this.@java.lang.Object::getClass()(), "updateCaches", "DSResponse");
        }
        var self = this.@com.smartgwt.client.core.BaseClass::getOrCreateJsObj()();
    ...
    public native void updateCaches(DSResponse dsResponse, DSRequest dsRequest) /*-{
        if (this.@com.smartgwt.client.core.BaseClass::isConfigOnly()()) {
            @com.smartgwt.client.util.ConfigUtil::warnOfPostConfigInstantiation(Ljava/lang/Class;Ljava/lang/String;Ljava/lang/String;)(this.@java.lang.Object::getClass()(), "updateCaches", "DSResponse,DSRequest");
        }
        var self = this.@com.smartgwt.client.core.BaseClass::getOrCreateJsObj()();
     ...
     * com.smartgwt.client.data.DSResponse#getErrors DSResponse.errors} validation errors or a {@link
     * com.smartgwt.client.data.DSResponse#getStatus DSResponse.status} code of 0. <p> A "validate" dsRequest is effectively
     * always {@link com.smartgwt.client.rpc.RPCRequest#getWillHandleError RPCRequest.willHandleError}:true. It is a normal
     * condition for a "validate" DSResponse to have validation errors and the response will never go to system-wide handling
     * for unexpected errors ({@link com.smartgwt.client.rpc.HandleErrorCallback#handleError
    ...
    public native void validateData(Record values) /*-{
        if (this.@com.smartgwt.client.core.BaseClass::isConfigOnly()()) {
            @com.smartgwt.client.util.ConfigUtil::warnOfPostConfigInstantiation(Ljava/lang/Class;Ljava/lang/String;Ljava/lang/String;)(this.@java.lang.Object::getClass()(), "validateData", "Record");
        }
        var self = this.@com.smartgwt.client.core.BaseClass::getOrCreateJsObj()();
    ...
    public native void validateData(Record values, DSCallback callback, DSRequest requestProperties) /*-{
        if (this.@com.smartgwt.client.core.BaseClass::isConfigOnly()()) {
            @com.smartgwt.client.util.ConfigUtil::warnOfPostConfigInstantiation(Ljava/lang/Class;Ljava/lang/String;Ljava/lang/String;)(this.@java.lang.Object::getClass()(), "validateData", "Record,DSCallback,DSRequest");
        }
        var self = this.@com.smartgwt.client.core.BaseClass::getOrCreateJsObj()();
        self.validateData(values.@com.smartgwt.client.core.DataClass::getJsObj()(), 
			$entry( function(dsResponse, data, dsRequest) { 
    ...
    public native void viewFile(Record data) /*-{
        if (this.@com.smartgwt.client.core.BaseClass::isConfigOnly()()) {
            @com.smartgwt.client.util.ConfigUtil::warnOfPostConfigInstantiation(Ljava/lang/Class;Ljava/lang/String;Ljava/lang/String;)(this.@java.lang.Object::getClass()(), "viewFile", "Record");
        }
        var self = this.@com.smartgwt.client.core.BaseClass::getOrCreateJsObj()();
        if(!self.viewFile) { @com.smartgwt.client.util.SC::requiresServerComponents()(); }
    ...
    public native void viewFile(Record data, String fieldName, DSRequest requestProperties) /*-{
        if (this.@com.smartgwt.client.core.BaseClass::isConfigOnly()()) {
            @com.smartgwt.client.util.ConfigUtil::warnOfPostConfigInstantiation(Ljava/lang/Class;Ljava/lang/String;Ljava/lang/String;)(this.@java.lang.Object::getClass()(), "viewFile", "Record,String,DSRequest");
        }
        var self = this.@com.smartgwt.client.core.BaseClass::getOrCreateJsObj()();
        if(!self.viewFile) { @com.smartgwt.client.util.SC::requiresServerComponents()(); }
	...
	/**
     * Returns true if calling {@link com.smartgwt.client.data.DataSource#flattenCriteria flattenCriteria()} on the passed
     ...
     * You can use {@link com.smartgwt.client.data.DataSource#canFlattenCriteria canFlattenCriteria()} to detect whether an
    ...
    public static native String getAdvancedCriteriaDescription(AdvancedCriteria criteria, DataSource dataSource) /*-{
        ...
        var ret = $wnd.isc.DataSource.getAdvancedCriteriaDescription(criteria.@com.smartgwt.client.core.DataClass::getJsObj()(), dataSource == null ? null : dataSource.@com.smartgwt.client.core.BaseClass::getOrCreateJsObj()());
        return ret;
    }-*/;
     ...
     * See {@link com.smartgwt.client.docs.GlobalId GlobalId}
     *
	...
	/**
     * Returns the {@link com.smartgwt.client.data.DataSource#setLoaderURL loaderURL}
     *
     * @return The loaderURL
     */
    public static native String getLoaderURL() /*-{
        var ret = $wnd.isc.DataSource.getLoaderURL();
        return ret;
    }-*/;
     ...
     * expected by {@link com.smartgwt.client.data.DSRequest#getSortBy DSRequest.sortBy}.
     * @param sortSpecifiers The list of specifiers to return in   sortBy format
     *
     * @return An array of sort-definitions in the format expected by  {@link com.smartgwt.client.data.DSRequest#getSortBy
     * DSRequest.sortBy}
     */
	...
	/**
     * Return an array of {@link com.smartgwt.client.data.SortSpecifier}s, given an array of Strings in the format expected by
     * {@link com.smartgwt.client.data.DSRequest#getSortBy DSRequest.sortBy}.
     * @param sortBy A list of sortBy strings in the format expected by {@link com.smartgwt.client.data.DSRequest#getSortBy DSRequest.sortBy}
     *
     * @return An array of {@link com.smartgwt.client.data.SortSpecifier}s equivalent to the passed in string array
     */
    public static native SortSpecifier[] getSortSpecifiers(String[] sortBy) /*-{
	...
	/**
     * Variation of {@link com.smartgwt.client.data.DataSource#load load()} that will also automatically load any DataSources
     * that the requested DataSources inherit from (via {@link com.smartgwt.client.data.DataSource#getInheritsFrom
	...
	/**
     * Sets the URL where the DataSourceLoader servlet has been installed; this is used by the  {@link
     * com.smartgwt.client.data.DataSource#load load()} method.  Note, one reason you may wish to modify the loader URL is to
     * include a Cross-Site Request Forgery (CSRF) token, as described  {@link com.smartgwt.client.rpc.RPCManager#actionURL
     * here}
     * @param url The new loaderURL
     */
    public static native void setLoaderURL(String url) /*-{
        $wnd.isc.DataSource.setLoaderURL(url);
    }-*/;
     ...
     *
     * @param dataSourceProperties properties that should be used as new defaults when instances of this class are created
     * @see com.smartgwt.client.docs.SGWTProperties
     */
    public static native void setDefaultProperties(DataSource dataSourceProperties) /*-{
        if (dataSourceProperties.@com.smartgwt.client.core.BaseClass::isCreated()()) {
            @com.smartgwt.client.util.ConfigUtil::warnOfPreConfigInstantiation(Ljava/lang/Class;Ljava/lang/String;Ljava/lang/Class;)(DataSource.@java.lang.Object::getClass()(), "setDefaultProperties", dataSourceProperties.@java.lang.Object::getClass()());
        }
        dataSourceProperties.@com.smartgwt.client.core.BaseClass::setConfigOnly(Z)(true);
    	var properties = dataSourceProperties.@com.smartgwt.client.core.BaseClass::getConfig()();
        properties = @com.smartgwt.client.util.JSOHelper::cleanProperties(Lcom/google/gwt/core/client/JavaScriptObject;Z)(properties,true);
        $wnd.isc.DataSource.addProperties(properties);
    }-*/;
  ...
  *
    ...
    protected native boolean useOfflineResponse(DSRequest dsRequest, DSResponse dsResponse) /*-{
        var self = this.@com.smartgwt.client.core.BaseClass::getOrCreateJsObj()();
        if (self.__useOfflineResponse == null) return true; // no default implementation in SC, so check for null
    ...
    */
     ...
     * field if necessary, and will extract  {@link com.smartgwt.client.data.SimpleType.SimpleTypeValueExtractor#getAtomicValue atomic values} from
     ...
     * dataPath.  This method is only of real use when you are dealing with complex nested data via 
     * {@link com.smartgwt.client.widgets.grid.ListGridField#getDataPath dataPath}; it is obviously a trivial matter to obtain a field 
     * value from a flat record directly.<p>
     * If the dataPath is null, this method will follow any {@link com.smartgwt.client.widgets.grid.ListGridField#getDataPath dataPath}
     * specified on the component field instead.  In either case, it will also extract 
     * {@link com.smartgwt.client.data.SimpleType.SimpleTypeValueExtractor#getAtomicValue atomic values} from custom {@link com.smartgwt.client.data.SimpleType} 
     * fields where this is required.
     *
     * @param field Field definition from a dataSource or dataBoundComponent.
     * @param record data object
     * @param dataPath Optional dataPath to use; if not supplied, the field's dataPath is used (or its name if the field has no dataPath)
     * @param component Optional component to provide additional context for the dataPath search.  This is typically
     *                  required if the dataPath traverses a list
     * @param reason Optional reason for the get request, to be passed into any {@link com.smartgwt.client.data.SimpleType.SimpleTypeValueExtractor#getAtomicValue} 
     *                  method - see that API for details
     * @param convertResult If true, convert the field value to a native Java object before returning it
     * @return extracted field value
     */
    public static Object getFieldValue(DataSourceField field, Record record, String dataPath, Canvas component,
                                       String reason, boolean convertResult) 
    {
    	return getFieldValue((DataClass)field, record, dataPath, component, reason, convertResult);
    }
     ...
     * @return extracted field value
     */
    public static Object getFieldValue(ListGridField field, Record record, String dataPath, Canvas component,
                                       String reason, boolean convertResult) 
    {
    	return getFieldValue((DataClass)field, record, dataPath, component, reason, convertResult);
    }
     ...
     * @return extracted field value
     */
    public static Object getFieldValue(DetailViewerField field, Record record, String dataPath, Canvas component,
                                       String reason, boolean convertResult) 
    {
    	return getFieldValue((DataClass)field, record, dataPath, component, reason, convertResult);
    }
     ...
     * @return extracted field value
     */
    public static Object getFieldValue(FormItem field, Record record, String dataPath, Canvas component,
                                       String reason, boolean convertResult) 
    {
    	return getFieldValue((DataClass)field, record, dataPath, component, reason, convertResult);
    }
    
    private static native Object getFieldValue(DataClass field, Record record, String dataPath, Canvas component,
                                               String reason, boolean convertResult) 
    /*-{
        var fieldJ = field == null ? null : field.@com.smartgwt.client.core.DataClass::getJsObj()(),
            recordJ = record.@com.smartgwt.client.core.DataClass::getJsObj()(),
            componentJ = component == null ? null : component.@com.smartgwt.client.widgets.BaseWidget::getJsObj()(),
            reasonJ = reason;
        var ret = $wnd.isc.DataSource.getFieldValue(fieldJ, recordJ, dataPath, componentJ, reasonJ);
        if (convertResult) {
            return $wnd.SmartGWT.convertToJavaObject(ret);
        }
        return ret;
     ...
     * the field's declared dataPath if the argument dataPath is null.  This method is only of real use when you are dealing with complex 
     * nested data via {@link com.smartgwt.client.widgets.grid.ListGridField#getDataPath dataPath}; it is obviously a trivial matter 
     * to store a field value in a flat record directly.<p>
     * This method will call the {@link com.smartgwt.client.data.SimpleType.SimpleTypeValueUpdater#updateAtomicValue updateAtomicValue()} of custom 
     * {@link com.smartgwt.client.data.SimpleType} fields where this is required.
     *
     * @param field Field definition from a dataSource or dataBoundComponent.
     * @param dataPath Optional dataPath to use (the field's dataPath is used if this is null)
     * @param value the field value to save
     * @param values data object to save into
     * @param reason Optional reason for the get request, to be passed into any {@link com.smartgwt.client.data.SimpleType.SimpleTypeValueUpdater#updateAtomicValue} 
     *                  method - see that API for details
     * @return extracted field value
     */
    public static void saveValueViaDataPath(DataSourceField field, String dataPath, String value, Record values,
                                            String reason)
    {
        saveValueViaDataPath((DataClass)field, dataPath, value, values, reason);
    }                                            
     ...
     * @return extracted field value
     */
    public static void saveValueViaDataPath(ListGridField field, String dataPath, String value, Record values,
                                            String reason)
    {
        saveValueViaDataPath((DataClass)field, dataPath, value, values, reason);
    }                                            
     ...
     * @return extracted field value
     */
    public static void saveValueViaDataPath(DetailViewerField field, String dataPath, String value, Record values,
                                            String reason)
    {
        saveValueViaDataPath((DataClass)field, dataPath, value, values, reason);
    }                                            
     ...
     * @return extracted field value
     */
    public static void saveValueViaDataPath(FormItem field, String dataPath, String value, Record values,
                                            String reason)
    {
        saveValueViaDataPath((DataClass)field, dataPath, value, values, reason);
    }                                            
     ...
     * @return extracted field value
     */
    public static void saveValueViaDataPath(DataSourceField field, String dataPath, Integer value, Record values,
                                            String reason)
    {
        saveValueViaDataPath((DataClass)field, dataPath, value, values, reason);
    }                                            
     ...
     * @return extracted field value
     */
    public static void saveValueViaDataPath(ListGridField field, String dataPath, Integer value, Record values,
                                            String reason)
    {
        saveValueViaDataPath((DataClass)field, dataPath, value, values, reason);
    }                                            
     ...
     * @return extracted field value
     */
    public static void saveValueViaDataPath(DetailViewerField field, String dataPath, Integer value, Record values,
                                            String reason)
    {
        saveValueViaDataPath((DataClass)field, dataPath, value, values, reason);
    }                                            
     ...
     * @return extracted field value
     */
    public static void saveValueViaDataPath(FormItem field, String dataPath, Integer value, Record values,
                                            String reason)
    {
        saveValueViaDataPath((DataClass)field, dataPath, value, values, reason);
    }                                            
     ...
     * @return extracted field value
     */
    public static void saveValueViaDataPath(DataSourceField field, String dataPath, Double value, Record values,
                                            String reason)
    {
        saveValueViaDataPath((DataClass)field, dataPath, value, values, reason);
    }                                            
     ...
     * @return extracted field value
     */
    public static void saveValueViaDataPath(ListGridField field, String dataPath, Double value, Record values,
                                            String reason)
    {
        saveValueViaDataPath((DataClass)field, dataPath, value, values, reason);
    }                                            
     ...
     * @return extracted field value
     */
    public static void saveValueViaDataPath(DetailViewerField field, String dataPath, Double value, Record values,
                                            String reason)
    {
        saveValueViaDataPath((DataClass)field, dataPath, value, values, reason);
    }                                            
     ...
     * @return extracted field value
     */
    public static void saveValueViaDataPath(FormItem field, String dataPath, Double value, Record values,
                                            String reason)
    {
        saveValueViaDataPath((DataClass)field, dataPath, value, values, reason);
    }                                            
     ...
     * @return extracted field value
     */
    public static void saveValueViaDataPath(DataSourceField field, String dataPath, Float value, Record values,
                                            String reason)
    {
        saveValueViaDataPath((DataClass)field, dataPath, value, values, reason);
    }                                            
     ...
     * @return extracted field value
     */
    public static void saveValueViaDataPath(ListGridField field, String dataPath, Float value, Record values,
                                            String reason)
    {
        saveValueViaDataPath((DataClass)field, dataPath, value, values, reason);
    }                                            
     ...
     * @return extracted field value
     */
    public static void saveValueViaDataPath(DetailViewerField field, String dataPath, Float value, Record values,
                                            String reason)
    {
        saveValueViaDataPath((DataClass)field, dataPath, value, values, reason);
    }                                            
     ...
     * @return extracted field value
     */
    public static void saveValueViaDataPath(FormItem field, String dataPath, Float value, Record values,
                                            String reason)
    {
        saveValueViaDataPath((DataClass)field, dataPath, value, values, reason);
    }                                            
     ...
     * @return extracted field value
     */
    public static void saveValueViaDataPath(DataSourceField field, String dataPath, Date value, Record values,
                                            String reason)
    {
        saveValueViaDataPath((DataClass)field, dataPath, value, values, reason);
    }                                            
     ...
     * @return extracted field value
     */
    public static void saveValueViaDataPath(ListGridField field, String dataPath, Date value, Record values,
                                            String reason)
    {
        saveValueViaDataPath((DataClass)field, dataPath, value, values, reason);
    }                                            
     ...
     * @return extracted field value
     */
    public static void saveValueViaDataPath(DetailViewerField field, String dataPath, Date value, Record values,
                                            String reason)
    {
        saveValueViaDataPath((DataClass)field, dataPath, value, values, reason);
    }                                            
     ...
     * @return extracted field value
     */
    public static void saveValueViaDataPath(FormItem field, String dataPath, Date value, Record values,
                                            String reason)
    {
        saveValueViaDataPath((DataClass)field, dataPath, value, values, reason);
    }                                            
     ...
     * @return extracted field value
     */
    public static void saveValueViaDataPath(DataSourceField field, String dataPath, Boolean value, Record values,
                                            String reason)
    {
        saveValueViaDataPath((DataClass)field, dataPath, value, values, reason);
    }                                            
     ...
     * @return extracted field value
     */
    public static void saveValueViaDataPath(ListGridField field, String dataPath, Boolean value, Record values,
                                            String reason)
    {
        saveValueViaDataPath((DataClass)field, dataPath, value, values, reason);
    }                                            
     ...
     * @return extracted field value
     */
    public static void saveValueViaDataPath(DetailViewerField field, String dataPath, Boolean value, Record values,
                                            String reason)
    {
        saveValueViaDataPath((DataClass)field, dataPath, value, values, reason);
    }                                            
     ...
     * @return extracted field value
     */
    public static void saveValueViaDataPath(FormItem field, String dataPath, Boolean value, Record values,
                                            String reason)
    {
        saveValueViaDataPath((DataClass)field, dataPath, value, values, reason);
    }                                            
     ...
     * @return extracted field value
     */
    public static void saveValueViaDataPath(DataSourceField field, String dataPath, JavaScriptObject value, Record values,
                                            String reason)
    {
        saveValueViaDataPath((DataClass)field, dataPath, value, values, reason);
    }                                            
     ...
     * @return extracted field value
     */
    public static void saveValueViaDataPath(ListGridField field, String dataPath, JavaScriptObject value, Record values,
                                            String reason)
    {
        saveValueViaDataPath((DataClass)field, dataPath, value, values, reason);
    }                                            
     ...
     * @return extracted field value
     */
    public static void saveValueViaDataPath(DetailViewerField field, String dataPath, JavaScriptObject value, Record values,
                                            String reason)
    {
        saveValueViaDataPath((DataClass)field, dataPath, value, values, reason);
    }                                            
     ...
     * @return extracted field value
     */
    public static void saveValueViaDataPath(FormItem field, String dataPath, JavaScriptObject value, Record values,
                                            String reason)
    {
        saveValueViaDataPath((DataClass)field, dataPath, value, values, reason);
    }                                            
     ...
     * @return extracted field value
     */
    public static void saveValueViaDataPath(DataSourceField field, String dataPath, Map value, Record values,
                                            String reason)
    {
        saveValueViaDataPath((DataClass)field, dataPath, JSOHelper.convertMapToJavascriptObject(value), values, reason);
    }                                            
     ...
     * @return extracted field value
     */
    public static void saveValueViaDataPath(ListGridField field, String dataPath, Map value, Record values,
                                            String reason)
    {
        saveValueViaDataPath((DataClass)field, dataPath, JSOHelper.convertMapToJavascriptObject(value), values, reason);
    }                                            
     ...
     * @return extracted field value
     */
    public static void saveValueViaDataPath(DetailViewerField field, String dataPath, Map value, Record values,
                                            String reason)
    {
        saveValueViaDataPath((DataClass)field, dataPath, JSOHelper.convertMapToJavascriptObject(value), values, reason);
    }                                            
     ...
     * @param value the field value to save
     * @param values data object to save into
     * @param reason Optional reason for the save, to be passed into any {@link com.smartgwt.client.data.SimpleType.SimpleTypeValueUpdaterr#pdateAtomicValue} 
     *                  method - see that API for details
     * @return extracted field value
     */
    public static void saveValueViaDataPath(FormItem field, String dataPath, Map value, Record values,
                                            String reason)
    {
        saveValueViaDataPath((DataClass)field, dataPath, JSOHelper.convertMapToJavascriptObject(value), values, reason);
    }                                            

    private static native void saveValueViaDataPath(DataClass field, String dataPath, Object value, 
                                                    Record values, String reason) 
    /*-{        
        var fieldJ = field == null ? null : field.@com.smartgwt.client.core.DataClass::getJsObj()(),
            valuesJ = values == null ? null : values.@com.smartgwt.client.core.DataClass::getJsObj()(),
            reasonJ = reason;
            // Note, although this method accepts an Object parameter, because it is private the only way into
            // it is via one of the public APIs, so that "Object" is guaranteed to be a Java boxed primitive 
            // (Integer, Float, Double or Boolean), a String, a Date, or a JSO.  convertToPrimitiveType() will handle
            // all of these except the JSO, which is safe to use as it is
            valueJ = $wnd.SmartGWT.convertToPrimitiveType(value);
        $wnd.isc.DataSource.saveValueViaDataPath(fieldJ, dataPath, valueJ, valuesJ, reasonJ);
	}-*/;
    
	/**
     * Helper method to remove the value at the supplied dataPath inside the argument values record, or at 
     * the field's declared dataPath if the argument dataPath is null.  This method is only of real use when 
     * you are dealing with complex nested data via {@link com.smartgwt.client.widgets.grid.ListGridField#getDataPath dataPath}; 
    ...
    public static void clearValueAtDataPath(FormItem field, String dataPath, Record values) {
        clearValueAtDataPath((DataClass)field, dataPath, values);
    }
    ...
    private static native void clearValueAtDataPath(DataClass field, String dataPath, Record values) 
    /*-{
        var fieldJ = field == null ? null : field.@com.smartgwt.client.core.DataClass::getJsObj()(),
            valuesJ = values.@com.smartgwt.client.core.DataClass::getJsObj()();
        $wnd.isc.DataSource.clearValueAtDataPath(fieldJ, dataPath, valuesJ);
	}-*/;

    /**
     * When calling DataSource.fetchData(), no actions are automatically performed with the returned data; you must 
     * provide a callback that does something with the server's response.  The exception is 
     * {@link com.smartgwt.client.data.DataSource#setCacheAllData setCacheAllData(true)} mode, in 
     * which case <code>fetchData()</code> populates the DataSource cache for use by subsequent fetches.  To achieve 
     * this, use a signature of fetchData() that provides a callback, and pass criteria as null.
     *
     * @deprecated
     */
     ...
     * <P>
     * If an existing {@link com.smartgwt.client.data.Operator Operator} is passed, restricts the set 
     ...
     */
    public native void addSearchOperator(Operator operator, FieldType[] types) /*-{
        var self = this.@com.smartgwt.client.core.BaseClass::getOrCreateJsObj()();
        var jsOperator = operator.@com.smartgwt.client.core.DataClass::getJsObj()();
        var jsTypes = @com.smartgwt.client.util.JSOHelper::convertToJavaScriptArray([Ljava/lang/Object;)(types);
        self.addSearchOperator(jsOperator, jsTypes);
    }-*/;

    /**
     * See {@link #getPatternMultiWildcardAsStringArray}.
     * @deprecated in favor of {@link #getPatternMultiWildcardAsStringArray}.
     */
    ...
    /**
     * See {@link #getPatternSingleWildcardAsStringArray}.
     * @deprecated in favor of {@link #getPatternSingleWildcardAsStringArray}.
     */
