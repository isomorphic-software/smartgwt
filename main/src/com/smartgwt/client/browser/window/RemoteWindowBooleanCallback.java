...
public interface RemoteWindowBooleanCallback {
    ...
    /** 
     * Callback reporting the result of a boolean {@link com.smartgwt.client.browser.window.RemoteWindow} operation.
     *
     * @param remoteWindow window affected
     * @param result result
     */
	public void execute(RemoteWindow remoteWindow, Boolean result);
} 
