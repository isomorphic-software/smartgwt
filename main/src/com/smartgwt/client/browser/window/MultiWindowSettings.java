...
/**
 * Allows specifying settings to apply to the {@link com.smartgwt.client.browser.window.MultiWindow} of a child window.
 */
...
public class MultiWindowSettings extends DataClass {
    ...
    public static MultiWindowSettings getOrCreateRef(JavaScriptObject jsObj) {
        ...
        return new MultiWindowSettings(jsObj);
    }
     ...
     * supported.
     *
     * @param autoCopyDataSources New autoCopyDataSources value. Default value is varies
     * @return {@link com.smartgwt.client.browser.window.MultiWindowSettings MultiWindowSettings} instance, for chaining setter calls
     */
    public MultiWindowSettings setAutoCopyDataSources(Boolean autoCopyDataSources) {
        return (MultiWindowSettings)setAttribute("autoCopyDataSources", autoCopyDataSources);
    }
     ...
     * supported.
     *
     * @return Current autoCopyDataSources value. Default value is varies
     */
     ...
     *
     * @param shareMessageChannels New shareMessageChannels value. Default value is varies
     * @return {@link com.smartgwt.client.browser.window.MultiWindowSettings MultiWindowSettings} instance, for chaining setter calls
     */
    public MultiWindowSettings setShareMessageChannels(Boolean shareMessageChannels) {
        return (MultiWindowSettings)setAttribute("shareMessageChannels", shareMessageChannels);
    }
     ...
     * This property will default to true if OpenFin is present; otherwise, false.
     *
     * @return Current shareMessageChannels value. Default value is varies
     */
