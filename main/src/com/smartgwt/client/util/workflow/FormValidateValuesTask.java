...
@BeanFactory.ScClassName("FormValidateValuesTask")
public class FormValidateValuesTask extends ComponentTask {
    ...
    public static FormValidateValuesTask getOrCreateRef(JavaScriptObject jsObj) {
        ...
        if(obj != null) {
            return (FormValidateValuesTask) obj;
        } else {
            return new FormValidateValuesTask(jsObj);
        }
    }
    ...
    public FormValidateValuesTask(){
        scClassName = "FormValidateValuesTask";
    }
     ...
     * @return {@link com.smartgwt.client.util.workflow.FormValidateValuesTask FormValidateValuesTask} instance, for chaining setter calls
     * @throws IllegalStateException this property cannot be changed after the underlying component has been created
     */
    public FormValidateValuesTask setPassThruOutput(Boolean passThruOutput)  throws IllegalStateException {
        return (FormValidateValuesTask)setAttribute("passThruOutput", passThruOutput, false);
    }
