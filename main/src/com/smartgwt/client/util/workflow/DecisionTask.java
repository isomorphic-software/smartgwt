 ...
 * {@link com.smartgwt.client.util.workflow.DecisionTask#getNextElement nextElement} is chosen, otherwise the {@link
 * com.smartgwt.client.util.workflow.DecisionTask#getFailureElement failureElement}.
 */
@BeanFactory.FrameworkClass
@BeanFactory.ScClassName("DecisionTask")
public class DecisionTask extends ProcessElement {
    ...
    public static DecisionTask getOrCreateRef(JavaScriptObject jsObj) {
        ...
        if(obj != null) {
            return (DecisionTask) obj;
        } else {
            return new DecisionTask(jsObj);
        }
    }
     ...
     * are not applicable for an DecisionTask but "$inputRecord" can be used for direct reference to {@link
     ...
     * @return {@link com.smartgwt.client.util.workflow.DecisionTask DecisionTask} instance, for chaining setter calls
    ...
    public DecisionTask setCriteria(Criteria criteria)  throws IllegalStateException {
        ...
        return (DecisionTask)setAttribute("criteria", criteria == null ? null : criteria.getJsObj(), false);
    }
    ...
    public DecisionTask setFailureElement(String failureElement)  throws IllegalStateException {
        return (DecisionTask)setAttribute("failureElement", failureElement, false);
    }
     ...
     * <code>nextElement</code> does not need to be specified if this element is part of a {@link
    ...
    public DecisionTask setNextElement(String nextElement)  throws IllegalStateException {
        return (DecisionTask)setAttribute("nextElement", nextElement, false);
    }
