...
/**
 * Sets the edit value of a given field. The targeted row is determined in the following order: <ol> <li> the current edit
 * row <li> the first selected row <li> the first row in the grid <li> a new edit row </ol>
...
public class GridSetEditValueTask extends ComponentTask {
    ...
    public static GridSetEditValueTask getOrCreateRef(JavaScriptObject jsObj) {
        ...
        if(obj != null) {
            return (GridSetEditValueTask) obj;
        } else {
            return new GridSetEditValueTask(jsObj);
        }
    }
    ...
    public GridSetEditValueTask(){
        scClassName = "GridSetEditValueTask";
    }
     ...
     * @return {@link com.smartgwt.client.util.workflow.GridSetEditValueTask GridSetEditValueTask} instance, for chaining setter calls
     * @throws IllegalStateException this property cannot be changed after the underlying component has been created
     */
    public GridSetEditValueTask setTargetField(Integer targetField)  throws IllegalStateException {
        return (GridSetEditValueTask)setAttribute("targetField", targetField, false);
    }
