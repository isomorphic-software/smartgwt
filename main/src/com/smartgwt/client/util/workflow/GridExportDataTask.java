...
public class GridExportDataTask extends ComponentTask {
    ...
    public static GridExportDataTask getOrCreateRef(JavaScriptObject jsObj) {
        if(jsObj == null) return null;
        BaseClass obj = BaseClass.getRef(jsObj);
        if(obj != null) {
            return (GridExportDataTask) obj;
        } else {
            return new GridExportDataTask(jsObj);
        }
    }
    ...
    public GridExportDataTask(){
        scClassName = "GridExportDataTask";
    }

    public GridExportDataTask(JavaScriptObject jsObj){
        scClassName = "GridExportDataTask";
     ...
     * @return {@link com.smartgwt.client.util.workflow.GridExportDataTask GridExportDataTask} instance, for chaining setter calls
     * @throws IllegalStateException this property cannot be changed after the underlying component has been created
     */
    public GridExportDataTask setRequestProperties(DSRequest requestProperties)  throws IllegalStateException {
        JavaScriptObject config = JSOHelper.createObject();
        if (requestProperties != null) {
            JSOHelper.addProperties(config, requestProperties.getJsObj());
        }
        return (GridExportDataTask)setAttribute("requestProperties", requestProperties == null ? null : config, false);
    }
