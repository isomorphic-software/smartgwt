...
public class PrintCanvasTask extends ComponentTask {
    ...
    public static PrintCanvasTask getOrCreateRef(JavaScriptObject jsObj) {
        ...
        if(obj != null) {
            return (PrintCanvasTask) obj;
        } else {
            return new PrintCanvasTask(jsObj);
        }
    }
     ...
     *
     * @param printProperties New printProperties value. Default value is null
     * @return {@link com.smartgwt.client.util.workflow.PrintCanvasTask PrintCanvasTask} instance, for chaining setter calls
    ...
    public PrintCanvasTask setPrintProperties(PrintProperties printProperties)  throws IllegalStateException {
        ...
        if (printProperties != null) {
            JSOHelper.addProperties(config, printProperties.getJsObj());
        }
        return (PrintCanvasTask)setAttribute("printProperties", printProperties == null ? null : config, false);
    }

    /**
     * PrintProperties object for customizing the print HTML output.
     *
     * @return Current printProperties value. Default value is null
     */
     ...
     *
     * @param printWindowProperties New printWindowProperties value. Default value is null
     * @return {@link com.smartgwt.client.util.workflow.PrintCanvasTask PrintCanvasTask} instance, for chaining setter calls
     * @throws IllegalStateException this property cannot be changed after the underlying component has been created
     */
    public PrintCanvasTask setPrintWindowProperties(PrintWindow printWindowProperties)  throws IllegalStateException {
        return (PrintCanvasTask)setAttribute("printWindowProperties", printWindowProperties == null ? null : printWindowProperties.getOrCreateJsObj(), false);
    }

    /**
     * Properties to apply to the generated print window.
     *
     * @return Current printWindowProperties value. Default value is null
     */
