...
public class SendTransactionTask extends ProcessElement {
    ...
    public static SendTransactionTask getOrCreateRef(JavaScriptObject jsObj) {
        if(jsObj == null) return null;
        BaseClass obj = BaseClass.getRef(jsObj);
        if(obj != null) {
            return (SendTransactionTask) obj;
        } else {
            return new SendTransactionTask(jsObj);
        }
    }
    ...
    public SendTransactionTask(){
        scClassName = "SendTransactionTask";
    }

    public SendTransactionTask(JavaScriptObject jsObj){
        scClassName = "SendTransactionTask";
