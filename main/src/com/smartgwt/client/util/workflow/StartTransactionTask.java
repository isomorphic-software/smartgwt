...
public class StartTransactionTask extends ProcessElement {
    ...
    public static StartTransactionTask getOrCreateRef(JavaScriptObject jsObj) {
        if(jsObj == null) return null;
        BaseClass obj = BaseClass.getRef(jsObj);
        if(obj != null) {
            return (StartTransactionTask) obj;
        } else {
            return new StartTransactionTask(jsObj);
        }
    }
    ...
    public StartTransactionTask(){
        scClassName = "StartTransactionTask";
    }

    public StartTransactionTask(JavaScriptObject jsObj){
        scClassName = "StartTransactionTask";
