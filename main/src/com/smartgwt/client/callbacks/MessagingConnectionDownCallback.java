...
public interface MessagingConnectionDownCallback {
     ...
     * This latter is defined as the <code>messaging.keepaliveInterval</code> plus the
     * <code>messaging.keepaliveReestablishDelay</code>. With default settings, a maximum of 4 seconds will elapse between the
     * connection actually going down and you receiving this callback.
     *
     */
	public void execute();
} 
