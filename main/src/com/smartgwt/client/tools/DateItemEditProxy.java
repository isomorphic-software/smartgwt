...
/**
 * {@link com.smartgwt.client.tools.EditProxy} that handles {@link com.smartgwt.client.widgets.form.fields.DateItem} when
 * editMode is enabled.
 * @see com.smartgwt.client.docs.DevTools DevTools overview and related methods
 */
@BeanFactory.FrameworkClass
@BeanFactory.ScClassName("DateItemEditProxy")
public class DateItemEditProxy extends FormItemEditProxy {

    public static DateItemEditProxy getOrCreateRef(JavaScriptObject jsObj) {
        if(jsObj == null) return null;
        BaseClass obj = BaseClass.getRef(jsObj);
        if(obj != null) {
            return (DateItemEditProxy) obj;
        } else {
            return new DateItemEditProxy(jsObj);
        }
    }
        


    public DateItemEditProxy(){
        scClassName = "DateItemEditProxy";
    }

    public DateItemEditProxy(JavaScriptObject jsObj){
        scClassName = "DateItemEditProxy";
     ...
     * Returns the component's value using {@link com.smartgwt.client.util.Date#toShortDate Date.toShortDate()}.
     */
     ...
     * @param newValue the new component default value
     */
