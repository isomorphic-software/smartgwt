...
public class NodeAddedEvent extends AbstractSmartEvent<NodeAddedHandler>  {
     ...
     */
    public static <S extends HasNodeAddedHandlers & HasHandlers> void fire(
        S source, JavaScriptObject jsObj) {
        if (TYPE != null) {
            NodeAddedEvent event = new NodeAddedEvent(jsObj);
    ...
    @Override
    public final Type<NodeAddedHandler> getAssociatedType() {
        return TYPE;
    }

    public NodeAddedEvent(JavaScriptObject jsObj) {
        super(jsObj);
    }
     ...
     *
     * @return parent node of the node that was added
     */
     ...
     *
     * @return root node of the edit context
     */
    public native EditNode getRootNode() /*-{
        var self = this.@com.smartgwt.client.event.AbstractSmartEvent::jsObj;
        var ret = self.rootNode;
        if(ret == null) return null;
        return @com.smartgwt.client.tools.EditNode::getOrCreateRef(Lcom/google/gwt/core/client/JavaScriptObject;)(ret);
    }-*/;
