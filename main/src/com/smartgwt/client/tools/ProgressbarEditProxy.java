...
/**
 * {@link com.smartgwt.client.tools.EditProxy} that handles {@link com.smartgwt.client.widgets.Progressbar} objects when
 * editMode is enabled.
 * @see com.smartgwt.client.docs.DevTools DevTools overview and related methods
 */
@BeanFactory.FrameworkClass
@BeanFactory.ScClassName("ProgressbarEditProxy")
public class ProgressbarEditProxy extends StatefulCanvasEditProxy {

    public static ProgressbarEditProxy getOrCreateRef(JavaScriptObject jsObj) {
        if(jsObj == null) return null;
        BaseClass obj = BaseClass.getRef(jsObj);
        if(obj != null) {
            return (ProgressbarEditProxy) obj;
        } else {
            return new ProgressbarEditProxy(jsObj);
        }
    }


    public ProgressbarEditProxy(){
        scClassName = "ProgressbarEditProxy";
    }

    public ProgressbarEditProxy(JavaScriptObject jsObj){
        scClassName = "ProgressbarEditProxy";
     ...
     * component's <code>percentDone</code>.
     */
     ...
     * @param newValue the new component percentDone
     */
