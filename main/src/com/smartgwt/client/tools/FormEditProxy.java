 ...
 * DynamicForms} when editMode is enabled.
...
public class FormEditProxy extends CanvasEditProxy {
    ...
    public static FormEditProxy getOrCreateRef(JavaScriptObject jsObj) {
        if(jsObj == null) return null;
        BaseClass obj = BaseClass.getRef(jsObj);
        if(obj != null) {
            return (FormEditProxy) obj;
        } else {
            return new FormEditProxy(jsObj);
        }
    }
    ...
    public FormEditProxy(){
        scClassName = "FormEditProxy";
    }

    public FormEditProxy(JavaScriptObject jsObj){
        scClassName = "FormEditProxy";
    ...
    /**
     * Controls which parts of a {@link com.smartgwt.client.widgets.form.fields.FormItem FormItem} respond to a click and
     ...
     * result in selecting the component.
     *
     * @return Current selectItemsMode value. Default value is "item"
     */
    public SelectItemsMode getSelectItemsMode()  {
        return EnumUtil.getEnum(SelectItemsMode.values(), getAttribute("selectItemsMode"));
    }
