...
/**
 * {@link com.smartgwt.client.tools.EditProxy} that handles {@link com.smartgwt.client.widgets.StatefulCanvas} objects when
 * editMode is enabled.
 * @see com.smartgwt.client.docs.DevTools DevTools overview and related methods
 */
@BeanFactory.FrameworkClass
@BeanFactory.ScClassName("StatefulCanvasEditProxy")
public class StatefulCanvasEditProxy extends CanvasEditProxy {

    public static StatefulCanvasEditProxy getOrCreateRef(JavaScriptObject jsObj) {
        if(jsObj == null) return null;
        BaseClass obj = BaseClass.getRef(jsObj);
        if(obj != null) {
            return (StatefulCanvasEditProxy) obj;
        } else {
            return new StatefulCanvasEditProxy(jsObj);
        }
    }


    public StatefulCanvasEditProxy(){
        scClassName = "StatefulCanvasEditProxy";
    }

    public StatefulCanvasEditProxy(JavaScriptObject jsObj){
        scClassName = "StatefulCanvasEditProxy";
