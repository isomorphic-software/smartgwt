...
/**
 * {@link com.smartgwt.client.tools.EditProxy} that handles {@link com.smartgwt.client.widgets.drawing.DrawItem DrawItems}
 * except for {@link com.smartgwt.client.widgets.drawing.DrawLabel DrawLabels} when editMode is enabled.
 * @see com.smartgwt.client.docs.DevTools DevTools overview and related methods
 */
@BeanFactory.FrameworkClass
@BeanFactory.ScClassName("DrawItemEditProxy")
public class DrawItemEditProxy extends EditProxy {

    public static DrawItemEditProxy getOrCreateRef(JavaScriptObject jsObj) {
        if(jsObj == null) return null;
        BaseClass obj = BaseClass.getRef(jsObj);
        if(obj != null) {
            return (DrawItemEditProxy) obj;
        } else {
            return new DrawItemEditProxy(jsObj);
        }
    }


    public DrawItemEditProxy(){
        scClassName = "DrawItemEditProxy";
    }

    public DrawItemEditProxy(JavaScriptObject jsObj){
        scClassName = "DrawItemEditProxy";
