 ...
 * com.smartgwt.client.widgets.tree.TreeNode} within {@link com.smartgwt.client.widgets.tree.TreeGrid#getData data} can be
 * a {@link com.smartgwt.client.tools.PaletteNode}.
...
public class TreePalette extends TreeGrid implements Palette {
    ...
    private static final TreePalette TEST_INSTANCE = new TreePalette();
    static {
        TEST_INSTANCE.setID("isc_TreePalette_testInstance");
    }

    @Override
    protected TreePalette getTestInstance() {
    ...
    public static native void changeAutoChildDefaults(String autoChildName, Canvas defaults) /*-{
        $wnd.isc.TreePalette.changeDefaults(autoChildName + "Defaults", defaults.@com.smartgwt.client.widgets.Canvas::getConfig()());
    }-*/;
    ...
    public static native void changeAutoChildDefaults(String autoChildName, FormItem defaults) /*-{
        $wnd.isc.TreePalette.changeDefaults(autoChildName + "Defaults", defaults.@com.smartgwt.client.widgets.form.fields.FormItem::getJsObj()());
    }-*/;
     ...
     *
     * @param componentDefaults  Default value is null
     * @throws IllegalStateException this property cannot be changed after the component has been created
     * @see com.smartgwt.client.docs.DevTools DevTools overview and related methods
     */
    public void setComponentDefaults(Record componentDefaults)  throws IllegalStateException {
        setAttribute("componentDefaults", componentDefaults.getJsObj(), false);
    }
    ...
    public static native void setDefaultProperties(TreePalette treePaletteProperties) /*-{
    	var properties = $wnd.isc.addProperties({},treePaletteProperties.@com.smartgwt.client.widgets.BaseWidget::getConfig()());
