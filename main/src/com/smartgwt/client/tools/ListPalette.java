 ...
 * drag and drop instantiation of components when combined with an {@link com.smartgwt.client.tools.EditContext} as  the
 * drop target. <P> Each {@link com.smartgwt.client.widgets.grid.ListGridRecord} can be a {@link
...
public class ListPalette extends ListGrid implements Palette {
    ...
    public static ListPalette getOrCreateRef(JavaScriptObject jsObj) {
        ...
        if (refInstance == null) {
            return new ListPalette(jsObj);
        } else {
            assert refInstance instanceof ListPalette;
            return (ListPalette)refInstance;
        }
    }
    ...
    public static native void changeAutoChildDefaults(String autoChildName, Canvas defaults) /*-{
        if (defaults.@com.smartgwt.client.widgets.BaseWidget::isCreated()()) {
            @com.smartgwt.client.util.ConfigUtil::warnOfPreConfigInstantiation(Ljava/lang/Class;Ljava/lang/String;Ljava/lang/String;)(ListPalette.@java.lang.Object::getClass()(), "changeAutoChildDefaults", "Canvas");
        }
        defaults.@com.smartgwt.client.widgets.BaseWidget::setConfigOnly(Z)(true);
        var cleanDefaultsJS = @com.smartgwt.client.util.JSOHelper::cleanProperties(Lcom/google/gwt/core/client/JavaScriptObject;Z)(defaults.@com.smartgwt.client.widgets.BaseWidget::getConfig()(), true);
        $wnd.isc.ListPalette.changeDefaults(autoChildName + "Defaults", cleanDefaultsJS);
    }-*/;
    ...
    public static native void changeAutoChildDefaults(String autoChildName, FormItem defaults) /*-{
        if (defaults.@com.smartgwt.client.widgets.form.fields.FormItem::isCreated()()) {
            @com.smartgwt.client.util.ConfigUtil::warnOfPreConfigInstantiation(Ljava/lang/Class;Ljava/lang/String;Ljava/lang/String;)(ListPalette.@java.lang.Object::getClass()(), "changeAutoChildDefaults", "FormItem");
        }
     ...
     */
    public native ListPalette setDefaultEditContext(EditContext defaultEditContext) /*-{
     ...
     * @return {@link com.smartgwt.client.tools.ListPalette ListPalette} instance, for chaining setter calls
     */
    public native ListPalette setDefaultEditContext(EditTree defaultEditContext) /*-{
        var defaultEditContextJS = (
                defaultEditContext == null ?
                null :
     ...
     * @return {@link com.smartgwt.client.tools.ListPalette ListPalette} instance, for chaining setter calls
     */
    public native ListPalette setDefaultEditContext(EditPane defaultEditContext) /*-{
        var defaultEditContextJS = (
                defaultEditContext == null ?
                null :
    ...
    public ListPalette setGenerateNames(boolean generateNames)  throws IllegalStateException {
        return (ListPalette)setAttribute("generateNames", generateNames, false);
    }
     ...
     *
     * @param listPaletteProperties properties that should be used as new defaults when instances of this class are created
     * @see com.smartgwt.client.docs.SGWTProperties
     */
    public static native void setDefaultProperties(ListPalette listPaletteProperties) /*-{
        if (listPaletteProperties.@com.smartgwt.client.widgets.BaseWidget::isCreated()()) {
            @com.smartgwt.client.util.ConfigUtil::warnOfPreConfigInstantiation(Ljava/lang/Class;Ljava/lang/String;Ljava/lang/Class;)(ListPalette.@java.lang.Object::getClass()(), "setDefaultProperties", listPaletteProperties.@java.lang.Object::getClass()());
        }
        listPaletteProperties.@com.smartgwt.client.widgets.BaseWidget::setConfigOnly(Z)(true);
    	var properties = listPaletteProperties.@com.smartgwt.client.widgets.BaseWidget::getConfig()();
        properties = @com.smartgwt.client.util.JSOHelper::cleanProperties(Lcom/google/gwt/core/client/JavaScriptObject;Z)(properties,true);
        $wnd.isc.ListPalette.addProperties(properties);
    }-*/;
    ...
    public LogicalStructureObject getLogicalStructure() {
        ListPaletteLogicalStructure s = new ListPaletteLogicalStructure();
