...
public class ListPalette extends ListGrid implements Palette {
    ...
    private static final ListPalette TEST_INSTANCE = new ListPalette();
    static {
        TEST_INSTANCE.setID("isc_ListPalette_testInstance");
    }

    @Override
    protected ListPalette getTestInstance() {
    ...
    public static native void changeAutoChildDefaults(String autoChildName, Canvas defaults) /*-{
        $wnd.isc.ListPalette.changeDefaults(autoChildName + "Defaults", defaults.@com.smartgwt.client.widgets.Canvas::getConfig()());
    }-*/;
    ...
    public static native void changeAutoChildDefaults(String autoChildName, FormItem defaults) /*-{
        $wnd.isc.ListPalette.changeDefaults(autoChildName + "Defaults", defaults.@com.smartgwt.client.widgets.form.fields.FormItem::getJsObj()());
    }-*/;
    ...
    public static native void setDefaultProperties(ListPalette listPaletteProperties) /*-{
    	var properties = $wnd.isc.addProperties({},listPaletteProperties.@com.smartgwt.client.widgets.BaseWidget::getConfig()());
