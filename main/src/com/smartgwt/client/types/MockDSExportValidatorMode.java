...
/**
 */
public enum MockDSExportValidatorMode implements ValueEnum {
    /**
     ...
     * <P>
     * If this enumerated value is used in a {@link com.smartgwt.client.docs.ComponentXML Component XML}
     * file or server-side DataSource descriptor (.ds.xml file), use the value "standard".
     */
    STANDARD("standard"),
    /**
    ...
    MockDSExportValidatorMode(String value) {
        this.value = value;
    }
