...
public enum Positioning implements ValueEnum {
     ...
     * file or server-side DataSource descriptor (.ds.xml file), use the value "absolute".
     */
    ABSOLUTE("absolute"),
    /**
     ...
     * <P>
     * If this enumerated value is used in a {@link com.smartgwt.client.docs.ComponentXML Component XML}
     * file or server-side DataSource descriptor (.ds.xml file), use the value "relative".
     */
    RELATIVE("relative");
