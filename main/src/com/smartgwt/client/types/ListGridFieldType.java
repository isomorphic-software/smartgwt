...
public enum ListGridFieldType implements ValueEnum {
     ...
     * unset, dates are formatted using the standard {@link com.smartgwt.client.util.Date#setShortDisplayFormat short display
     * format} for dates. <P> For editing, by default a {@link com.smartgwt.client.widgets.form.fields.DateItem} is used with
     * {@link com.smartgwt.client.widgets.form.fields.DateItem#getUseTextField useTextField} set to true, providing textual
     ...
     * are unset, dates are formatted using the standard {@link com.smartgwt.client.util.Date#getSetShortDateTimeDisplayFormat
