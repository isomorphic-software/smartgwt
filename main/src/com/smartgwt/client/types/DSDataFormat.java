...
public enum DSDataFormat implements ValueEnum {
     ...
     * DataSource.transformResponse()} must be implemented. <code>transformResponse</code> will receive the "data" parameter as
     * a String, and must parse this String into an Array of Objects, which should be set as {@link
     * com.smartgwt.client.data.DSResponse#getData DSResponse.data}. Request format depends on the setting for {@link
