...
public enum PreserveOpenState implements ValueEnum {
     ...
     * com.smartgwt.client.widgets.tree.Tree#getOpenProperty openProperty} optionally set by the server.
     */
    NEVER("never"),
    /**
     * If either the {@link com.smartgwt.client.widgets.tree.Tree#getIdField idField} or {@link
     ...
     * com.smartgwt.client.widgets.tree.Tree#getOpenProperty openProperty} set by the server,  then applying the openState.
     */
