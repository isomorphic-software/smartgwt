...
public class GridDataBoundDragDropSample extends ShowcasePanel {
    ...
    private static final String DESCRIPTION = "<p>Drag employee records into the Project Team Members list. SmartClient recognizes that the two dataSources are linked by a " +
            ...
            "<p>In this example, note that SmartClient is automatically populating all three of the fields in the teamMembers dataSource, even though none of " +
