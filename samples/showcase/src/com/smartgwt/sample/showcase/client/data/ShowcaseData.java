...
import com.smartgwt.sample.showcase.client.buttons.*;
import com.smartgwt.sample.showcase.client.calendar.*;
import com.smartgwt.sample.showcase.client.combobox.*;
...
import com.smartgwt.sample.showcase.client.windows.*;
    ...
    private ExplorerTreeNode[] getData() {
        if (data == null) {
            data = new ExplorerTreeNode[]{
                    ...
                    new ExplorerTreeNode("Adaptive Filter", "grid-adaptive-filter-featured-category", "featured-category", null, new AdaptiveFilterSample.Factory(), true, idSuffix),
                    ...
                    new ExplorerTreeNode("Adaptive Filter", "grid-adaptive-filter-new-category", "new-category", null, new AdaptiveFilterSample.Factory(), true, idSuffix),
                    new ExplorerTreeNode("Adaptive Sort", "grid--adaptive-sort-new-category", "new-category", null, new AdaptiveSortSample.Factory(), true, idSuffix),
                    ...
                    new ExplorerTreeNode("Adaptive Filter", "grid-sortfilter-adaptive-filter", "grid-sortfilter-category", null, new AdaptiveFilterSample.Factory(), true, idSuffix),
                    new ExplorerTreeNode("Adaptive Sort", "grid-sortfilter-adaptive-sort", "grid-sortfilter-category", null, new AdaptiveSortSample.Factory(), true, idSuffix),
